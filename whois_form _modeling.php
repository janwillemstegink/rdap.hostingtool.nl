...
<td><b>Toelichting</b></td><td><b>Explanation</b> - https://github.com/janwillemstegink/xml-whois</td></tr>';
foreach ($xml->xpath('//domain') as $item)	{
	...
	<td>Een bestaande, gewenste en zichtbare naam van de houder gaat over zeggenschap.</td>
	<td>An existing, desired and visible name of the holder is about control.</td></tr>';
	...
	if (strlen(trim($item->reseller->reseller_name)))	{
		...
		<td>De verwerkersovereenkomst kan tussen de houder en de reseller zijn.</td>
		<td>The processing agreement can be between the holder and the reseller.</td></tr>';
