...
foreach ($xml->xpath('//domain') as $item)	{
	...
	<td>Zakelijk gebruik met een bestaande, bedoelde en zichtbare houdernaam is onder controle.</td>
	<td>Business use with an existing, intended and visible holder name is under control.</td></tr>';
	...
	<td>Contactgegevens van een registrar om misbruik te melden zijn optioneel.</td>
	<td>Contact information of a registrar to report abuse is optional.</td></tr>';
	...
	if (strlen(trim($item->reseller->reseller_name)))	{
		...
		<td>Tussen de reseller en de houder kan de verwerkersovereenkomst bestaan.</td>
		<td>Between the reseller and the holder the processing agreement may exist.</td></tr>';
