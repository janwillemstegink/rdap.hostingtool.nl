...
foreach ($xml->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td><button a style="cursor:pointer;cursor:hand" onclick="OpenMenu()">background information (later on)</a></td></tr>';
	...
	$html_text .= '<tr id="B3" style="display:none"><td><b>domain_last_renewal</b></td><td>'.$item->domain_last_renewal.'</td></tr>';
	...
	$html_text .= '<tr><td><b>registrar_hidden</b></td><td>'.$item->registrar->registrar_hidden.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	if (strlen(trim($item->reseller->reseller_name)))	{
		...
		$html_text .= '<tr><td><b>reseller_hidden</b></td><td>'.$item->reseller->reseller_hidden.'</td></tr>';
		$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	}
	...
	$html_text .= '<tr><td><b>registrant_holder_hidden</b></td><td>'.$item->registrant->registrant_holder_hidden.'</td>
	...
	$html_text .= '<tr id="F2" style="display:none"><td><b>admin_hidden</b></td><td>'.$item->admin->admin_hidden.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	if (strlen(trim($item->tech->contact_1->tech_email_1)))	{	
		...
		$html_text .= '<tr id="G2" style="display:none"><td><b>tech_hidden_1</b></td><td>'.$item->tech->contact_1->tech_hidden_1.'</td></tr>';
	}
	if (strlen(trim($item->tech->contact_2->tech_email_2)))	{	
		$html_text .= '<tr id="G3" style="display:none"><td><b>tech_contact_id_2</b></td><td>'.$item->tech->contact_2->tech_contact_id_2.'</td></tr>';
		$html_text .= '<tr><td><b>tech_email_2</b></td><td>'.$item->tech->contact_2->tech_email_2.'</td></tr>';
		$html_text .= '<tr id="G4" style="display:none"><td><b>tech_hidden_2</b></td><td>'.$item->tech->contact_2->tech_hidden_2.'</td></tr>';
	}
	if (strlen(trim($item->tech->contact_3->tech_email_3)))	{	
		$html_text .= '<tr id="G5" style="display:none"><td><b>tech_contact_id_3</b></td><td>'.$item->tech->contact_3->tech_contact_id_3.'</td></tr>';
		$html_text .= '<tr><td><b>tech_email_3</b></td><td>'.$item->tech->contact_3->tech_email_3.'</td></tr>';
		$html_text .= '<tr id="G6" style="display:none"><td><b>tech_hidden_3</b></td><td>'.$item->tech->contact_3->tech_hidden_3.'</td></tr>';
	}
	if (strlen(trim($item->tech->contact_4->tech_email_4)))	{	
		$html_text .= '<tr id="G7" style="display:none"><td><b>tech_contact_id_4</b></td><td>'.$item->tech->contact_4->tech_contact_id_4.'</td></tr>';
		$html_text .= '<tr><td><b>tech_email_4</b></td><td>'.$item->tech->contact_4->tech_email_4.'</td></tr>';
		$html_text .= '<tr id="G8" style="display:none"><td><b>tech_hidden_4</b></td><td>'.$item->tech->contact_4->tech_hidden_4.'</td></tr>';
	}	
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
