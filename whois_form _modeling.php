...
foreach ($xml->xpath('//domain') as $item)	{
	...
	<td>Als "web_publish" is ingesteld op "ja", dan is publicatie van een zoekresultaat in orde.</td>
	...
	<td>Voor zakelijk gebruik is een bestaande en zichtbare naam van de houder van belang.</td>
	<td>For business use, an existing and visible name of the holder is important.</td></tr>';
	...
	<td>Contactgegevens voor melding van misbruik, zijn optioneel voor een registrar.</td>
	<td>Contact information for notification of abuse, is optional for a registrar.</td></tr>';
	...
	if (strlen(trim($item->reseller->reseller_name)))	{
		...
		<td>Een reseller kan verantwoordelijk zijn voor de verwerkersovereenkomst.</td>
		<td>A reseller can be responsible for the processing agreement.</td></tr>';
	...
	<td>De houdernaam is de directe verantwoordelijkheid van de houder, anders de reseller.</td>
	<td>The holder name is the direct responsibility of the holder, otherwise the reseller.</td></tr>';
	$html_text .= '<tr><td>registrant_holder_web_id</td><td>'.$item->registrant->registrant_holder_web_id.'</td>
	<td>De KVK kan de beoogde "web_id"-identificatie aan het Handelsregister toevoegen.</td>
	<td>The Chamber of Commerce can add the intended "web_id" identification to the Trade Register.</td></tr>';
