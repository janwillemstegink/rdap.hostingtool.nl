...
foreach ($xml->xpath('//domain') as $item)	{
	...
	<td>Als "web_publish" op "ja" is gezet, dan wordt publicatie van een zoekresultaat verantwoord.</td>
	<td>If "web_publish" is set to "yes", then publication of a search result is justified.</td></tr>';
	$html_text .= '<tr><td>domain_business_use</td><td>'.$item->domain_business_use.'</td>
	<td>Voor zakelijk gebruik is een bestaande en zichtbare naam van de houder vereist.</td>
	<td>For business use, an existing and visible name of the holder is required.</td></tr>';
