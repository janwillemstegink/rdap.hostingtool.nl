...
foreach ($xml->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td>registrar_abuse_email</td><td>'.$item->registrar->registrar_abuse_email.'</td>
	<td>Het invullen van contactgegevens voor het melden van misbruik is aan een registrar.</td>
	<td>Filling in contact details for reporting abuse is up to a registrar.</td></tr>';
	$html_text .= '<tr id="C2" style="display:none"><td>registrar_abuse_phone</td><td>'.$item->registrar->registrar_abuse_phone.'</td></tr>';
	$html_text .= '<tr id="C3" style="display:none"><td>registrar_street</td><td>'.$item->registrar->registrar_street.'</td></tr>';
	$html_text .= '<tr id="C4" style="display:none"><td>registrar_postal_code</td><td>'.$item->registrar->registrar_postal_code.'</td></tr>';
	$html_text .= '<tr id="C5" style="display:none"><td>registrar_city</td><td>'.$item->registrar->registrar_city.'</td></tr>';
	$html_text .= '<tr id="C6" style="display:none"><td>registrar_country_code</td><td>'.$item->registrar->registrar_country_code.'</td></tr>';
	$html_text .= '<tr id="C7" style="display:none"><td>registrar_country_name</td><td>'.$item->registrar->registrar_country_name.'</td></tr>';
	$html_text .= '<tr id="C8" style="display:none"><td>registrar_country_language</td><td>'.$item->registrar->registrar_country_language.'</td></tr>';
	$html_text .= '<tr id="C9" style="display:none"><td>registrar_whois_server</td><td>'.$item->registrar->registrar_whois_server.'</td></tr>';
	$html_text .= '<tr id="C10" style="display:none"><td>registrar_url</td><td>'.$item->registrar->registrar_url.'</td></tr>';
	$html_text .= '<tr id="C11" style="display:none"><td>registrar_iana_id</td><td>'.$item->registrar->registrar_iana_id.'</td></tr>';
	$html_text .= '<tr><td>registrar_hidden</td><td>'.$item->registrar->registrar_hidden.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	if (strlen(trim($item->reseller->reseller_name)))	{
		...
		$html_text .= '<tr><td>reseller_name</td><td>'.$item->reseller->reseller_name.'</td>
		...
		$html_text .= '<tr id="D2" style="display:none"><td>reseller_street</td><td>'.$item->reseller->reseller_street.'</td></tr>';
		$html_text .= '<tr id="D3" style="display:none"><td>reseller_postal_code</td><td>'.$item->reseller->reseller_postal_code.'</td></tr>';
		$html_text .= '<tr id="D4" style="display:none"><td>reseller_city</td><td>'.$item->reseller->reseller_city.'</td></tr>';
		$html_text .= '<tr id="D5" style="display:none"><td>reseller_country_code</td><td>'.$item->reseller->reseller_country_code.'</td></tr>';
		$html_text .= '<tr id="D6" style="display:none"><td>reseller_country_name</td><td>'.$item->reseller->reseller_country_name.'</td></tr>';
		$html_text .= '<tr id="D7" style="display:none"><td>reseller_country_language</td><td>'.$item->reseller->reseller_country_language.'</td></tr>';
		$html_text .= '<tr><td>reseller_hidden</td><td>'.$item->reseller->reseller_hidden.'</td></tr>';
		$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	}
	...
	$html_text .= '<tr><td>registrant_holder_hidden</td><td>'.$item->registrant->registrant_holder_hidden.'</td>
	<td>Met een bestaande, bedoelde en zichtbare bedrijfsnaam is er wettelijk houderschap.</td>
	<td>Having an existing, intended and visible company name, there is legal holdership.</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
