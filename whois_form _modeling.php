...
foreach ($xml->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td><button a style="cursor:pointer;cursor:hand" onclick="OpenMenu()">to case law (by a c-c registry)</a></td></tr>';
	...
	if (strlen(trim($item->reseller->reseller_name)))	{
		...
		<td>De verwerkersovereenkomst kan zijn tussen de reseller en de houder.</td>
