...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="C12" style="display:none"><td><b>registrar_protected</b></td><td>'.$item->registrar->registrar_protected.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	if (!empty($item->reseller->reseller_name))	{
		if (strlen(trim($item->reseller->reseller_name)))	{
			...
			$html_text .= '<tr id="D8" style="display:none"><td><b>reseller_protected</b></td><td>'.$item->reseller->reseller_protected.'</td></tr>';
			$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
		}	
	}
	...
	$html_text .= '<tr id="E5" style="display:none"><td><b>registrant_holder_phone</b></td><td>'.$item->registrant->registrant_holder_phone.'</td></tr>';
	$html_text .= '<tr id="E6" style="display:none"><td><b>registrant_holder_email</b></td><td>'.$item->registrant->registrant_holder_email.'</td></tr>';
	$html_text .= '<tr id="E7" style="display:none"><td><b>registrant_holder_country_code</b></td><td>'.$item->registrant->registrant_holder_country_code.'</td></tr>';
	$html_text .= '<tr id="E8" style="display:none"><td><b>registrant_holder_country_name</b></td><td>'.$item->registrant->registrant_holder_country_name.'</td></tr>';
	$html_text .= '<tr id="E9" style="display:none"><td><b>registrant_holder_country_language</b></td><td>'.$item->registrant->registrant_holder_country_language.'</td></tr>';
	...
	$html_text .= '<tr id="F2" style="display:none"><td><b>admin_name</b></td><td>'.$item->admin->admin_name.'</td></tr>';
	$html_text .= '<tr id="F3" style="display:none"><td><b>admin_phone</b></td><td>'.$item->admin->admin_phone.'</td></tr>';
	...
	$html_text .= '<tr id="F4" style="display:none"><td><b>admin_protected</b></td><td>'.$item->admin->admin_protected.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	if (!empty($item->tech->contact_1->tech_email_1))	{
		if (strlen(trim($item->tech->contact_1->tech_email_1)))	{	
			...
			$html_text .= '<tr id="G2" style="display:none"><td><b>tech_name_1</b></td><td>'.$item->tech->contact_1->tech_name_1.'</td></tr>';
			$html_text .= '<tr id="G3" style="display:none"><td><b>tech_phone_1</b></td><td>'.$item->tech->contact_1->tech_phone_1.'</td></tr>';
			...
			$html_text .= '<tr id="G4" style="display:none"><td><b>tech_protected_1</b></td><td>'.$item->tech->contact_1->tech_protected_1.'</td></tr>';
		}	
	}
	if (!empty($item->tech->contact_2->tech_email_2))	{
		if (strlen(trim($item->tech->contact_2->tech_email_2)))	{	
			$html_text .= '<tr id="G5" style="display:none"><td><b>tech_contact_id_2</b></td><td>'.$item->tech->contact_2->tech_contact_id_2.'</td></tr>';
			$html_text .= '<tr id="G6" style="display:none"><td><b>tech_name_2</b></td><td>'.$item->tech->contact_2->tech_name_2.'</td></tr>';
			$html_text .= '<tr id="G7" style="display:none"><td><b>tech_phone_2</b></td><td>'.$item->tech->contact_2->tech_phone_2.'</td></tr>';
			$html_text .= '<tr><td><b>tech_email_2</b></td><td>'.$item->tech->contact_2->tech_email_2.'</td></tr>';
			$html_text .= '<tr id="G8" style="display:none"><td><b>tech_protected_2</b></td><td>'.$item->tech->contact_2->tech_protected_2.'</td></tr>';
		}	
	}
	if (!empty($item->tech->contact_3->tech_email_3))	{
		if (strlen(trim($item->tech->contact_3->tech_email_3)))	{	
			$html_text .= '<tr id="G9" style="display:none"><td><b>tech_contact_id_3</b></td><td>'.$item->tech->contact_3->tech_contact_id_3.'</td></tr>';
			$html_text .= '<tr id="G10" style="display:none"><td><b>tech_name_3</b></td><td>'.$item->tech->contact_3->tech_name_3.'</td></tr>';
			$html_text .= '<tr id="G11" style="display:none"><td><b>tech_phone_3</b></td><td>'.$item->tech->contact_3->tech_phone_3.'</td></tr>';
			$html_text .= '<tr><td><b>tech_email_3</b></td><td>'.$item->tech->contact_3->tech_email_3.'</td></tr>';
			$html_text .= '<tr id="G12" style="display:none"><td><b>tech_protected_3</b></td><td>'.$item->tech->contact_3->tech_protected_3.'</td></tr>';
		}	
	}
	if (!empty($item->tech->contact_4->tech_email_4))	{
		if (strlen(trim($item->tech->contact_4->tech_email_4)))	{	
			$html_text .= '<tr id="G13" style="display:none"><td><b>tech_contact_id_4</b></td><td>'.$item->tech->contact_4->tech_contact_id_4.'</td></tr>';
			$html_text .= '<tr id="G14" style="display:none"><td><b>tech_name_4</b></td><td>'.$item->tech->contact_4->tech_name_4.'</td></tr>';
			$html_text .= '<tr id="G15" style="display:none"><td><b>tech_phone_4</b></td><td>'.$item->tech->contact_4->tech_phone_4.'</td></tr>';
			$html_text .= '<tr><td><b>tech_email_4</b></td><td>'.$item->tech->contact_4->tech_email_4.'</td></tr>';
			$html_text .= '<tr id="G16" style="display:none"><td><b>tech_protected_4</b></td><td>'.$item->tech->contact_4->tech_protected_4.'</td></tr>';
		}	
	}	
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
