...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	if (!empty($item->tech->contact_2->tech_email_2))	{
		if (strlen(trim($item->tech->contact_2->tech_email_2)))	{	
			$html_text .= '<tr id="G4" style="display:none"><td><b>tech_contact_id_2</b></td><td>'.$item->tech->contact_2->tech_contact_id_2.'</td></tr>';
			$html_text .= '<tr id="G5" style="display:none"><td><b>tech_name_2</b></td><td>'.$item->tech->contact_2->tech_name_2.'</td></tr>';
			$html_text .= '<tr id="G6" style="display:none"><td><b>tech_phone_2</b></td><td>'.$item->tech->contact_2->tech_phone_2.'</td></tr>';
	...
	if (!empty($item->tech->contact_3->tech_email_3))	{
		if (strlen(trim($item->tech->contact_3->tech_email_3)))	{	
			$html_text .= '<tr id="G7" style="display:none"><td><b>tech_contact_id_3</b></td><td>'.$item->tech->contact_3->tech_contact_id_3.'</td></tr>';
			$html_text .= '<tr id="G8" style="display:none"><td><b>tech_name_3</b></td><td>'.$item->tech->contact_3->tech_name_3.'</td></tr>';
			$html_text .= '<tr id="G9" style="display:none"><td><b>tech_phone_3</b></td><td>'.$item->tech->contact_3->tech_phone_3.'</td></tr>';
	...
	if (!empty($item->tech->contact_4->tech_email_4))	{
		if (strlen(trim($item->tech->contact_4->tech_email_4)))	{	
			$html_text .= '<tr id="G10" style="display:none"><td><b>tech_contact_id_4</b></td><td>'.$item->tech->contact_4->tech_contact_id_4.'</td></tr>';
			$html_text .= '<tr id="G11" style="display:none"><td><b>tech_name_4</b></td><td>'.$item->tech->contact_4->tech_name_4.'</td></tr>';
			$html_text .= '<tr id="G12" style="display:none"><td><b>tech_phone_4</b></td><td>'.$item->tech->contact_4->tech_phone_4.'</td></tr>';
