...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td><b>registrar_company_name</b></td><td>'.$item->registrar->registrar_company_name.'</td></tr>';
	$html_text .= '<tr><td><b>registrar_web_id</b></td><td>'.$item->registrar->registrar_web_id.'</td></tr>';
	$html_text .= '<tr id="C2" style="display:none"><td><b>registrar_personal_name</b></td><td>'.$item->registrar->registrar_personal_name.'</td></tr>';
	...
	$html_text .= '<tr id="C3" style="display:none"><td><b>registrar_abuse_phone</b></td><td>'.$item->registrar->registrar_abuse_phone.'</td></tr>';
	$html_text .= '<tr id="C4" style="display:none"><td><b>registrar_street</b></td><td>'.$item->registrar->registrar_street.'</td></tr>';
	$html_text .= '<tr id="C5" style="display:none"><td><b>registrar_postal_code</b></td><td>'.$item->registrar->registrar_postal_code.'</td></tr>';
	$html_text .= '<tr id="C6" style="display:none"><td><b>registrar_city</b></td><td>'.$item->registrar->registrar_city.'</td></tr>';
	$html_text .= '<tr id="C7" style="display:none"><td><b>registrar_phone</b></td><td>'.$item->registrar->registrar_phone.'</td></tr>';
	$html_text .= '<tr id="C8" style="display:none"><td><b>registrar_email</b></td><td>'.$item->registrar->registrar_email.'</td></tr>';
	$html_text .= '<tr id="C9" style="display:none"><td><b>registrar_country_code</b></td><td>'.$item->registrar->registrar_country_code.'</td></tr>';
	$html_text .= '<tr id="C10" style="display:none"><td><b>registrar_country_name</b></td><td>'.$item->registrar->registrar_country_name.'</td></tr>';
	$html_text .= '<tr id="C11" style="display:none"><td><b>registrar_country_language</b></td><td>'.$item->registrar->registrar_country_language.'</td></tr>';
	$html_text .= '<tr id="C12" style="display:none"><td><b>registrar_whois_server</b></td><td>'.$item->registrar->registrar_whois_server.'</td></tr>';
	$html_text .= '<tr id="C13" style="display:none"><td><b>registrar_url</b></td><td>'.$item->registrar->registrar_url.'</td></tr>';
	$html_text .= '<tr id="C14" style="display:none"><td><b>registrar_iana_id</b></td><td>'.$item->registrar->registrar_iana_id.'</td></tr>';
	$html_text .= '<tr id="C15" style="display:none"><td><b>registrar_protected</b></td><td>'.$item->registrar->registrar_protected.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	if (!empty($item->reseller->reseller_company_name))	{
		if (strlen(trim($item->reseller->reseller_company_name)))	{
			...
			$html_text .= '<tr id="D2" style="display:none"><td><b>reseller_personal_name</b></td><td>'.$item->reseller->reseller_personal_name.'</td></tr>';
			$html_text .= '<tr id="D3" style="display:none"><td><b>reseller_street</b></td><td>'.$item->reseller->reseller_street.'</td></tr>';
			$html_text .= '<tr id="D4" style="display:none"><td><b>reseller_postal_code</b></td><td>'.$item->reseller->reseller_postal_code.'</td></tr>';
			$html_text .= '<tr id="D5" style="display:none"><td><b>reseller_city</b></td><td>'.$item->reseller->reseller_city.'</td></tr>';
			$html_text .= '<tr id="D6" style="display:none"><td><b>reseller_phone</b></td><td>'.$item->reseller->reseller_phone.'</td></tr>';
			$html_text .= '<tr id="D7" style="display:none"><td><b>reseller_email</b></td><td>'.$item->reseller->reseller_email.'</td></tr>';
			$html_text .= '<tr id="D8" style="display:none"><td><b>reseller_country_code</b></td><td>'.$item->reseller->reseller_country_code.'</td></tr>';
			$html_text .= '<tr id="D9" style="display:none"><td><b>reseller_country_name</b></td><td>'.$item->reseller->reseller_country_name.'</td></tr>';
			$html_text .= '<tr id="D10" style="display:none"><td><b>reseller_country_language</b></td><td>'.$item->reseller->reseller_country_language.'</td></tr>';
			$html_text .= '<tr id="D11" style="display:none"><td><b>reseller_protected</b></td><td>'.$item->reseller->reseller_protected.'</td></tr>';
			$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
		}	
	}
	$html_text .= '<tr><td><button a style="cursor:pointer;cursor:hand" onclick="SwitchDisplay(50)">registrant +/-</a></td></tr>';
	$html_text .= '<tr id="E1" style="display:none"><td><b>registrant_contact_id</b></td><td>'.$item->registrant->registrant_contact_id.'</td></tr>';
	...
	$html_text .= '<tr id="E2" style="display:none"><td><b>registrant_street</b></td><td>'.$item->registrant->registrant_street.'</td></tr>';
	$html_text .= '<tr id="E3" style="display:none"><td><b>registrant_postal_code</b></td><td>'.$item->registrant->registrant_postal_code.'</td></tr>';
	$html_text .= '<tr id="E4" style="display:none"><td><b>registrant_city</b></td><td>'.$item->registrant->registrant_city.'</td></tr>';
	$html_text .= '<tr id="E5" style="display:none"><td><b>registrant_phone</b></td><td>'.$item->registrant->registrant_phone.'</td></tr>';
	$html_text .= '<tr id="E6" style="display:none"><td><b>registrant_email</b></td><td>'.$item->registrant->registrant_email.'</td></tr>';
	$html_text .= '<tr id="E7" style="display:none"><td><b>registrant_country_code</b></td><td>'.$item->registrant->registrant_country_code.'</td></tr>';
	$html_text .= '<tr id="E8" style="display:none"><td><b>registrant_country_name</b></td><td>'.$item->registrant->registrant_country_name.'</td></tr>';
	$html_text .= '<tr id="E9" style="display:none"><td><b>registrant_country_language</b></td><td>'.$item->registrant->registrant_country_language.'</td></tr>';
	$html_text .= '<tr id="E10" style="display:none"><td><b>registrant_protected</b></td><td>'.$item->registrant->registrant_protected.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="F2" style="display:none"><td><b>admin_company_name</b></td><td>'.$item->admin->admin_company_name.'</td></tr>';
	$html_text .= '<tr id="F3" style="display:none"><td><b>admin_web_id</b></td><td>'.$item->admin->admin_web_id.'</td></tr>';
	$html_text .= '<tr id="F4" style="display:none"><td><b>admin_personal_name</b></td><td>'.$item->admin->admin_personal_name.'</td></tr>';
	$html_text .= '<tr id="F5" style="display:none"><td><b>admin_phone</b></td><td>'.$item->admin->admin_phone.'</td></tr>';
	...
	$html_text .= '<tr id="F6" style="display:none"><td><b>admin_protected</b></td><td>'.$item->admin->admin_protected.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	if (!empty($item->tech->contact_1->tech_email_1))	{
		if (strlen(trim($item->tech->contact_1->tech_email_1)))	{	
			...
			$html_text .= '<tr id="G2" style="display:none"><td><b>tech_company_name_1</b></td><td>'.$item->tech->contact_1->tech_company_name_1.'</td></tr>';
			$html_text .= '<tr id="G3" style="display:none"><td><b>tech_web_id_1</b></td><td>'.$item->tech->contact_1->tech_web_id_1.'</td></tr>';
			$html_text .= '<tr id="G4" style="display:none"><td><b>tech_personal_name_1</b></td><td>'.$item->tech->contact_1->tech_personal_name_1.'</td></tr>';
			$html_text .= '<tr id="G5" style="display:none"><td><b>tech_phone_1</b></td><td>'.$item->tech->contact_1->tech_phone_1.'</td></tr>';
			...
			$html_text .= '<tr id="G6" style="display:none"><td><b>tech_protected_1</b></td><td>'.$item->tech->contact_1->tech_protected_1.'</td></tr>';
		}	
	}
	if (!empty($item->tech->contact_2->tech_email_2))	{
		if (strlen(trim($item->tech->contact_2->tech_email_2)))	{	
			$html_text .= '<tr id="G7" style="display:none"><td><b>tech_contact_id_2</b></td><td>'.$item->tech->contact_2->tech_contact_id_2.'</td></tr>';
			$html_text .= '<tr id="G8" style="display:none"><td><b>tech_company_name_2</b></td><td>'.$item->tech->contact_2->tech_company_name_2.'</td></tr>';
			$html_text .= '<tr id="G9" style="display:none"><td><b>tech_web_id_2</b></td><td>'.$item->tech->contact_2->tech_web_id_2.'</td></tr>';
			$html_text .= '<tr id="G10" style="display:none"><td><b>tech_personal_name_2</b></td><td>'.$item->tech->contact_2->tech_personal_name_2.'</td></tr>';
			$html_text .= '<tr id="G11" style="display:none"><td><b>tech_phone_2</b></td><td>'.$item->tech->contact_2->tech_phone_2.'</td></tr>';
			$html_text .= '<tr><td><b>tech_email_2</b></td><td>'.$item->tech->contact_2->tech_email_2.'</td></tr>';
			$html_text .= '<tr id="G12" style="display:none"><td><b>tech_protected_2</b></td><td>'.$item->tech->contact_2->tech_protected_2.'</td></tr>';
		}	
	}
	if (!empty($item->tech->contact_3->tech_email_3))	{
		if (strlen(trim($item->tech->contact_3->tech_email_3)))	{	
			$html_text .= '<tr id="G13" style="display:none"><td><b>tech_contact_id_3</b></td><td>'.$item->tech->contact_3->tech_contact_id_3.'</td></tr>';
			$html_text .= '<tr id="G14" style="display:none"><td><b>tech_company_name_3</b></td><td>'.$item->tech->contact_3->tech_company_name_3.'</td></tr>';
			$html_text .= '<tr id="G15" style="display:none"><td><b>tech_web_id_3</b></td><td>'.$item->tech->contact_3->tech_web_id_3.'</td></tr>';
			$html_text .= '<tr id="G16" style="display:none"><td><b>tech_personal_name_3</b></td><td>'.$item->tech->contact_3->tech_personal_name_3.'</td></tr>';
			$html_text .= '<tr id="G17" style="display:none"><td><b>tech_phone_3</b></td><td>'.$item->tech->contact_3->tech_phone_3.'</td></tr>';
			$html_text .= '<tr><td><b>tech_email_3</b></td><td>'.$item->tech->contact_3->tech_email_3.'</td></tr>';
			$html_text .= '<tr id="G18" style="display:none"><td><b>tech_protected_3</b></td><td>'.$item->tech->contact_3->tech_protected_3.'</td></tr>';
		}	
	}
	if (!empty($item->tech->contact_4->tech_email_4))	{
		if (strlen(trim($item->tech->contact_4->tech_email_4)))	{	
			$html_text .= '<tr id="G19" style="display:none"><td><b>tech_contact_id_4</b></td><td>'.$item->tech->contact_4->tech_contact_id_4.'</td></tr>';
			$html_text .= '<tr id="G20" style="display:none"><td><b>tech_company_name_4</b></td><td>'.$item->tech->contact_4->tech_company_name_4.'</td></tr>';
			$html_text .= '<tr id="G21" style="display:none"><td><b>tech_web_id_4</b></td><td>'.$item->tech->contact_4->tech_web_id_4.'</td></tr>';
			$html_text .= '<tr id="G22" style="display:none"><td><b>tech_personal_name_4</b></td><td>'.$item->tech->contact_4->tech_personal_name_4.'</td></tr>';
			$html_text .= '<tr id="G23" style="display:none"><td><b>tech_phone_4</b></td><td>'.$item->tech->contact_4->tech_phone_4.'</td></tr>';
			$html_text .= '<tr><td><b>tech_email_4</b></td><td>'.$item->tech->contact_4->tech_email_4.'</td></tr>';
			$html_text .= '<tr id="G24" style="display:none"><td><b>tech_protected_4</b></td><td>'.$item->tech->contact_4->tech_protected_4.'</td></tr>';
		}	
	}	
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
