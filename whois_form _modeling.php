...
foreach ($xml->xpath('//domain') as $item)	{
	...
	<td>Contactgegevens voor het melden van misbruik zijn aan een registrar.</td>
	<td>Contact details for reporting abuse are to a registrar.</td></tr>';
	...
	<td>Een bestaande en beoogde naam van de houder kan commercieel controleerbaar zijn.</td>
	<td>An existing and intended name of the holder may be commercially verifiable.</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
