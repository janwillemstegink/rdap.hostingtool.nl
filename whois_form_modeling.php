...
function SwitchTranslation(inputlanguage)	{
	if (inputlanguage == 1)	{
		...
		document.getElementById("domain_web_publish").innerText = newfield + ": Als 'web_publish' is ingesteld op 'ja', dan komt publiceren van een zoekresultaat overeen.";
		document.getElementById("domain_last_renewal").innerText = newfield + ": Een zoekmachine kan deze datum gebruiken om op jaarlijkse verlenging te controleren.";
		...
		document.getElementById("registrar_protected").innerText = newfield;
		...
		document.getElementById("reseller_protected").innerText = newfield;
		...
		document.getElementById("registrant_protected").innerText = newfield;
		...
		document.getElementById("tech_protected_1").innerText = newfield;
		document.getElementById("billing_protected").innerText = newfield;
		...
		document.getElementById("domain_web_publish").innerText = newfield + ": If 'web_publish' is set to 'yes', then publishing a search result will match.";	
		document.getElementById("domain_last_renewal").innerText = newfield + ": A search engine can use this date to check for annual renewal.";	
		...
		document.getElementById("domain_web_publish").innerText = newfield + ": Wenn „web_publish“ auf „yes“ gesetzt ist, wird die Veröffentlichung eines Suchergebnisses übereinstimmen.";
		document.getElementById("domain_last_renewal").innerText = newfield + ": Eine Suchmaschine kann dieses Datum verwenden, um nach einer jährlichen Verlängerung zu suchen.";
		...
		document.getElementById("domain_web_publish").innerText = newfield + " : Si 'web_publish' est défini sur 'yes', la publication d'un résultat de recherche correspondra.";
		document.getElementById("domain_last_renewal").innerText = newfield + " : Un moteur de recherche peut utiliser cette date pour vérifier le renouvellement annuel.";
