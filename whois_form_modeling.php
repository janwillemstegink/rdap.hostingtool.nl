...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("domain_transaction").innerText = newfield + "";
		...
		document.getElementById("domain_transaction").innerText = newfield + ": Zoekmachines kunnen weergave tot jaarlijks bevestigde domeinen beperken.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("domain_transaction").innerText = newfield + ": Search engines can limit display to annually confirmed domains.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("domain_status_codes").innerText = "Statuscodes: " + statuscodes;
		document.getElementById("domain_transaction").innerText = newfield + ": Suchmaschinen können die Anzeige auf jährlich bestätigte Domains beschränken.";
		...
		document.getElementById("domain_transaction").innerText = newfield + " : Les moteurs de recherche peuvent limiter l'affichage aux domaines confirmés annuellement.";
		document.getElementById("registrar_web_id").innerText = "";
