...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("registrant_trade_name").innerText = "WHOIS kan functioneren met een bestaande, beoogde en zichtbare handelsnaam.";
		...
		document.getElementById("registrant_trade_name").innerText = "WHOIS can function with an existing, intended and visible trade name.";	
		...
		document.getElementById("registrant_trade_name").innerText = "WHOIS kann mit einem bestehenden, beabsichtigten und sichtbaren Handelsnamen funktionieren.";
		...
		document.getElementById("registrant_trade_name").innerText = "Le WHOIS peut fonctionner avec un nom commercial existant, prévu et visible.";
