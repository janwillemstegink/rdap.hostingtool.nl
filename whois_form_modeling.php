...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("domain_renewed").innerText = newfield + ": Zoekmachines kunnen filteren op status 'active' en maximaal een jaar oude transactie.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("registrant_trade_name").innerText = purpose + ": Legitieme bedrijfsvoering vraagt om een bestaande, beoogde en zichtbare handelsnaam.";
		...
		document.getElementById("domain_renewed").innerText = newfield + ": Search engines can filter by status 'active' and up to a year old transaction.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("registrant_trade_name").innerText = purpose + ": Legitimate business operations require an existing, intended and visible trade name.";	
		...
		document.getElementById("domain_status_codes").innerText = "Statuscodes: " + statuscodes;
		document.getElementById("domain_renewed").innerText = newfield + ": Suchmaschinen können nach Status 'active' und bis zu einem Jahr alten Transaktionen filtern.";
		...
		document.getElementById("registrant_trade_name").innerText = purpose + ": Legitime Geschäftstätigkeiten erfordern einen bestehenden, beabsichtigten und sichtbaren Handelsnamen.";
		...
		document.getElementById("domain_renewed").innerText = newfield + " : Les moteurs de recherche peuvent filtrer par statut 'active' et jusqu'à un an de transaction.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("registrant_trade_name").innerText = purpose + " : Les opérations commerciales légitimes nécessitent un nom commercial existant, prévu et visible.";
