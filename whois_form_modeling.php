...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("registrar_role").textContent = "Een domeinregistrar verzorgt de reservering van domeinen en IP-adresroutering.";
		document.getElementById("registrar_web_id").textContent = "";
		...
		document.getElementById("registrar_protected").textContent = derivedfield;
		document.getElementById("reseller_role").textContent = "Een domeinreseller kan verantwoordelijk zijn voor de verwerking van de gegevens van de houder.";
		document.getElementById("reseller_web_id").textContent = "";
		document.getElementById("reseller_protected").textContent = derivedfield;
		document.getElementById("registrant_role").textContent = "Een domeinregistrant heeft tenminste de abonnementsrechten van een domein.";
		...
		document.getElementById("tech_web_id").textContent = "";
		document.getElementById("tech_protected").textContent = derivedfield;
		document.getElementById("billing_role").textContent = "Een domeinregistry kan factureringsgegevens van registranten bijhouden voor facturering.";
		document.getElementById("billing_protected").textContent = derivedfield;
		...
		document.getElementById("tech_web_id").textContent = "";
		document.getElementById("tech_protected").textContent = derivedfield;
		document.getElementById("billing_role").textContent = "A domain registry can maintain billing data of registrants for billing.";
		document.getElementById("billing_protected").textContent = derivedfield;
		...
		document.getElementById("tech_web_id").textContent = "";
		document.getElementById("tech_protected").textContent = derivedfield;
		document.getElementById("billing_role").textContent = "Eine Domain-Registrierung kann Abrechnungsdaten von Registranten zur Abrechnung pflegen.";
		document.getElementById("billing_protected").textContent = derivedfield;
		...
		document.getElementById("tech_web_id").textContent = "";
		document.getElementById("tech_protected").textContent = derivedfield;
		document.getElementById("billing_role").textContent = "Un registre de domaine peut conserver les données de facturation des inscrits pour la facturation.";
		document.getElementById("billing_protected").textContent = derivedfield;
