...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("admin_protected").innerText = newfield;
		document.getElementById("tech_web_id").innerText = "";
		document.getElementById("tech_email").innerText = "";
		...
		var newfield = 'NIEUW';
		var newcontactfield = 'Velden met privacybeveiligde waarden';
		...
		document.getElementById("domain_renewed").innerText = newfield + ": Zoekmachines kunnen filteren op 'actief' samen met de transactie die niet ouder is dan een jaar.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_web_id").innerText = 'Het webid-identificatienummer voor de Handelsregisters, is in de ontwerpfase.';
		document.getElementById("registrant_trade_name").innerText = "Met een bestaande, beoogde en zichtbare handelsnaam werkt u up to date.";
		...
		document.getElementById("registrant_personal_name").innerText = "De privacybescherming van de persoonlijke naam van de houder is niet altijd gewenst.";
		document.getElementById("registrant_protected").innerText = newcontactfield;
		document.getElementById("admin_web_id").innerText = "";
		...
		document.getElementById("tech_web_id").innerText = "";
		document.getElementById("tech_email").innerText = "Een technisch contact reageert om een gemelde storing op te lossen.";
		document.getElementById("tech_protected").innerText = newcontactfield;
		document.getElementById("billing_protected").innerText = newcontactfield;
		...
		var newfield = 'NEW';
		var newcontactfield = 'Fields with privacy protected values';
		...
		document.getElementById("domain_renewed").innerText = newfield + ": Search engines can filter by 'active' along with the transaction that is not older than one year.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_web_id").innerText = 'The webid identification number for the Trade Registers is in the design phase.';
		document.getElementById("registrant_trade_name").innerText = "With an existing, intended and visible trade name you work up to date.";	
		...
		document.getElementById("registrant_personal_name").innerText = "The privacy protection of the holder's personal name is not always desirable.";
		document.getElementById("registrant_protected").innerText = newcontactfield;
		document.getElementById("admin_web_id").innerText = "";
		...
		document.getElementById("admin_protected").innerText = newfield;
		document.getElementById("tech_web_id").innerText = "";
		document.getElementById("tech_email").innerText = "A technical contact responds to resolve a reported malfunction.";
		document.getElementById("tech_protected").innerText = newcontactfield;
		document.getElementById("billing_protected").innerText = newcontactfield;
		...
		var newfield = 'NEU';
		var newcontactfield = 'Felder mit datenschutzrechtlich geschützten Werten';
		...
		document.getElementById("domain_status_codes").innerText = "Statuscodes: " + statuscodes;
		document.getElementById("domain_renewed").innerText = newfield + ": Suchmaschinen können zusammen mit der Transaktion, die nicht älter als ein Jahr ist, nach „aktiv“ filtern.";
		...
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_web_id").innerText = 'Die Webid-Identifikationsnummer für die Handelsregister befindet sich in der Entwurfsphase.';
		document.getElementById("registrant_trade_name").innerText = "Mit einem bestehenden, gewollten und sichtbaren Handelsnamen arbeiten Sie zeitgemäß.";
		...
		document.getElementById("registrant_personal_name").innerText = "Der Schutz der Privatsphäre des persönlichen Namens des Inhabers ist nicht immer wünschenswert.";
		document.getElementById("registrant_protected").innerText = newcontactfield;
		document.getElementById("admin_web_id").innerText = "";
		...
		document.getElementById("admin_protected").innerText = newcontactfield;
		document.getElementById("tech_web_id").innerText = "";
		document.getElementById("tech_email").innerText = "Ein technischer Kontakt reagiert, um eine gemeldete Störung zu beheben.";
		document.getElementById("tech_protected").innerText = newcontactfield;
		document.getElementById("billing_protected").innerText = newcontactfield;
		...
		var newcontactfield = 'Champs avec des valeurs protégées par la confidentialité';
		...
		document.getElementById("domain_renewed").innerText = newfield + " : Les moteurs de recherche peuvent filtrer 'actif' avec la transaction qui ne date pas de plus d'un an.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_web_id").innerText = "Le numéro d'identification webid des registres du commerce est en phase de conception.";
		document.getElementById("registrant_trade_name").innerText = "Avec un nom commercial existant, prévu et visible, vous travaillez à jour.";
		...
		document.getElementById("registrant_personal_name").innerText = "La protection de la confidentialité du nom personnel du titulaire n'est pas toujours souhaitable.";
		document.getElementById("registrant_protected").innerText = newcontactfield;
		document.getElementById("admin_web_id").innerText = "";
		...
		document.getElementById("admin_protected").innerText = newfield;
		document.getElementById("tech_web_id").innerText = "";
		document.getElementById("tech_email").innerText = "Un contact technique répond pour résoudre un dysfonctionnement signalé.";
		document.getElementById("tech_protected").innerText = newcontactfield;
		document.getElementById("billing_protected").innerText = newcontactfield;
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="803" style="display:none"><td><b>billing_trade_name</b></td><td>'.$item->billing->billing_trade_name.'</td><td id="billing_trade_name" style="font-style:italic"></td></tr>';
	$html_text .= '<tr id="804" style="display:none"><td><b>billing_personal_name</b></td><td>'.$item->billing->billing_personal_name.'</td><td id="billing_personal_name" style="font-style:italic"></td></tr>';
