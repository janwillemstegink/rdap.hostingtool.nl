...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("domain_role").innerText = "";
		document.getElementById("domain_status").innerText = "";
		document.getElementById("domain_status_codes").innerText = "";
		document.getElementById("domain_renewed").innerText = newfield + "";
		document.getElementById("registrar_role").innerText = "";
		document.getElementById("registrar_web_id").innerText = "";
		document.getElementById("registrar_abuse_email").innerText = "";
		document.getElementById("registrar_protected").innerText = derivedfield;
		document.getElementById("reseller_role").innerText = "";
		document.getElementById("reseller_web_id").innerText = "";
		document.getElementById("reseller_protected").innerText = derivedfield;
		document.getElementById("registrant_role").innerText = "";
		document.getElementById("registrant_web_id").innerText = "";
		document.getElementById("registrant_trade_name").innerText = "";
		document.getElementById("registrant_personal_public").innerText = "";
		...
		document.getElementById("admin_role").innerText = "";
		document.getElementById("admin_web_id").innerText = "";
		document.getElementById("admin_protected").innerText = derivedfield;
		document.getElementById("tech_role").innerText = "";
		document.getElementById("tech_web_id").innerText = "";
		document.getElementById("tech_protected").innerText = derivedfield;
		document.getElementById("billing_role").innerText = "";
		document.getElementById("billing_protected").innerText = derivedfield;
		document.getElementById("name_servers_dnssec").innerText = "";
		document.getElementById("zone_role").innerText = "";
	}
		...
		document.getElementById("domain_role").innerText = "Een domeinnaam identificeert bestuurlijke autonomie, autoriteit of controle binnen het internet.";
		...
		document.getElementById("domain_renewed").innerText = newfield + ": Zoekmachines kunnen filteren op 'actief' en een transactie die niet ouder is dan een jaar.";
		document.getElementById("registrar_role").innerText = "Een domeinregistrar verzorgt voor de reservering van domeinen en IP-adresroutering.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("registrar_protected").innerText = derivedfield;
		document.getElementById("reseller_role").innerText = "Een domeinreseller kan verantwoordelijk zijn voor de verwerking van de gegevens van de houder.";
		document.getElementById("reseller_web_id").innerText = "";
		document.getElementById("reseller_protected").innerText = derivedfield;
		document.getElementById("registrant_role").innerText = "Een domeinregistrant heeft tenminste de abonnementsrechten van een domein.";
		...
		document.getElementById("registrant_protected").innerText = derivedfield;
		document.getElementById("admin_role").innerText = "Het administratief aanspreekpunt beantwoordt een verzoek, en stuurt het indien nodig door.";
		document.getElementById("admin_web_id").innerText = "";
		document.getElementById("admin_protected").innerText = derivedfield;
		document.getElementById("tech_role").innerText = "Een technisch contact reageert om een gemelde storing op te lossen.";
		document.getElementById("tech_web_id").innerText = "";
		document.getElementById("tech_protected").innerText = derivedfield;
		document.getElementById("billing_role").innerText = "Een domeinregistry kan factureringsgegevens van registranten bijhouden voor facturering.";
		document.getElementById("billing_protected").innerText = derivedfield;
		...
		document.getElementById("zone_role").innerText = "Een domeinzone wordt door de ICANN toegewezen aan een registry om domeinen te beheren.";
	}
		...
		document.getElementById("domain_role").innerText = "A domain name identifies administrative autonomy, authority or control within the Internet.";
		...
		document.getElementById("domain_renewed").innerText = newfield + ": Search engines can filter by 'active' and a transaction that is not older than one year.";
		document.getElementById("registrar_role").innerText = "A domain registrar takes care of domain reservations and IP address routing.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("registrar_protected").innerText = derivedfield;
		document.getElementById("reseller_role").innerText = "A domain reseller may be responsible for processing of the holder's data.";
		document.getElementById("reseller_web_id").innerText = "";
		document.getElementById("reseller_protected").innerText = derivedfield;
		document.getElementById("registrant_role").innerText = "A domain registrant has at least the subscription rights of a domain.";
		...
		document.getElementById("registrant_protected").innerText = derivedfield;
		document.getElementById("admin_role").innerText = "The administratively responsible desk answers a request, and forwards it if necessary.";
		document.getElementById("admin_web_id").innerText = "";
		document.getElementById("admin_protected").innerText = derivedfield;
		document.getElementById("tech_role").innerText = "A technical contact responds to resolve a reported malfunction.";
		document.getElementById("tech_web_id").innerText = "";
		document.getElementById("tech_protected").innerText = derivedfield;
		document.getElementById("billing_role").innerText = "A domain registry can maintain billing data of registrants for billing.";
		document.getElementById("billing_protected").innerText = derivedfield;
		...
		document.getElementById("zone_role").innerText = "A domain zone is assigned by the ICANN to a registry to manage domains.";
	}
		...
		document.getElementById("domain_role").innerText = "Ein Domänenname kennzeichnet administrative Autonomie, Autorität oder Kontrolle innerhalb des Internets.";
		...
		document.getElementById("domain_status_codes").innerText = "Statuscodes: " + statuscodes;
		document.getElementById("domain_renewed").innerText = newfield + ": Suchmaschinen können nach „aktiv“ und einer Transaktion filtern, die nicht älter als ein Jahr ist.";
		document.getElementById("registrar_role").innerText = "Ein Domain-Registrar kümmert sich um Domain-Reservierungen und IP-Adress-Routing.";
		...
		document.getElementById("registrar_web_id").innerText = "";
		document.getElementById("registrar_protected").innerText = derivedfield;
		document.getElementById("reseller_role").innerText = "Ein Domain-Wiederverkäufer kann für die Verarbeitung der Daten des Inhabers verantwortlich sein.";
		document.getElementById("reseller_web_id").innerText = "";
		document.getElementById("reseller_protected").innerText = derivedfield;
		document.getElementById("registrant_role").innerText = "Ein Domain-Registrant hat mindestens die Bezugsrechte einer Domain.";
		...
		document.getElementById("registrant_protected").innerText = derivedfield;
		document.getElementById("admin_role").innerText = "Die administrativ zuständige Stelle beantwortet eine Anfrage und leitet diese gegebenenfalls weiter.";
		document.getElementById("admin_web_id").innerText = "";
		document.getElementById("admin_protected").innerText = derivedfield;
		document.getElementById("tech_role").innerText = "Ein technischer Kontakt reagiert, um eine gemeldete Störung zu beheben.";
		document.getElementById("tech_web_id").innerText = "";
		document.getElementById("tech_protected").innerText = derivedfield;
		document.getElementById("billing_role").innerText = "Eine Domain-Registrierung kann Abrechnungsdaten von Registranten zur Abrechnung pflegen.";
		document.getElementById("billing_protected").innerText = derivedfield;
		...
		document.getElementById("zone_role").innerText = "Eine Domänenzone wird von der ICANN einer Registrierungsstelle zugewiesen, um Domänen zu verwalten.";
	}
		...
		document.getElementById("domain_role").innerText = "Un nom de domaine identifie l'autonomie administrative, l'autorité ou le contrôle au sein d'Internet.";
		...
		document.getElementById("domain_renewed").innerText = newfield + " : Les moteurs de recherche peuvent filtrer par 'actif' et une transaction datant de moins d'un an.";
		document.getElementById("registrar_role").innerText = "Un registraire de domaine s'occupe des réservations de domaine et du routage des adresses IP.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("registrar_protected").innerText = derivedfield;
		document.getElementById("reseller_role").innerText = "Un revendeur de domaine peut être responsable du traitement des données du titulaire.";
		document.getElementById("reseller_web_id").innerText = "";
		document.getElementById("reseller_protected").innerText = derivedfield;
		document.getElementById("registrant_role").innerText = "Un titulaire de nom de domaine a au moins les droits d'abonnement d'un domaine.";
		...
		document.getElementById("registrant_protected").innerText = derivedfield;
		document.getElementById("admin_role").innerText = "Le bureau administrativement responsable répond à une demande, et la transmet si nécessaire.";
		document.getElementById("admin_web_id").innerText = "";
		document.getElementById("admin_protected").innerText = derivedfield;
		document.getElementById("tech_role").innerText = "Un contact technique répond pour résoudre un dysfonctionnement signalé.";
		document.getElementById("tech_web_id").innerText = "";
		document.getElementById("tech_protected").innerText = derivedfield;
		document.getElementById("billing_role").innerText = "Un registre de domaine peut conserver les données de facturation des inscrits pour la facturation.";
		document.getElementById("billing_protected").innerText = derivedfield;
		...
		document.getElementById("zone_role").innerText = "Une zone de domaine est attribuée par l'ICANN à un registre pour gérer les domaines.";
	}
}	
</script><?php
echo '</head>';
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(20)">domain +/-</button></td><td></td><td id="domain_role" style="font-style:italic"></td></tr>';
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(30)">registrar +/-</button></td><td></td><td id="registrar_role" style="font-style:italic"></td></tr>';
	...
	if (!empty($item->reseller->reseller_trade_name))	{
		if (strlen(trim($item->reseller->reseller_trade_name)))	{
			$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(40)">reseller +/-</button></td><td></td><td id="reseller_role" style="font-style:italic"></td></tr>';				$html_text .= '<tr id="401" style="display:none"><td><b>reseller_contact_id</b></td><td>'.$item->reseller->reseller_contact_id.'</td><td></td></tr>';
	...
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(50)">registrant +/-</button></td><td></td><td id="registrant_role" style="font-style:italic"></td></tr>';
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(60)">admin +/-</button></td><td></td><td id="admin_role" style="font-style:italic"></td></tr>';
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(70)">tech +/-</button></td><td></td><td id="tech_role" style="font-style:italic"></td></tr>';
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(80)">billing +/-</button></td><td></td><td id="billing_role" style="font-style:italic"></td></tr>';
...
foreach ($xml2->xpath('//zone') as $item)	{
	simplexml_load_string($item->asXML());
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(100)">zone +/-</button></td><td></td><td id="zone_role" style="font-style:italic"></td></tr>';
