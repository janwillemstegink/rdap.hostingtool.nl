...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td><button style="cursor:pointer;cursor:hand" onclick="OpenMenu()">see work instruction by a c-c registry</button></td><td></td>
	<td><button style="cursor:pointer;cursor:hand" onclick="SwitchTranslation(1)">Dutch</button> 
	<button style="cursor:pointer;cursor:hand" onclick="SwitchTranslation(2)">English</button></td></tr>';
