...
function SwitchTranslation(inputlanguage)	{
	if (inputlanguage == 1)	{
		...
		document.getElementById("domain_web_publish").innerText = "Als 'web_publish' is ingesteld op 'ja', dan komt publiceren van een zoekresultaat overeen.";
		document.getElementById("domain_last_renewal").innerText = "Een zoekmachine kan deze datum gebruiken om op jaarlijkse verlenging te controleren.";
		...
		document.getElementById("registrant_web_id").innerText = "De KVK kan de benodigde 'web_id'-identificatie aan het Handelsregister toevoegen.";
		...
		document.getElementById("domain_web_publish").innerText = "If 'web_publish' is set to 'yes', then publishing a search result will match.";	
		document.getElementById("domain_last_renewal").innerText = "A search engine can use this date to check for annual renewal.";	
		...
		document.getElementById("registrant_web_id").innerText = "The Chamber of Commerce can add the required 'web_id' identification to the Trade Register.";	
		...
		document.getElementById("domain_web_publish").innerText = "Wenn „web_publish“ auf „yes“ gesetzt ist, wird die Veröffentlichung eines Suchergebnisses übereinstimmen.";	
		document.getElementById("domain_last_renewal").innerText = "Eine Suchmaschine kann dieses Datum verwenden, um nach einer jährlichen Verlängerung zu suchen.";	
		...
		document.getElementById("registrant_web_id").innerText = "Die Handelskammer kann die erforderliche Kennung „web_id“ zum Handelsregister hinzufügen.";	
		...
		document.getElementById("registrant_web_id").innerText = "La Chambre de Commerce peut ajouter l'identification 'web_id' requise au registre du commerce.";	
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td><b>domain_status</b></td><td><b>'.$item->domain_status.'</b></td><td id="domain_status"></td></tr>';
	...
	$html_text .= '<tr><td><b>registrar_web_id</b></td><td>'.$item->registrar->registrar_web_id.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="C15" style="display:none"><td><b>registrar_protected</b></td><td>'.$item->registrar->registrar_protected.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	if (!empty($item->reseller->reseller_company_name))	{
		if (strlen(trim($item->reseller->reseller_company_name)))	{
			...
			$html_text .= '<tr><td><b>reseller_web_id</b></td><td>'.$item->reseller->reseller_web_id.'</td><td></td></tr>';
			...
			$html_text .= '<tr id="D11" style="display:none"><td><b>reseller_protected</b></td><td>'.$item->reseller->reseller_protected.'</td><td></td></tr>';
			$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
		}	
	}
	...
	$html_text .= '<tr id="E10" style="display:none"><td><b>registrant_protected</b></td><td>'.$item->registrant->registrant_protected.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="F3" style="display:none"><td><b>admin_web_id</b></td><td>'.$item->admin->admin_web_id.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="F6" style="display:none"><td><b>admin_protected</b></td><td>'.$item->admin->admin_protected.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	if (!empty($item->tech->contact_1->tech_email_1))	{
		if (strlen(trim($item->tech->contact_1->tech_email_1)))	{	
			...
			$html_text .= '<tr id="G3" style="display:none"><td><b>tech_web_id_1</b></td><td>'.$item->tech->contact_1->tech_web_id_1.'</td><td></td></tr>';
			...
			$html_text .= '<tr id="G6" style="display:none"><td><b>tech_protected_1</b></td><td>'.$item->tech->contact_1->tech_protected_1.'</td><td></td></tr>';
		}	
	}
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer;cursor:hand" onclick="SwitchDisplay(80)">name servers +/-</button></td><td></td><td></td></tr>';
	if (!empty($item->name_servers->server_1->server_name_1))	{
		if (strlen(trim($item->name_servers->server_1->server_name_1)))	{
			$html_text .= '<tr id="H1" style="display:none"><td><b>server_name_1</b></td><td>'.$item->name_servers->server_1->server_name_1.'</td><td></td></tr>';
			$html_text .= '<tr id="H2" style="display:none"><td><b>ipv4_1</b></td><td>'.$item->name_servers->server_1->ipv4_1.'</td><td></td></tr>';
			$html_text .= '<tr id="H3" style="display:none"><td><b>ipv6_1</b></td><td>'.$item->name_servers->server_1->ipv6_1.'</td><td></td></tr>';
		}	
	}
	if (!empty($item->name_servers->server_1->server_name_1))	{		
		if (strlen(trim($item->name_servers->server_1->server_name_1)))	{
			$html_text .= '<tr id="H4" style="display:none"><td><b>server_name_2</b></td><td>'.$item->name_servers->server_2->server_name_2.'</td><td></td></tr>';
			$html_text .= '<tr id="H5" style="display:none"><td><b>ipv4_2</b></td><td>'.$item->name_servers->server_2->ipv4_2.'</td><td></td></tr>';
			$html_text .= '<tr id="H6" style="display:none"><td><b>ipv6_2</b></td><td>'.$item->name_servers->server_2->ipv6_2.'</td><td></td></tr>';
		}	
	}
	if (!empty($item->name_servers->server_3->server_name_3))	{
		if (strlen(trim($item->name_servers->server_3->server_name_3)))	{
			$html_text .= '<tr id="H7" style="display:none"><td><b>server_name_3</b></td><td>'.$item->name_servers->server_3->server_name_3.'</td><td></td></tr>';
			$html_text .= '<tr id="H8" style="display:none"><td><b>ipv4_3</b></td><td>'.$item->name_servers->server_3->ipv4_3.'</td><td></td></tr>';
			$html_text .= '<tr id="H9" style="display:none"><td><b>ipv6_3</b></td><td>'.$item->name_servers->server_3->ipv6_3.'</td><td></td></tr>';
		}	
	}
	if (!empty($item->name_servers->server_4->server_name_4))	{	
		if (strlen(trim($item->name_servers->server_4->server_name_4)))	{
			$html_text .= '<tr id="H10" style="display:none"><td><b>server_name_4</b></td><td>'.$item->name_servers->server_4->server_name_4.'</td><td></td></tr>';
			$html_text .= '<tr id="H11" style="display:none"><td><b>ipv4_4</b></td><td>'.$item->name_servers->server_4->ipv4_4.'</td><td></td></tr>';
			$html_text .= '<tr id="H12" style="display:none"><td><b>ipv6_4</b></td><td>'.$item->name_servers->server_4->ipv6_4.'</td><td></td></tr>';
		}	
	}
	if (!empty($item->name_servers->server_5->server_name_5))	{		
		if (strlen(trim($item->name_servers->server_5->server_name_5)))	{
			$html_text .= '<tr id="H13" style="display:none"><td><b>server_name_5</b></td><td>'.$item->name_servers->server_5->server_name_5.'</td><td></td></tr>';
			$html_text .= '<tr id="H14" style="display:none"><td><b>ipv4_5</b></td><td>'.$item->name_servers->server_5->ipv4_5.'</td><td></td></tr>';
			$html_text .= '<tr id="H15" style="display:none"><td><b>ipv6_5</b></td><td>'.$item->name_servers->server_5->ipv6_5.'</td><td></td></tr>';
		}	
	}
	if (!empty($item->name_servers->server_6->server_name_6))	{
		if (strlen(trim($item->name_servers->server_6->server_name_6)))	{
			$html_text .= '<tr id="H16" style="display:none"><td><b>server_name_6</b></td><td>'.$item->name_servers->server_6->server_name_6.'</td><td></td></tr>';
			$html_text .= '<tr id="H17" style="display:none"><td><b>ipv4_6</b></td><td>'.$item->name_servers->server_6->ipv4_6.'</td><td></td></tr>';
			$html_text .= '<tr id="H18" style="display:none"><td><b>ipv6_6</b></td><td>'.$item->name_servers->server_6->ipv6_6.'</td><td></td></tr>';
		}	
	}
	$html_text .= '<tr><td><b>name_servers_dnssec</b></td><td>'.$item->name_servers->name_servers_dnssec.'</td><td id="name_servers_dnssec"></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer;cursor:hand" onclick="SwitchDisplay(90)">registry +/-</button></td><td></td><td></td></tr>';
	$html_text .= '<tr><td><b>registry_description</b></td><td>'.$item->data_management->registry_description.'</td><td></td></tr>';
	$html_text .= '<tr id="I1" style="display:none"><td><b>registry_language</b></td><td>'.$item->data_management->registry_language.'</td><td></td></tr>';
	$html_text .= '<tr id="I2" style="display:none"><td><b>registry_format</b></td><td>'.$item->data_management->registry_format.'</td><td></td></tr>';
	break;
}	
foreach ($xml2->xpath('//domain') as $item)	{
simplexml_load_string($item->asXML());
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer;cursor:hand" onclick="SwitchDisplay(100)">whois restrictions +/-</button></td><td></td><td></td></tr>';
	$html_text .= '<tr id="J1" style="display:none"><td><b>restrictions_legally</b></td><td>'.$item->restrictions_legally.'</td><td></td></tr>';
	$html_text .= '<tr id="J2" style="display:none"><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr id="J3" style="display:none"><td><b>restrictions_translated</b></td><td>'.$item->restrictions_translated.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	break;
}
