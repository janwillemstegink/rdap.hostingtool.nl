...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_web_id").innerText = newdomainfield + ": Het webid-identificatienummer in het Handelsregister is in de ontwerpfase.";
		...
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_web_id").innerText = newdomainfield + ": The webid identification number in the Trade Register is in the design phase.";
		...
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_web_id").innerText = newdomainfield + ": Die Webid-Identifikationsnummer im Handelsregister befindet sich in der Konzeptionsphase.";
		...
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_web_id").innerText = newdomainfield + " : Le numéro d'identification webid au registre du commerce est en phase de conception.";
