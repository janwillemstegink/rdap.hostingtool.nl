...
foreach ($xml2->xpath('//zone') as $item)	{
	...
	$html_text .= '<tr id="1002" style="display:none"><td><b>zone_menu</b></td><td>'.$item->zone_menu.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="1007" style="display:none"><td><b>zone_time_zone</b></td><td>'.$item->zone_time_zone.'</td><td></td></tr>';
	$html_text .= '<tr id="1008" style="display:none"><td><b>zone_language</b></td><td>'.$item->zone_language.'</td><td></td></tr>';
	$html_text .= '<tr id="1009" style="display:none"><td><b>zone_format</b></td><td>'.$item->zone_format.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
