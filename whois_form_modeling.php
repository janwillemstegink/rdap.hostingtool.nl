...
function SwitchTranslation(inputlanguage)	{
	if (inputlanguage == 1)	{
		...
		var newcontactfield = 'NIEUW contacttabelveld';
		...
		var newcontactfield = 'NEW contacts table field';
		...
		var newcontactfield = 'NEUES Kontakttabellenfeld';
		...
		var newcontactfield = 'NOUVEAU champ de table de contacts';
