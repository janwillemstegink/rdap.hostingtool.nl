...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("reseller_web_id").innerText = newcontactfield;
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_trade_name").innerText = purpose + ": Zakelijk gebruik vereist een bestaande, beoogde en zichtbare handelsnaam.";
		...
		document.getElementById("reseller_web_id").innerText = newcontactfield;
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_trade_name").innerText = purpose + ": Business use requires an existing, intended and visible trade name.";	
		...
		document.getElementById("reseller_web_id").innerText = newcontactfield;
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_trade_name").innerText = purpose + ": Die geschäftliche Nutzung erfordert einen bestehenden, beabsichtigten und sichtbaren Handelsnamen.";
		...
		document.getElementById("reseller_web_id").innerText = newcontactfield;
		document.getElementById("reseller_protected").innerText = newcontactfield;
		document.getElementById("registrant_trade_name").innerText = purpose + " : L'utilisation commerciale nécessite un nom commercial existant, prévu et visible.";
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="308" style="display:none"><td><b>registrar_state</b></td><td>'.$item->registrar->registrar_state.'</td><td></td></tr>';
	$html_text .= '<tr id="309" style="display:none"><td><b>registrar_phone</b></td><td>'.$item->registrar->registrar_phone.'</td><td></td></tr>';
	$html_text .= '<tr id="3010" style="display:none"><td><b>registrar_email</b></td><td>'.$item->registrar->registrar_email.'</td><td></td></tr>';
	$html_text .= '<tr id="3011" style="display:none"><td><b>registrar_country_code</b></td><td>'.$item->registrar->registrar_country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="3012" style="display:none"><td><b>registrar_country_name</b></td><td>'.$item->registrar->registrar_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="3013" style="display:none"><td><b>registrar_country_language</b></td><td>'.$item->registrar->registrar_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="3014" style="display:none"><td><b>registrar_url</b></td><td>'.$item->registrar->registrar_url.'</td><td></td></tr>';
	$html_text .= '<tr id="3015" style="display:none"><td><b>registrar_iana_id</b></td><td>'.$item->registrar->registrar_iana_id.'</td><td></td></tr>';
	...
	if (!empty($item->reseller->reseller_trade_name))	{
		if (strlen(trim($item->reseller->reseller_trade_name)))	{
			...
			$html_text .= '<tr id="406" style="display:none"><td><b>reseller_state</b></td><td>'.$item->reseller->reseller_state.'</td><td></td></tr>';
			$html_text .= '<tr id="407" style="display:none"><td><b>reseller_phone</b></td><td>'.$item->reseller->reseller_phone.'</td><td></td></tr>';
			$html_text .= '<tr id="408" style="display:none"><td><b>reseller_email</b></td><td>'.$item->reseller->reseller_email.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="505" style="display:none"><td><b>registrant_state</b></td><td>'.$item->registrant->registrant_state.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="608" style="display:none"><td><b>admin_state</b></td><td>'.$item->admin->admin_state.'</td><td></td></tr>';
	$html_text .= '<tr id="609" style="display:none"><td><b>admin_phone</b></td><td>'.$item->admin->admin_phone.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="708" style="display:none"><td><b>tech_state</b></td><td>'.$item->tech->tech_state.'</td><td></td></tr>';
	$html_text .= '<tr id="709" style="display:none"><td><b>tech_phone</b></td><td>'.$item->tech->tech_phone.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="807" style="display:none"><td><b>billing_state</b></td><td>'.$item->billing->billing_state.'</td><td></td></tr>';
	$html_text .= '<tr id="808" style="display:none"><td><b>billing_phone</b></td><td>'.$item->billing->billing_phone.'</td><td></td></tr>';
	$html_text .= '<tr id="809" style="display:none"><td><b>billing_email</b></td><td>'.$item->billing->billing_email.'</td><td></td></tr>';
	$html_text .= '<tr id="8010" style="display:none"><td><b>billing_country_code</b></td><td>'.$item->billing->billing_country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="8011" style="display:none"><td><b>billing_country_name</b></td><td>'.$item->billing->billing_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="8012" style="display:none"><td><b>billing_country_language</b></td><td>'.$item->billing->billing_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="8013" style="display:none"><td><b>billing_protected</b></td><td>'.$item->billing->billing_protected.'</td><td id="billing_protected" style="font-style:italic"></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
