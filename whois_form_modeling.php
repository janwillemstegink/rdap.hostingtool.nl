...
function SwitchTranslation(inputlanguage)	{
	if (inputlanguage == 0)	{
		...
		document.getElementById("what_about_whois").innerText = "";
...
$domainfile = 'whois_domain_data.xml';
...
elseif (file_exists($registryfile))	{
	$xml2 = simplexml_load_file($registryfile) or die("Cannot load xml2 from same folder.");
}
elseif (@get_headers($url2a))	{ // application to compose
...
$html_text .= '<tr><td id="title" style="font-size: 1.2rem;font-weight:bold"></td><td id="data" style="font-size:1.2rem;font-weight:bold"></td>
...
$html_text .= '<tr><td></td><td></td><td id="what_about_whois" style="font-size: 1rem;font-style:italic"></td></tr>';
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td><b>domain_transaction</b></td><td>'.$item->domain_transaction.'</td><td id="domain_transaction"></td></tr>';
	...
	$html_text .= '<tr><td><b>registrant_trade_name</b></td><td>'.$item->registrant->registrant_trade_name.'</td><td id="registrant_trade_name"></td></tr>';
