...
echo '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="robots" content="index"><title>Web Domain Whois Modeling</title>';
?><script>
...
function SwitchTranslation(inputlanguage)	{
	if (inputlanguage == 1)	{
		...
		document.getElementById("registrant_company_name").innerText = purpose + ": Er is legitiem houderschap met een bestaande, beoogde en zichtbare bedrijfsnaam.";
...
$html_text .= '<tr><td></td><td></td><td id="what_about_whois"style="font-size:14px"></td></tr>';
