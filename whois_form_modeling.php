...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("registrant_public_name").innerText = newdomainfield + "";
		...
		document.getElementById("registrant_public_name").innerText = newdomainfield + ": Bij zakelijk gebruik dient een zichtbare handelsnaam, of de privénaam, tot transparantie.";
		...
		document.getElementById("registrant_public_name").innerText = newdomainfield + ": In business use, a visible trade name, or the personal name, serves for transparency.";
		...
		document.getElementById("registrant_public_name").innerText = newdomainfield + ": Im geschäftlichen Gebrauch dient ein sichtbarer Handelsname oder der Personenname der Transparenz.";
		...
		document.getElementById("registrant_public_name").innerText = newdomainfield + " : Dans l'utilisation commerciale, un nom commercial visible, ou le nom personnel, sert à la transparence.";
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td><b>registrant_public_name</b></td><td>'.$item->registrant->registrant_public_name.'</td><td id="registrant_public_name" style="font-style:italic"></td></tr>';
	...
	$html_text .= '<tr id="505" style="display:none"><td><b>registrant_street</b></td><td>'.$item->registrant->registrant_street.'</td><td></td></tr>';
	$html_text .= '<tr id="506" style="display:none"><td><b>registrant_postal_code</b></td><td>'.$item->registrant->registrant_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="507" style="display:none"><td><b>registrant_city</b></td><td>'.$item->registrant->registrant_city.'</td><td></td></tr>';
	$html_text .= '<tr id="508" style="display:none"><td><b>registrant_state</b></td><td>'.$item->registrant->registrant_state.'</td><td></td></tr>';	
	$html_text .= '<tr id="509" style="display:none"><td><b>registrant_country_code</b></td><td>'.$item->registrant->registrant_country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="5010" style="display:none"><td><b>registrant_country_name</b></td><td>'.$item->registrant->registrant_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="5011" style="display:none"><td><b>registrant_country_language</b></td><td>'.$item->registrant->registrant_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="5012" style="display:none"><td><b>registrant_protected</b></td><td>'.$item->registrant->registrant_protected.'</td><td id="registrant_protected" style="font-style:italic"></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
