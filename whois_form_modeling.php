...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("domain_renewed").innerText = newfield + ": Zoekmachines kunnen filteren op 'actief' samen met de transactie niet ouder dan een jaar.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("domain_renewed").innerText = newfield + ": Search engines can filter by 'active' along with the transaction not older than one year.";
		document.getElementById("registrar_web_id").innerText = "";
		...
		document.getElementById("domain_renewed").innerText = newfield + " : Les moteurs de recherche peuvent filtrer par 'actif' avec la transaction datant de moins d'un an.";
		document.getElementById("registrar_web_id").innerText = "";
