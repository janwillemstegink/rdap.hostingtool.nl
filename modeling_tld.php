...
if (true or $pd == mb_strtolower($data[$pd]['domain']['ascii_name']) or empty($data[$pd]['domain']['ascii_name']))	{
	...
	$html_text .= '<tr id="419" style="display:table-row"><td>tld_services_uri</td><td>'.((!empty($data[$pd]['root_zone']['tld_services_uri'])) ? '<a href='.$data[$pd]['root_zone']['tld_services_uri'].' target="_blank">TLD Services</a>' : '').'</td><td id="root_zone_tld_services_uri"></td></tr>';
	$html_text .= '<tr id="4110" style="display:table-row"><td>tld_standardized_prices_uri</td><td>'.((!empty($data[$pd]['root_zone']['tld_standardized_prices_uri'])) ? '<a href='.$data[$pd]['root_zone']['tld_standardized_prices_uri'].' target="_blank">TLD Prices</a>' : '').'</td><td id="root_zone_tld_standardized_prices_uri"></td></tr>';
	...
	$html_text .= '<tr id="4112" style="display:table-row"><td>tld_json_response_uri</td><td>'.((!empty($data[$pd]['root_zone']['tld_json_response_uri'])) ? '<a href='.$data[$pd]['root_zone']['tld_json_response_uri'].' target="_blank">TLD Data</a>' : '').'</td><td id="root_zone_tld_json_response_uri"></td></tr>';
	$html_text .= '<tr id="4113" style="display:table-row"><td>tld_terms_of_service_uri</td><td>'.((!empty($data[$pd]['root_zone']['tld_terms_of_service_uri'])) ? '<a href='.$data[$pd]['root_zone']['tld_terms_of_service_uri'].' target="_blank">TLD Terms</a>' : '').'</td><td id="root_zone_tld_terms_of_service_uri"></td></tr>';
	$html_text .= '<tr id="4114" style="display:table-row"><td>tld_privacy_policy_uri</td><td>'.((!empty($data[$pd]['root_zone']['tld_privacy_policy_uri'])) ? '<a href='.$data[$pd]['root_zone']['tld_privacy_policy_uri'].' target="_blank">TLD Privacy</a>' : '').'</td><td id="root_zone_tld_privacy_policy_uri"></td></tr>';
