...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td COLSPAN="2">Als u als registrant toegang heeft tot het menu, dan bent u primair verantwoordelijk.</td></tr>';
...
$html_text .= '<tr><td COLSPAN="2">team.blue nl B.V. has changed the registrant of webhostingtech.nl, as mentioned above.</td></tr>';
...
$html_text .= '<tr><td COLSPAN="2">If you as a registrant have access to the menu, you are primarily responsible.</td></tr>';
$html_text .= '<tr><td COLSPAN="2"><br />Kind regards</td></tr>';
$html_text .= '<tr><td COLSPAN="2">SIDN - Essential Services Provider</td></tr>';
