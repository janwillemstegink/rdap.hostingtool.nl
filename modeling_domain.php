...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="105" style="display:none"><td>zone_country_language</td><td>'.$item->zone->zone_country_language.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4013" style="display:none"><td>registrar_country_language</td><td>'.$item->registrar->registrar_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="4014" style="display:none"><td>registrar_protected</td><td>'.$item->registrar->registrar_protected.'</td><td id="registrar_protected"></td></tr>';
	...
	if (!empty($item->reseller->reseller_trade_name))	{
		if (strlen(trim($item->reseller->reseller_trade_name)))	{
			...
			$html_text .= '<tr id="5011" style="display:none"><td>reseller_country_language</td><td>'.$item->reseller->reseller_country_language.'</td><td></td></tr>';
			$html_text .= '<tr id="5012" style="display:none"><td>reseller_protected</td><td>'.$item->reseller->reseller_protected.'</td><td id="reseller_protected"></td></tr>';
			$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
		}	
	}
	...
	$html_text .= '<tr id="6010" style="display:none"><td>registrant_country_language</td><td>'.$item->registrant->registrant_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="6011" style="display:none"><td>registrant_protected</td><td>'.$item->registrant->registrant_protected.'</td><td id="registrant_protected"></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="7012" style="display:none"><td>admin_country_language</td><td>'.$item->admin->admin_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="7013" style="display:none"><td>admin_protected</td><td>'.$item->admin->admin_protected.'</td><td id="admin_protected"></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="8012" style="display:none"><td>tech_country_language</td><td>'.$item->tech->tech_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="8013" style="display:none"><td>tech_protected</td><td>'.$item->tech->tech_protected.'</td><td id="tech_protected"></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="9013" style="display:none"><td>billing_country_language</td><td>'.$item->billing->billing_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="9014" style="display:none"><td>billing_protected</td><td>'.$item->billing->billing_protected.'</td><td id="billing_protected"></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
