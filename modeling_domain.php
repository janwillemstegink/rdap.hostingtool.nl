...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("registrar_shielded").textContent = proposed;
		...
		document.getElementById("registrant_city").textContent = address;
		document.getElementById("registrant_postal_code").textContent = address;
		document.getElementById("registrant_country_name").textContent = "De landnaam is beperkt tot registrar informatie in de zogenaamde 'registrar RDAP-query'.";
		...
		document.getElementById("raw_data_next").textContent = "De volgorde van verantwoordelijkheid moet leidend zijn voor de weergave. 'None Specified' is een term van deze tool.";	
	}
		...
		document.getElementById("raw_data_next").textContent = "The order of responsibility should be leading for display. 'None Specified' is a term of this tool.";
	}
		...
		document.getElementById("raw_data_next").textContent = "Die Reihenfolge der Zuständigkeit sollte bei der Anzeige an erster Stelle stehen. 'None Specified' ist ein Begriff dieses Tools.";
	}
		...
		document.getElementById("raw_data_next").textContent = "L'ordre de responsabilité doit être le premier à être affiché. 'None Specified' est un terme de cet outil.";
	}
}	
</script><?php
echo '</head>';
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="101" style="display:none"><td>zone_language</td><td>'.$item->zone->language.'</td><td></td></tr>';
	$html_text .= '<tr id="102" style="display:none"><td>zone_delegation</td><td><a href='.$item->zone->delegation.' target="_blank">IANA Delegation Data</a></td><td id="zone_delegation"></td></tr>';
	$html_text .= '<tr id="103" style="display:none"><td>zone_regmenu</td><td>'.$item->zone->regmenu.'</td><td id="zone_regmenu"></td></tr>';
	...
	$html_text .= '<tr id="301" style="display:none"><td>domain_handle</td><td>'.$item->details->handle.'</td><td></td></tr>';
	$html_text .= '<tr id="302" style="display:none"><td>domain_name_ascii</td><td>'.$item->details->name_ascii.'</td><td id="domain_name_ascii"></td></tr>';
	$html_text .= '<tr id="303" style="display:none"><td>domain_name_unicode</td><td>'.$item->details->name_unicode.'</td><td id="domain_name_unicode"></td></tr>';
	$html_text .= '<tr style="vertical-align:top"><td>domain_status_values</td><td><b>'.$item->details->status_values.'</b></td><td id="domain_status_values"></td></tr>';
	$html_text .= '<tr id="304" style="display:none"><td>domain_event_registration</td><td>'.$item->details->event_registration.'</td><td></td></tr>';
	$html_text .= '<tr id="305" style="display:none"><td>domain_event_last_transferred</td><td>'.$item->details->event_last_transferred.'</td><td></td></tr>';
	$html_text .= '<tr id="306" style="display:none"><td>domain_event_last_changed</td><td>'.$item->details->event_last_changed.'</td><td></td></tr>';
	$html_text .= '<tr><td>domain_event_expiration</td><td>'.$item->details->event_expiration.'</td><td id="domain_event_expiration"></td></tr>';
	$html_text .= '<tr id="307" style="display:none"><td>domain_event_recovery_until</td><td>'.$item->details->event_recovery_until.'</td><td id="domain_event_recovery_until"></td></tr>';
	$html_text .= '<tr id="308" style="display:none"><td>domain_event_deletion</td><td>'.$item->details->event_deletion.'</td><td id="domain_event_deletion"></td></tr>';
	$html_text .= '<tr id="309" style="display:none"><td>domain_event_last_uploaded</td><td>'.$item->details->event_last_uploaded.'</td><td id="domain_event_last_uploaded"></td></tr>';
	$html_text .= '<tr id="3010" style="display:none;vertical-align:top"><td>domain_extensions_values</td><td><b>'.$item->details->extensions_values.'</b></td><td id="domain_extensions_values"></td></tr>';
	$html_text .= '<tr id="3011" style="display:none;vertical-align:top"><td>domain_remark_values</td><td>'.$item->details->remark_values.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="401" style="display:none"><td>registrant_handle</td><td>'.$item->registrant->handle.'</td><td></td></tr>';
	$html_text .= '<tr id="402" style="display:none"><td>registrant_web_id</td><td>'.$item->registrant->web_id.'</td><td id="registrant_web_id"></td></tr>';
	$html_text .= '<tr><td>registrant_full_name</td><td><b>'.$item->registrant->full_name.'</b></td><td id="registrant_full_name"></td></tr>';
	$html_text .= '<tr><td>registrant_kind</td><td>'.$item->registrant->kind.'</td><td id="registrant_kind"></td></tr>';
	$html_text .= '<tr id="403" style="display:none"><td>registrant_name</td><td><b>'.$item->registrant->name.'</b></td><td id="registrant_name"></td></tr>';
	$html_text .= '<tr id="404" style="display:none"><td>registrant_email</td><td>'.$item->registrant->email.'</td><td></td></tr>';
	$html_text .= '<tr id="405" style="display:none"><td>registrant_tel</td><td>'.$item->registrant->tel.'</td><td></td></tr>';
	$html_text .= '<tr><td>registrant_country_code (<a style="font-size: 0.9rem" href="https://icann-hamster.nl/ham/soac/ccnso/techday/icann80/2.%20RDAP%20Conformance%20Tool%20-%20Tech%20Day.pdf" target="_blank">cc parameter</a>)</td><td><b>'.$item->registrant->country_code.'</b></td><td id="registrant_country_code"></td></tr>';
	$html_text .= '<tr id="406" style="display:none"><td>registrant_street</td><td>'.$item->registrant->street.'</td><td id="registrant_street"></td></tr>';
	$html_text .= '<tr id="407" style="display:none"><td>registrant_city</td><td>'.$item->registrant->city.'</td><td id="registrant_city"></td></tr>';
	$html_text .= '<tr id="408" style="display:none"><td>registrant_state_province</td><td>'.$item->registrant->state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="409" style="display:none"><td>registrant_postal_code</td><td>'.$item->registrant->postal_code.'</td><td id="registrant_postal_code"></td></tr>';
	$html_text .= '<tr id="4010" style="display:none"><td>registrant_country_name</td><td>'.$item->registrant->country_name.'</td><td id="registrant_country_name"></td></tr>';
	$html_text .= '<tr><td>registrant_organization</td><td><b>'.$item->registrant->organization.'</b></td><td></td></tr>';
	$html_text .= '<tr id="4011" style="display:none"><td>registrant_language_pref_1</td><td>'.$item->registrant->language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="4012" style="display:none"><td>registrant_language_pref_2</td><td>'.$item->registrant->language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="4013" style="display:none"><td>registrant_shielded</td><td>'.$item->registrant->shielded.'</td><td id="registrant_shielded"></td></tr>';
	$html_text .= '<tr id="4014" style="display:none;vertical-align:top"><td>registrant_status_values</td><td>'.$item->registrant->status_values.'</td><td></td></tr>';
	$html_text .= '<tr id="4015" style="display:none"><td>registrant_event_registration</td><td>'.$item->registrant->event_registration.'</td><td></td></tr>';
	$html_text .= '<tr id="4016" style="display:none"><td>registrant_event_last_transferred</td><td>'.$item->registrant->event_last_transferred.'</td><td></td></tr>';
	$html_text .= '<tr id="4017" style="display:none"><td>registrant_event_last_changed</td><td>'.$item->registrant->event_last_changed.'</td><td></td></tr>';
	$html_text .= '<tr id="4018" style="display:none"><td>registrant_event_expiration</td><td>'.$item->registrant->event_expiration.'</td><td></td></tr>';
	$html_text .= '<tr id="4019" style="display:none"><td>registrant_event_deletion</td><td>'.$item->registrant->event_deletion.'</td><td id="registrant_event_deletion"></td></tr>';
	$html_text .= '<tr id="4020" style="display:none"><td>registrant_event_last_uploaded</td><td>'.$item->registrant->event_last_uploaded.'</td><td id="registrant_event_last_uploaded"></td></tr>';
	$html_text .= '<tr id="4021" style="display:none"><td>registrant_event_verification_received</td><td>'.$item->registrant->event_verification_received.'</td><td id="registrant_event_verification_received"></td></tr>';
	$html_text .= '<tr id="4022" style="display:none"><td>registrant_event_verification_set</td><td>'.$item->registrant->event_verification_set.'</td><td id="registrant_event_verification_set"></td></tr>';
	$html_text .= '<tr id="4023" style="display:none;vertical-align:top"><td>registrant_properties</td><td>'.$item->registrant->properties.'</td><td></td></tr>';
	$html_text .= '<tr id="4024" style="display:none;vertical-align:top"><td>registrant_remark_values</td><td>'.$item->registrant->remark_values.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="411" style="display:none"><td>administrative_handle</td><td>'.$item->administrative->handle.'</td><td></td></tr>';
	$html_text .= '<tr id="412" style="display:none"><td>administrative_web_id</td><td>'.$item->administrative->web_id.'</td><td id="administrative_web_id"></td></tr>';
	$html_text .= '<tr id="413" style="display:none"><td>administrative_full_name</td><td>'.$item->administrative->full_name.'</td><td></td></tr>';
	$html_text .= '<tr id="414" style="display:none"><td>administrative_kind</td><td>'.$item->administrative->kind.'</td><td></td></tr>';
	$html_text .= '<tr id="415" style="display:none"><td>administrative_name</td><td>'.$item->administrative->name.'</td><td></td></tr>';
	$html_text .= '<tr><td>administrative_email</td><td>'.$item->administrative->email.'</td><td></td></tr>';
	$html_text .= '<tr id="416" style="display:none"><td>administrative_tel</td><td>'.$item->administrative->tel.'</td><td></td></tr>';
	$html_text .= '<tr id="417" style="display:none"><td>administrative_country_code</td><td>'.$item->administrative->country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="418" style="display:none"><td>administrative_street</td><td>'.$item->administrative->street.'</td><td></td></tr>';
	$html_text .= '<tr id="419" style="display:none"><td>administrative_city</td><td>'.$item->administrative->city.'</td><td></td></tr>';
	$html_text .= '<tr id="4110" style="display:none"><td>administrative_state_province</td><td>'.$item->administrative->state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="4111" style="display:none"><td>administrative_postal_code</td><td>'.$item->administrative->postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="4112" style="display:none"><td>administrative_country_name</td><td>'.$item->administrative->country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="4113" style="display:none"><td>administrative_organization</td><td>'.$item->administrative->organization.'</td><td></td></tr>';
	$html_text .= '<tr id="4114" style="display:none"><td>administrative_language_pref_1</td><td>'.$item->administrative->language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="4115" style="display:none"><td>administrative_language_pref_2</td><td>'.$item->administrative->language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="4116" style="display:none"><td>administrative_shielded</td><td>'.$item->administrative->shielded.'</td><td id="administrative_shielded"></td></tr>';
	$html_text .= '<tr id="4117" style="display:none;vertical-align:top"><td>administrative_properties</td><td>'.$item->administrative->properties.'</td><td></td></tr>';
	$html_text .= '<tr id="4118" style="display:none;vertical-align:top"><td>administrative_remark_values</td><td>'.$item->administrative->remark_values.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="421" style="display:none"><td>technical_handle</td><td>'.$item->technical->handle.'</td><td></td></tr>';
	$html_text .= '<tr id="422" style="display:none"><td>technical_web_id</td><td>'.$item->technical->web_id.'</td><td id="technical_web_id"></td></tr>';
	$html_text .= '<tr id="423" style="display:none"><td>technical_full_name</td><td>'.$item->technical->full_name.'</td><td></td></tr>';
	$html_text .= '<tr id="424" style="display:none"><td>technical_kind</td><td>'.$item->technical->kind.'</td><td></td></tr>';
	$html_text .= '<tr id="425" style="display:none"><td>technical_name</td><td>'.$item->technical->name.'</td><td></td></tr>';
	$html_text .= '<tr><td>technical_email</td><td>'.$item->technical->email.'</td><td></td></tr>';
	$html_text .= '<tr id="426" style="display:none"><td>technical_tel</td><td>'.$item->technical->tel.'</td><td></td></tr>';
	$html_text .= '<tr id="427" style="display:none"><td>technical_country_code</td><td>'.$item->technical->country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="428" style="display:none"><td>technical_street</td><td>'.$item->technical->street.'</td><td></td></tr>';
	$html_text .= '<tr id="429" style="display:none"><td>technical_city</td><td>'.$item->technical->city.'</td><td></td></tr>';
	$html_text .= '<tr id="4210" style="display:none"><td>technical_state_province</td><td>'.$item->technical->state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="4211" style="display:none"><td>technical_postal_code</td><td>'.$item->technical->postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="4212" style="display:none"><td>technical_country_name</td><td>'.$item->technical->country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="4213" style="display:none"><td>technical_organization</td><td>'.$item->technical->organization.'</td><td></td></tr>';
	$html_text .= '<tr id="4214" style="display:none"><td>technical_language_pref_1</td><td>'.$item->technical->language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="4215" style="display:none"><td>technical_language_pref_2</td><td>'.$item->technical->language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="4216" style="display:none"><td>technical_shielded</td><td>'.$item->technical->shielded.'</td><td id="technical_shielded"></td></tr>';
	$html_text .= '<tr id="4217" style="display:none;vertical-align:top"><td>technical_properties</td><td>'.$item->technical->properties.'</td><td></td></tr>';
	$html_text .= '<tr id="4218" style="display:none;vertical-align:top"><td>technical_remark_values</td><td>'.$item->technical->remark_values.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="431" style="display:none"><td>billing_handle</td><td>'.$item->billing->handle.'</td><td></td></tr>';
	$html_text .= '<tr id="432" style="display:none"><td>billing_web_id</td><td>'.$item->billing->web_id.'</td><td></td></tr>';
	$html_text .= '<tr id="433" style="display:none"><td>billing_full_name</td><td>'.$item->billing->full_name.'</td><td></td></tr>';
	$html_text .= '<tr id="434" style="display:none"><td>billing_kind</td><td>'.$item->billing->kind.'</td><td></td></tr>';
	$html_text .= '<tr id="435" style="display:none"><td>billing_name</td><td>'.$item->billing->name.'</td><td></td></tr>';
	$html_text .= '<tr id="436" style="display:none"><td>billing_email</td><td>'.$item->billing->email.'</td><td></td></tr>';
	$html_text .= '<tr id="437" style="display:none"><td>billing_tel</td><td>'.$item->billing->tel.'</td><td></td></tr>';
	$html_text .= '<tr id="438" style="display:none"><td>billing_country_code</td><td>'.$item->billing->country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="439" style="display:none"><td>billing_street</td><td>'.$item->billing->street.'</td><td></td></tr>';
	$html_text .= '<tr id="4310" style="display:none"><td>billing_city</td><td>'.$item->billing->city.'</td><td></td></tr>';
	$html_text .= '<tr id="4311" style="display:none"><td>billing_state_province</td><td>'.$item->billing->state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="4312" style="display:none"><td>billing_postal_code</td><td>'.$item->billing->postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="4313" style="display:none"><td>billing_country_name</td><td>'.$item->billing->country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="4314" style="display:none"><td>billing_organization</td><td>'.$item->billing->organization.'</td><td></td></tr>';
	$html_text .= '<tr id="4315" style="display:none"><td>billing_language_pref_1</td><td>'.$item->billing->language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="4316" style="display:none"><td>billing_language_pref_2</td><td>'.$item->billing->language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="4317" style="display:none"><td>billing_shielded</td><td>'.$item->billing->shielded.'</td><td id="billing_shielded"></td></tr>';
	$html_text .= '<tr id="4318" style="display:none;vertical-align:top"><td>billing_properties</td><td>'.$item->billing->properties.'</td><td></td></tr>';	
	$html_text .= '<tr id="4319" style="display:none;vertical-align:top"><td>billing_remark_values</td><td>'.$item->billing->remark_values.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="441" style="display:none"><td>emergency_handle</td><td>'.$item->emergency->handle.'</td><td></td></tr>';
	$html_text .= '<tr id="442" style="display:none"><td>emergency_web_id</td><td>'.$item->emergency->web_id.'</td><td id="emergency_web_id"></td></tr>';
	$html_text .= '<tr id="443" style="display:none"><td>emergency_full_name</td><td>'.$item->emergency->full_name.'</td><td></td></tr>';
	$html_text .= '<tr id="444" style="display:none"><td>emergency_kind</td><td>'.$item->emergency->kind.'</td><td></td></tr>';
	$html_text .= '<tr id="445" style="display:none"><td>emergency_name</td><td>'.$item->emergency->name.'</td><td></td></tr>';
	$html_text .= '<tr id="446" style="display:none"><td>emergency_email</td><td>'.$item->emergency->email.'</td><td></td></tr>';
	$html_text .= '<tr id="447" style="display:none"><td>emergency_tel</td><td>'.$item->emergency->tel.'</td><td></td></tr>';
	$html_text .= '<tr id="448" style="display:none"><td>emergency_country_code</td><td>'.$item->emergency->country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="449" style="display:none"><td>emergency_street</td><td>'.$item->emergency->street.'</td><td></td></tr>';
	$html_text .= '<tr id="4410" style="display:none"><td>emergency_city</td><td>'.$item->emergency->city.'</td><td></td></tr>';
	$html_text .= '<tr id="4411" style="display:none"><td>emergency_state_province</td><td>'.$item->emergency->state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="4412" style="display:none"><td>emergency_postal_code</td><td>'.$item->emergency->postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="4413" style="display:none"><td>emergency_country_name</td><td>'.$item->emergency->country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="4414" style="display:none"><td>emergency_organization</td><td>'.$item->emergency->organization.'</td><td></td></tr>';
	$html_text .= '<tr id="4415" style="display:none"><td>emergency_language_pref_1</td><td>'.$item->emergency->language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="4416" style="display:none"><td>emergency_language_pref_2</td><td>'.$item->emergency->language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="4417" style="display:none"><td>emergency_shielded</td><td>'.$item->emergency->shielded.'</td><td id="emergency_shielded"></td></tr>';
	$html_text .= '<tr id="4418" style="display:none;vertical-align:top"><td>emergency_properties</td><td>'.$item->emergency->properties.'</td><td></td></tr>';
	$html_text .= '<tr id="4419" style="display:none;vertical-align:top"><td>emergency_remark_values</td><td>'.$item->emergency->remark_values.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="501" style="display:none"><td>reseller_handle</td><td>'.$item->reseller->handle.'</td><td></td></tr>';
	$html_text .= '<tr id="502" style="display:none"><td>reseller_web_id</td><td>'.$item->reseller->web_id.'</td><td id="reseller_web_id"></td></tr>';
	$html_text .= '<tr><td>reseller_full_name</td><td>'.$item->reseller->full_name.'</td><td></td></tr>';
	$html_text .= '<tr id="503" style="display:none"><td>reseller_kind</td><td>'.$item->reseller->kind.'</td><td></td></tr>';
	$html_text .= '<tr id="504" style="display:none"><td>reseller_name</td><td>'.$item->reseller->name.'</td><td></td></tr>';
	$html_text .= '<tr id="505" style="display:none"><td>reseller_email</td><td>'.$item->reseller->email.'</td><td></td></tr>';
	$html_text .= '<tr id="506" style="display:none"><td>reseller_tel</td><td>'.$item->reseller->tel.'</td><td></td></tr>';
	$html_text .= '<tr id="507" style="display:none"><td>reseller_country_code</td><td>'.$item->reseller->country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="508" style="display:none"><td>reseller_street</td><td>'.$item->reseller->street.'</td><td></td></tr>';
	$html_text .= '<tr id="509" style="display:none"><td>reseller_city</td><td>'.$item->reseller->city.'</td><td></td></tr>';
	$html_text .= '<tr id="5010" style="display:none"><td>reseller_state_province</td><td>'.$item->reseller->state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="5011" style="display:none"><td>reseller_postal_code</td><td>'.$item->reseller->postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="5012" style="display:none"><td>reseller_country_name</td><td>'.$item->reseller->country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="5013" style="display:none"><td>reseller_organization</td><td>'.$item->reseller->organization.'</td><td></td></tr>';
	$html_text .= '<tr id="5014" style="display:none"><td>reseller_language_pref_1</td><td>'.$item->reseller->language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="5015" style="display:none"><td>reseller_language_pref_2</td><td>'.$item->reseller->language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="5016" style="display:none"><td>reseller_shielded</td><td>'.$item->reseller->shielded.'</td><td id="reseller_shielded"></td></tr>';
	$html_text .= '<tr id="5017" style="display:none;vertical-align:top"><td>reseller_status_values</td><td>'.$item->reseller->status_values.'</td><td></td></tr>';
	$html_text .= '<tr id="5018" style="display:none"><td>reseller_event_registration</td><td>'.$item->reseller->event_registration.'</td><td></td></tr>';
	$html_text .= '<tr id="5019" style="display:none"><td>reseller_event_last_transferred</td><td>'.$item->reseller->event_last_transferred.'</td><td></td></tr>';
	$html_text .= '<tr id="5020" style="display:none"><td>reseller_event_last_changed</td><td>'.$item->reseller->event_last_changed.'</td><td></td></tr>';
	$html_text .= '<tr id="5021" style="display:none"><td>reseller_event_expiration</td><td>'.$item->reseller->event_expiration.'</td><td></td></tr>';
	$html_text .= '<tr id="5022" style="display:none"><td>reseller_event_deletion</td><td>'.$item->reseller->event_deletion.'</td><td></td></tr>';
	$html_text .= '<tr id="5023" style="display:none"><td>reseller_event_last_uploaded</td><td>'.$item->reseller->event_last_uploaded.'</td><td></td></tr>';
	$html_text .= '<tr id="5024" style="display:none"><td>reseller_event_verification_received</td><td>'.$item->reseller->event_verification_received.'</td><td id="reseller_event_verification_received"></td></tr>';
	$html_text .= '<tr id="5025" style="display:none"><td>reseller_event_verification_set</td><td>'.$item->reseller->event_verification_set.'</td><td id="reseller_event_verification_set"></td></tr>';
	$html_text .= '<tr id="5026" style="display:none;vertical-align:top"><td>reseller_properties</td><td>'.$item->reseller->properties.'</td><td></td></tr>';
	$html_text .= '<tr id="5027" style="display:none;vertical-align:top"><td>reseller_remark_values</td><td>'.$item->reseller->remark_values.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="601" style="display:none"><td>registrar_handle</td><td>'.$item->registrar->handle.'</td><td></td></tr>';
	$html_text .= '<tr id="602" style="display:none"><td>registrar_web_id</td><td>'.$item->registrar->web_id.'</td><td id="registrar_web_id"></td></tr>';		
	$html_text .= '<tr><td>registrar_full_name</td><td>'.$item->registrar->full_name.'</td><td id="registrar_recover"></td></tr>';
	$html_text .= '<tr id="603" style="display:none"><td>registrar_kind</td><td>'.$item->registrar->kind.'</td><td></td></tr>';
	$html_text .= '<tr id="604" style="display:none"><td>registrar_url</td><td>'.$item->registrar->url.'</td><td></td></tr>';
	$html_text .= '<tr id="605" style="display:none"><td>registrar_iana_id</td><td>'.$item->registrar->iana_id.'</td><td id="registrar_iana_id"></td></tr>';
	$html_text .= '<tr id="606" style="display:none"><td>registrar_name</td><td>'.$item->registrar->name.'</td><td></td></tr>';
	$html_text .= '<tr id="607" style="display:none"><td>registrar_email</td><td>'.$item->registrar->email.'</td><td></td></tr>';
	$html_text .= '<tr id="608" style="display:none"><td>registrar_tel</td><td>'.$item->registrar->tel.'</td><td></td></tr>';
	$html_text .= '<tr id="609" style="display:none"><td>registrar_country_code</td><td>'.$item->registrar->country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="6010" style="display:none"><td>registrar_street</td><td>'.$item->registrar->street.'</td><td></td></tr>';
	$html_text .= '<tr id="6011" style="display:none"><td>registrar_city</td><td>'.$item->registrar->city.'</td><td></td></tr>';
	$html_text .= '<tr id="6012" style="display:none"><td>registrar_state_province</td><td>'.$item->registrar->state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="6013" style="display:none"><td>registrar_postal_code</td><td>'.$item->registrar->postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="6014" style="display:none"><td>registrar_country_name</td><td>'.$item->registrar->country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="6015" style="display:none"><td>registrar_organization</td><td>'.$item->registrar->organization.'</td><td></td></tr>';
	$html_text .= '<tr id="6016" style="display:none"><td>registrar_language_pref_1</td><td>'.$item->registrar->language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="6017" style="display:none"><td>registrar_language_pref_2</td><td>'.$item->registrar->language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="6018" style="display:none"><td>registrar_shielded</td><td>'.$item->registrar->shielded.'</td><td id="registrar_shielded"></td></tr>';
	$html_text .= '<tr id="6019" style="display:none;vertical-align:top"><td>registrar_status_values</td><td>'.$item->registrar->status_values.'</td><td></td></tr>';
	$html_text .= '<tr id="6020" style="display:none"><td>registrar_event_registration</td><td>'.$item->registrar->event_registration.'</td><td></td></tr>';
	$html_text .= '<tr id="6021" style="display:none"><td>registrar_event_last_transferred</td><td>'.$item->registrar->event_last_transferred.'</td><td></td></tr>';
	$html_text .= '<tr id="6022" style="display:none"><td>registrar_event_last_changed</td><td>'.$item->registrar->event_last_changed.'</td><td></td></tr>';
	$html_text .= '<tr id="6023" style="display:none"><td>registrar_event_expiration</td><td>'.$item->registrar->event_expiration.'</td><td></td></tr>';
	$html_text .= '<tr id="6024" style="display:none"><td>registrar_event_deletion</td><td>'.$item->registrar->event_deletion.'</td><td></td></tr>';
	$html_text .= '<tr id="6025" style="display:none"><td>registrar_event_last_uploaded</td><td>'.$item->registrar->event_last_uploaded.'</td><td></td></tr>';
	$html_text .= '<tr id="6026" style="display:none"><td>registrar_event_verification_received</td><td>'.$item->registrar->event_verification_received.'</td><td id="registrar_event_verification_received"></td></tr>';
	$html_text .= '<tr id="6027" style="display:none"><td>registrar_event_verification_set</td><td>'.$item->registrar->event_verification_set.'</td><td id="registrar_event_verification_set"></td></tr>';
	$html_text .= '<tr id="6028" style="display:none;vertical-align:top"><td>registrar_properties</td><td>'.$item->registrar->properties.'</td><td></td></tr>';
	$html_text .= '<tr id="6029" style="display:none;vertical-align:top"><td>registrar_remark_values</td><td>'.$item->registrar->remark_values.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="611" style="display:none"><td>registrar_abuse_full_name</td><td>'.$item->registrar->abuse_full_name.'</td><td></td></tr>';
	$html_text .= '<tr id="612" style="display:none"><td>registrar_abuse_email</td><td>'.$item->registrar->abuse_email.'</td><td></td></tr>';
	$html_text .= '<tr id="613" style="display:none"><td>registrar_abuse_tel</td><td>'.$item->registrar->abuse_tel.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="621" style="display:none"><td>sponsor_handle</td><td>'.$item->sponsor->handle.'</td><td></td></tr>';
	$html_text .= '<tr id="622" style="display:none"><td>sponsor_web_id</td><td>'.$item->sponsor->web_id.'</td><td id="sponsor_web_id"></td></tr>';		
	$html_text .= '<tr><td>sponsor_full_name</td><td>'.$item->sponsor->full_name.'</td><td id="sponsor_recover"></td></tr>';
	$html_text .= '<tr id="623" style="display:none"><td>sponsor_kind</td><td>'.$item->sponsor->kind.'</td><td></td></tr>';
	$html_text .= '<tr id="624" style="display:none"><td>sponsor_url</td><td>'.$item->sponsor->url.'</td><td></td></tr>';
	$html_text .= '<tr id="625" style="display:none"><td>sponsor_iana_id</td><td>'.$item->sponsor->iana_id.'</td><td></td></tr>';
	$html_text .= '<tr id="626" style="display:none"><td>sponsor_name</td><td>'.$item->sponsor->name.'</td><td></td></tr>';
	$html_text .= '<tr id="627" style="display:none"><td>sponsor_email</td><td>'.$item->sponsor->email.'</td><td></td></tr>';
	$html_text .= '<tr id="628" style="display:none"><td>sponsor_tel</td><td>'.$item->sponsor->tel.'</td><td></td></tr>';
	$html_text .= '<tr id="629" style="display:none"><td>sponsor_country_code</td><td>'.$item->sponsor->country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="6210" style="display:none"><td>sponsor_street</td><td>'.$item->sponsor->street.'</td><td></td></tr>';
	$html_text .= '<tr id="6211" style="display:none"><td>sponsor_city</td><td>'.$item->sponsor->city.'</td><td></td></tr>';
	$html_text .= '<tr id="6212" style="display:none"><td>sponsor_state_province</td><td>'.$item->sponsor->state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="6213" style="display:none"><td>sponsor_postal_code</td><td>'.$item->sponsor->postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="6214" style="display:none"><td>sponsor_country_name</td><td>'.$item->sponsor->country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="6215" style="display:none"><td>sponsor_organization</td><td>'.$item->sponsor->organization.'</td><td></td></tr>';
	$html_text .= '<tr id="6216" style="display:none"><td>sponsor_language_pref_1</td><td>'.$item->sponsor->language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="6217" style="display:none"><td>sponsor_language_pref_2</td><td>'.$item->sponsor->language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="6218" style="display:none"><td>sponsor_shielded</td><td>'.$item->sponsor->shielded.'</td><td></td></tr>';
	$html_text .= '<tr id="6219" style="display:none;vertical-align:top"><td>sponsor_status_values</td><td>'.$item->sponsor->status_values.'</td><td></td></tr>';
	$html_text .= '<tr id="6220" style="display:none"><td>sponsor_event_registration</td><td>'.$item->sponsor->event_registration.'</td><td></td></tr>';
	$html_text .= '<tr id="6221" style="display:none"><td>sponsor_event_last_transferred</td><td>'.$item->sponsor->event_last_transferred.'</td><td></td></tr>';
	$html_text .= '<tr id="6222" style="display:none"><td>sponsor_event_last_changed</td><td>'.$item->sponsor->event_last_changed.'</td><td></td></tr>';
	$html_text .= '<tr id="6223" style="display:none"><td>sponsor_event_expiration</td><td>'.$item->sponsor->event_expiration.'</td><td></td></tr>';
	$html_text .= '<tr id="6224" style="display:none"><td>sponsor_event_deletion</td><td>'.$item->sponsor->event_deletion.'</td><td></td></tr>';
	$html_text .= '<tr id="6225" style="display:none"><td>sponsor_event_last_uploaded</td><td>'.$item->sponsor->event_last_uploaded.'</td><td></td></tr>';
	$html_text .= '<tr id="6226" style="display:none"><td>sponsor_event_verification_received</td><td>'.$item->sponsor->event_verification_received.'</td><td id="sponsor_event_verification_received"></td></tr>';
	$html_text .= '<tr id="6227" style="display:none"><td>sponsor_event_verification_set</td><td>'.$item->sponsor->event_verification_set.'</td><td id="sponsor_event_verification_set"></td></tr>';
	$html_text .= '<tr id="6228" style="display:none;vertical-align:top"><td>sponsor_properties</td><td>'.$item->sponsor->properties.'</td><td></td></tr>';
	$html_text .= '<tr id="6229" style="display:none;vertical-align:top"><td>sponsor_remark_values</td><td>'.$item->sponsor->remark_values.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr><td>name_servers_dnssec</td><td>'.$item->name_servers->dnssec.'</td><td id="name_servers_dnssec"></td></tr>';
	$html_text .= '<tr><td>name_servers_dnssec_algorithm</td><td>'.$item->name_servers->dnssec_algorithm.'</td><td id="name_servers_dnssec_algorithm"></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
