...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="418" style="display:none"><td>admin_city</td><td>'.$item->admin->admin_city.'</td><td></td></tr>';
	$html_text .= '<tr id="419" style="display:none"><td>admin_state_province</td><td>'.$item->admin->admin_state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="4110" style="display:none"><td>admin_postal_code</td><td>'.$item->admin->admin_postal_code.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="428" style="display:none"><td>tech_city</td><td>'.$item->tech->tech_city.'</td><td></td></tr>';
	$html_text .= '<tr id="429" style="display:none"><td>tech_state_province</td><td>'.$item->tech->tech_state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="4210" style="display:none"><td>tech_postal_code</td><td>'.$item->tech->tech_postal_code.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="439" style="display:none"><td>billing_city</td><td>'.$item->billing->billing_city.'</td><td></td></tr>';
	$html_text .= '<tr id="4310" style="display:none"><td>billing_state_province</td><td>'.$item->billing->billing_state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="4311" style="display:none"><td>billing_postal_code</td><td>'.$item->billing->billing_postal_code.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="449" style="display:none"><td>emergency_city</td><td>'.$item->emergency->emergency_city.'</td><td></td></tr>';
	$html_text .= '<tr id="4410" style="display:none"><td>emergency_state_province</td><td>'.$item->emergency->emergency_state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="4411" style="display:none"><td>emergency_postal_code</td><td>'.$item->emergency->emergency_postal_code.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="6010" style="display:none"><td>registrar_city</td><td>'.$item->registrar->registrar_city.'</td><td></td></tr>';
	$html_text .= '<tr id="6011" style="display:none"><td>registrar_state_province</td><td>'.$item->registrar->registrar_state_province.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="6210" style="display:none"><td>sponsor_city</td><td>'.$item->sponsor->sponsor_city.'</td><td></td></tr>';
	$html_text .= '<tr id="6211" style="display:none"><td>sponsor_state_province</td><td>'.$item->sponsor->sponsor_state_province.'</td><td></td></tr>';
	$html_text .= '<tr id="6212" style="display:none"><td>sponsor_postal_code</td><td>'.$item->sponsor->sponsor_postal_code.'</td><td></td></tr>';
