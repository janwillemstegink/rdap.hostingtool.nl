...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="4010" style="display:none"><td>registrant_country</td><td>'.$item->registrant->registrant_country.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4112" style="display:none"><td>admin_country</td><td>'.$item->admin->admin_country.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4313" style="display:none"><td>billing_country</td><td>'.$item->billing->billing_country.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4413" style="display:none"><td>emergency_country</td><td>'.$item->emergency->emergency_country.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="5012" style="display:none"><td>reseller_country</td><td>'.$item->reseller->reseller_country.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="6014" style="display:none"><td>registrar_country</td><td>'.$item->registrar->registrar_country.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="6214" style="display:none"><td>sponsor_country</td><td>'.$item->sponsor->sponsor_country.'</td><td></td></tr>';
