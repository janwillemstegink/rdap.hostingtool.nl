...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("resources_role").textContent = "The /v1/ folder may also support /v2/ responses — see icann.com for details.";
		document.getElementById("resources_registrar_source").textContent = proposed + 'No registrar source URL is included in the current RDAP v1 response.';
		document.getElementById("resources_registrar_public_ids").textContent = proposed + "The IANA registrar accreditation ID for gTLDs must be accurate.";
		document.getElementById("resources_registrar_complaint_url").textContent = proposed + 'Required for IANA-accredited registrars; used to direct user complaints.';		
