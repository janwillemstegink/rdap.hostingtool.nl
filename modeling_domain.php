...
if (true or $pd == mb_strtolower($data[$pd]['details']['name_ascii']) or empty($data[$pd]['details']['name_ascii']))	{
	...
	$html_text .= '<tr><td>object registry_source</td><td>'.((strlen($data[$pd]['object']['registry_source'])) ? '<a href='.$data[$pd]['object']['registry_source'].' target="_blank">registry file</a> - <a href="' . htmlspecialchars($validation_registry, ENT_QUOTES, "UTF-8") . '" target="_blank">validator.rdap.org</a>' : 'none').'</td><td id="object_registry_source"></td></tr>';	
