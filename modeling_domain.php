...
<td><form action='.htmlentities($_SERVER['PHP_SELF']).' method="get">
	...
	<a style="font-size: 0.9rem" href="https://rdap.hostingtool.nl/modeling_email" target="_blank">modeling_email</a> / <a style="font-size: 0.9rem" href="https://rdap.hostingtool.nl/modeling_menu" target="_blank">modeling_menu</a> / <a style="font-size: 0.9rem" href="https://rdap.hostingtool.nl/server_headers/index.php?url='.$viewdomain.'" target="_blank">server_headers</a> / <a style="font-size: 0.9rem" href="https://github.com/janwillemstegink/rdap_view_model/issues" target="_blank">issues</a></td></tr>';
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="307" style="display:none"><td>domain_last_cycle_control</td><td>'.$item->domain_last_cycle_control.'</td><td id="domain_last_cycle_control"></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
