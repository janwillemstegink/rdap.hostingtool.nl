...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="101" style="display:none"><td>zone_language</td><td>'.$item->zone->zone_language.'</td><td></td></tr>';
	$html_text .= '<tr id="102" style="display:none"><td>zone_delegation</td><td><a href='.$item->zone->zone_delegation.' target="_blank">IANA Delegation Data</a></td><td id="zone_delegation"></td></tr>';
	$html_text .= '<tr id="103" style="display:none"><td>zone_regmenu</td><td>'.$item->zone->zone_regmenu.'</td><td id="zone_regmenu"></td></tr>';
	...
	$html_text .= '<tr><td>registrant_country_code <a style="font-size: 0.9rem" href="https://icann-hamster.nl/ham/soac/ccnso/techday/icann80/2.%20RDAP%20Conformance%20Tool%20-%20Tech%20Day.pdf" target="_blank">(cc parameter)</a></td><td><b>'.$item->registrant->registrant_country_code.'</b></td><td id="registrant_country_code"></td></tr>';
	$html_text .= '<tr id="406" style="display:none"><td>registrant_street</td><td>'.$item->registrant->registrant_street.'</td><td id="registrant_street"></td></tr>';
	$html_text .= '<tr id="407" style="display:none"><td>registrant_city</td><td>'.$item->registrant->registrant_city.'</td><td id="registrant_city"></td></tr>';
	...
	$html_text .= '<tr id="4113" style="display:none"><td>administrative_organization</td><td>'.$item->administrative->administrative_organization.'</td><td></td></tr>';
	$html_text .= '<tr id="4114" style="display:none"><td>administrative_language_pref_1</td><td>'.$item->administrative->administrative_language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="4115" style="display:none"><td>administrative_language_pref_2</td><td>'.$item->administrative->administrative_language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="4116" style="display:none"><td>administrative_shielded</td><td>'.$item->administrative->administrative_shielded.'</td><td id="administrative_shielded"></td></tr>';
	$html_text .= '<tr id="4117" style="display:none;vertical-align:top"><td>administrative_properties</td><td>'.$item->administrative->administrative_properties.'</td><td></td></tr>';
	$html_text .= '<tr id="4118" style="display:none;vertical-align:top"><td>administrative_remark_values</td><td>'.$item->administrative->administrative_remark_values.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4212" style="display:none"><td>technical_country_name</td><td>'.$item->technical->technical_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="4213" style="display:none"><td>technical_organization</td><td>'.$item->technical->technical_organization.'</td><td></td></tr>';
	$html_text .= '<tr id="4214" style="display:none"><td>technical_language_pref_1</td><td>'.$item->technical->technical_language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="4215" style="display:none"><td>technical_language_pref_2</td><td>'.$item->technical->technical_language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="4216" style="display:none"><td>technical_shielded</td><td>'.$item->technical->technical_shielded.'</td><td id="technical_shielded"></td></tr>';
	$html_text .= '<tr id="4217" style="display:none;vertical-align:top"><td>technical_properties</td><td>'.$item->technical->technical_properties.'</td><td></td></tr>';
	$html_text .= '<tr id="4218" style="display:none;vertical-align:top"><td>technical_remark_values</td><td>'.$item->technical->technical_remark_values.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="438" style="display:none"><td>billing_country_code</td><td>'.$item->billing->billing_country_code.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4312" style="display:none"><td>billing_postal_code</td><td>'.$item->billing->billing_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="4313" style="display:none"><td>billing_country_name</td><td>'.$item->billing->billing_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="4314" style="display:none"><td>billing_organization</td><td>'.$item->billing->billing_organization.'</td><td></td></tr>';
	$html_text .= '<tr id="4315" style="display:none"><td>billing_language_pref_1</td><td>'.$item->billing->billing_language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="4316" style="display:none"><td>billing_language_pref_2</td><td>'.$item->billing->billing_language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="4317" style="display:none"><td>billing_shielded</td><td>'.$item->billing->billing_shielded.'</td><td id="billing_shielded"></td></tr>';
	$html_text .= '<tr id="4318" style="display:none;vertical-align:top"><td>billing_properties</td><td>'.$item->billing->billing_properties.'</td><td></td></tr>';	
	$html_text .= '<tr id="4319" style="display:none;vertical-align:top"><td>billing_remark_values</td><td>'.$item->billing->billing_remark_values.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="448" style="display:none"><td>emergency_country_code</td><td>'.$item->emergency->emergency_country_code.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4412" style="display:none"><td>emergency_postal_code</td><td>'.$item->emergency->emergency_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="4413" style="display:none"><td>emergency_country_name</td><td>'.$item->emergency->emergency_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="4414" style="display:none"><td>emergency_organization</td><td>'.$item->emergency->emergency_organization.'</td><td></td></tr>';
	$html_text .= '<tr id="4415" style="display:none"><td>emergency_language_pref_1</td><td>'.$item->emergency->emergency_language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="4416" style="display:none"><td>emergency_language_pref_2</td><td>'.$item->emergency->emergency_language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="4417" style="display:none"><td>emergency_shielded</td><td>'.$item->emergency->emergency_shielded.'</td><td id="emergency_shielded"></td></tr>';
	$html_text .= '<tr id="4418" style="display:none;vertical-align:top"><td>emergency_properties</td><td>'.$item->emergency->emergency_properties.'</td><td></td></tr>';
	$html_text .= '<tr id="4419" style="display:none;vertical-align:top"><td>emergency_remark_values</td><td>'.$item->emergency->emergency_remark_values.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="507" style="display:none"><td>reseller_country_code</td><td>'.$item->reseller->reseller_country_code.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="5011" style="display:none"><td>reseller_postal_code</td><td>'.$item->reseller->reseller_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="5012" style="display:none"><td>reseller_country_name</td><td>'.$item->reseller->reseller_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="5013" style="display:none"><td>reseller_organization</td><td>'.$item->reseller->reseller_organization.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="5016" style="display:none"><td>reseller_shielded</td><td>'.$item->reseller->reseller_shielded.'</td><td id="reseller_shielded"></td></tr>';
	$html_text .= '<tr id="5017" style="display:none;vertical-align:top"><td>reseller_status_values</td><td>'.$item->reseller->reseller_status_values.'</td><td></td></tr>';
	$html_text .= '<tr id="5018" style="display:none"><td>reseller_event_registration</td><td>'.$item->reseller->reseller_event_registration.'</td><td></td></tr>';
	$html_text .= '<tr id="5019" style="display:none"><td>reseller_event_last_transferred</td><td>'.$item->reseller->reseller_event_last_transferred.'</td><td></td></tr>';
	$html_text .= '<tr id="5020" style="display:none"><td>reseller_event_last_changed</td><td>'.$item->reseller->reseller_event_last_changed.'</td><td></td></tr>';
	$html_text .= '<tr id="5021" style="display:none"><td>reseller_event_expiration</td><td>'.$item->reseller->reseller_event_expiration.'</td><td></td></tr>';
	$html_text .= '<tr id="5022" style="display:none"><td>reseller_event_deletion</td><td>'.$item->reseller->reseller_event_deletion.'</td><td></td></tr>';
	$html_text .= '<tr id="5023" style="display:none"><td>reseller_event_last_uploaded</td><td>'.$item->reseller->reseller_event_last_uploaded.'</td><td></td></tr>';
	$html_text .= '<tr id="5024" style="display:none"><td>reseller_event_verification_received</td><td>'.$item->reseller->reseller_event_verification_received.'</td><td id="reseller_event_verification_received"></td></tr>';
	$html_text .= '<tr id="5025" style="display:none"><td>reseller_event_verification_set</td><td>'.$item->reseller->reseller_event_verification_set.'</td><td id="reseller_event_verification_set"></td></tr>';
	$html_text .= '<tr id="5026" style="display:none;vertical-align:top"><td>reseller_properties</td><td>'.$item->reseller->reseller_properties.'</td><td></td></tr>';
	$html_text .= '<tr id="5027" style="display:none;vertical-align:top"><td>reseller_remark_values</td><td>'.$item->reseller->reseller_remark_values.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="609" style="display:none"><td>registrar_country_code</td><td>'.$item->registrar->registrar_country_code.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="6013" style="display:none"><td>registrar_postal_code</td><td>'.$item->registrar->registrar_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="6014" style="display:none"><td>registrar_country_name</td><td>'.$item->registrar->registrar_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="6015" style="display:none"><td>registrar_organization</td><td>'.$item->registrar->registrar_organization.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="6018" style="display:none"><td>registrar_shielded</td><td>'.$item->registrar->registrar_shielded.'</td><td id="registrar_shielded"></td></tr>';
	$html_text .= '<tr id="6019" style="display:none;vertical-align:top"><td>registrar_status_values</td><td>'.$item->registrar->registrar_status_values.'</td><td></td></tr>';
	$html_text .= '<tr id="6020" style="display:none"><td>registrar_event_registration</td><td>'.$item->registrar->registrar_event_registration.'</td><td></td></tr>';
	$html_text .= '<tr id="6021" style="display:none"><td>registrar_event_last_transferred</td><td>'.$item->registrar->registrar_event_last_transferred.'</td><td></td></tr>';
	$html_text .= '<tr id="6022" style="display:none"><td>registrar_event_last_changed</td><td>'.$item->registrar->registrar_event_last_changed.'</td><td></td></tr>';
	$html_text .= '<tr id="6023" style="display:none"><td>registrar_event_expiration</td><td>'.$item->registrar->registrar_event_expiration.'</td><td></td></tr>';
	$html_text .= '<tr id="6024" style="display:none"><td>registrar_event_deletion</td><td>'.$item->registrar->registrar_event_deletion.'</td><td></td></tr>';
	$html_text .= '<tr id="6025" style="display:none"><td>registrar_event_last_uploaded</td><td>'.$item->registrar->registrar_event_last_uploaded.'</td><td></td></tr>';
	$html_text .= '<tr id="6026" style="display:none"><td>registrar_event_verification_received</td><td>'.$item->registrar->registrar_event_verification_received.'</td><td id="registrar_event_verification_received"></td></tr>';
	$html_text .= '<tr id="6027" style="display:none"><td>registrar_event_verification_set</td><td>'.$item->registrar->registrar_event_verification_set.'</td><td id="registrar_event_verification_set"></td></tr>';
	...
	$html_text .= '<tr id="629" style="display:none"><td>sponsor_country_code</td><td>'.$item->sponsor->sponsor_country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="6210" style="display:none"><td>sponsor_street</td><td>'.$item->sponsor->sponsor_street.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="6213" style="display:none"><td>sponsor_postal_code</td><td>'.$item->sponsor->sponsor_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="6214" style="display:none"><td>sponsor_country_name</td><td>'.$item->sponsor->sponsor_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="6215" style="display:none"><td>sponsor_organization</td><td>'.$item->sponsor->sponsor_organization.'</td><td></td></tr>';
	$html_text .= '<tr id="6216" style="display:none"><td>sponsor_language_pref_1</td><td>'.$item->sponsor->sponsor_language_pref_1.'</td><td></td></tr>';
	$html_text .= '<tr id="6217" style="display:none"><td>sponsor_language_pref_2</td><td>'.$item->sponsor->sponsor_language_pref_2.'</td><td></td></tr>';
	$html_text .= '<tr id="6218" style="display:none"><td>sponsor_shielded</td><td>'.$item->sponsor->sponsor_shielded.'</td><td></td></tr>';
	$html_text .= '<tr id="6219" style="display:none;vertical-align:top"><td>sponsor_status_values</td><td>'.$item->sponsor->sponsor_status_values.'</td><td></td></tr>';
	$html_text .= '<tr id="6220" style="display:none"><td>sponsor_event_registration</td><td>'.$item->sponsor->sponsor_event_registration.'</td><td></td></tr>';
	$html_text .= '<tr id="6221" style="display:none"><td>sponsor_event_last_transferred</td><td>'.$item->sponsor->sponsor_event_last_transferred.'</td><td></td></tr>';
	$html_text .= '<tr id="6222" style="display:none"><td>sponsor_event_last_changed</td><td>'.$item->sponsor->sponsor_event_last_changed.'</td><td></td></tr>';
	$html_text .= '<tr id="6223" style="display:none"><td>sponsor_event_expiration</td><td>'.$item->sponsor->sponsor_event_expiration.'</td><td></td></tr>';
	$html_text .= '<tr id="6224" style="display:none"><td>sponsor_event_deletion</td><td>'.$item->sponsor->sponsor_event_deletion.'</td><td></td></tr>';
	$html_text .= '<tr id="6225" style="display:none"><td>sponsor_event_last_uploaded</td><td>'.$item->sponsor->sponsor_event_last_uploaded.'</td><td></td></tr>';
	$html_text .= '<tr id="6226" style="display:none"><td>sponsor_event_verification_received</td><td>'.$item->sponsor->sponsor_event_verification_received.'</td><td id="sponsor_event_verification_received"></td></tr>';
	$html_text .= '<tr id="6227" style="display:none"><td>sponsor_event_verification_set</td><td>'.$item->sponsor->sponsor_event_verification_set.'</td><td id="sponsor_event_verification_set"></td></tr>';
	$html_text .= '<tr id="6228" style="display:none;vertical-align:top"><td>sponsor_properties</td><td>'.$item->sponsor->sponsor_properties.'</td><td></td></tr>';
	$html_text .= '<tr id="6229" style="display:none;vertical-align:top"><td>sponsor_remark_values</td><td>'.$item->sponsor->sponsor_remark_values.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
