...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	//$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(11)">notice 0 +/-</button></b></td><td></b></td><td id="zone_notices"></td></tr>';
	...
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(12)">notice 1 +/-</button></b></td><td></b></td><td></td></tr>';
	...
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(13)">notice 2 +/-</button></b></td><td></b></td><td></td></tr>';
	...
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(20)">view 0 +/-</button></b></td><td></b></td><td id="view_role"></td></tr>';
	...
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(21)">view 1 +/-</button></b></td><td></b></td><td id="view_role"></td></tr>';
