...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		var accessible = 'Zoals voorgesteld verbeteren de gestructureerde velden de bruikbaarheid en transparantie.';
		...
		document.getElementById("zone_tld_category").textContent = proposed + 'Geeft aan of de TLD een generiek (gTLD) of een landcodedomein (ccTLD) is.';
		...
		document.getElementById("zone_country_code_designated_manager").textContent = proposed + "De beheerder van een ccTLD hoeft internationale standaarden niet te implementeren.";
		...
		document.getElementById("zone_backend_operator_trade_name").textContent = proposed + 'De backendprovider verzorgt de technische infrastructuur van de TLD.';
		...
		document.getElementById("background_lookup_endpoints_url").textContent = proposed;
		document.getElementById("background_registry_source").textContent = proposed + "De map /v1/ ondersteunt mogelijk ook /v2/-reacties; zie icann.com.";
		...
		var accessible = 'As proposed, the structured fields enhance usability and transparency.';
		document.getElementById("title").textContent = "Domain Information";
		document.getElementById("subtitle").textContent = "RDAP-v1-based modeling";
		document.getElementById("instruction").textContent = "Fill in and press Enter to retrieve.";
		document.getElementById("field").textContent = "Description";
		...
		document.getElementById("zone_tld_category").textContent = proposed + 'Specifies whether the TLD is a generic (gTLD) or country-code (ccTLD) domain.';
		...
		document.getElementById("zone_country_code_designated_manager").textContent = proposed + 'The manager of a ccTLD is not required to implement international standards.';
		...
		document.getElementById("zone_backend_operator_trade_name").textContent = proposed + 'The backend provider manages the technical infrastructure of the TLD.';
		...
		document.getElementById("background_accredited_registrars_url").textContent = proposed;		
		document.getElementById("background_lookup_endpoints_url").textContent = proposed;
		document.getElementById("background_registry_source").textContent = proposed + "The /v1/ folder may support /v2/ responses; see icann.com.";
		...
		var accessible = 'Wie vorgeschlagen, verbessern die strukturierten Felder die Benutzerfreundlichkeit und Transparenz.';
		...
		document.getElementById("zone_tld_category").textContent = proposed + 'Gibt an, ob es sich bei der TLD um eine generische (gTLD) oder länderspezifische (ccTLD) Domäne handelt.';
		...
		document.getElementById("zone_country_code_designated_manager").textContent = proposed + 'Der Manager einer ccTLD ist nicht verpflichtet, internationale Standards umzusetzen.';
		...
		document.getElementById("zone_backend_operator_trade_name").textContent = proposed + 'Der Backend-Dienstleister verwaltet die technische Infrastruktur der TLD.';
		...
		document.getElementById("background_accredited_registrars_url").textContent = proposed;		
		document.getElementById("background_lookup_endpoints_url").textContent = proposed;
		document.getElementById("background_registry_source").textContent = proposed + "Der Ordner /v1/ unterstützt möglicherweise /v2/-Antworten; siehe icann.com.";
		...
		var accessible = 'Comme proposé, les champs structurés améliorent la convivialité et la transparence.';
		...
		document.getElementById("explanation").textContent = "Un aperçu et une explication du système des noms de domaine.";		
		document.getElementById("zone_role").textContent = "L'ICANN gère la délégation d'un domaine de premier niveau.";
		document.getElementById("zone_tld_category").textContent = proposed + "Indique si le TLD est générique (gTLD) ou associé à un code pays (ccTLD).";
		...
		document.getElementById("zone_country_code_designated_manager").textContent = proposed + "Le gestionnaire d’un ccTLD n’est pas tenu de mettre en œuvre des normes internationales.";
		...
		document.getElementById("zone_backend_operator_trade_name").textContent = proposed + "Le prestataire technique gère l'infrastructure technique du TLD.";
		...
		document.getElementById("background_accredited_registrars_url").textContent = proposed;		
		document.getElementById("background_lookup_endpoints_url").textContent = proposed;
		document.getElementById("background_registry_source").textContent = proposed + "Le dossier /v1/ peut prendre en charge les réponses /v2/ ; voir icann.com.";
