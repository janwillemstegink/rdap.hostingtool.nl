...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="103" style="display:none"><td>zone regmenu</td><td>'.$item->zone->regmenu.'</td><td id="zone_regmenu"></td></tr>';
	...
	$html_text .= '<tr id="301" style="display:none"><td>domain handle</td><td>'.$item->details->handle.'</td><td></td></tr>';
	$html_text .= '<tr id="302" style="display:none"><td>domain name_ascii</td><td>'.$item->details->name_ascii.'</td><td id="domain_name_ascii"></td></tr>';
	$html_text .= '<tr id="303" style="display:none"><td>domain name_unicode</td><td>'.$item->details->name_unicode.'</td><td id="domain_name_unicode"></td></tr>';
	$html_text .= '<tr style="vertical-align:top"><td>domain status_values</td><td><b>'.$item->details->status_values.'</b></td><td id="domain_status_values"></td></tr>';
	$html_text .= '<tr id="304" style="display:none"><td>domain event_registration</td><td>'.$item->details->event_registration.'</td><td></td></tr>';
	$html_text .= '<tr id="305" style="display:none"><td>domain event_last_transferred</td><td>'.$item->details->event_last_transferred.'</td><td></td></tr>';
	$html_text .= '<tr id="306" style="display:none"><td>domain event_last_changed</td><td>'.$item->details->event_last_changed.'</td><td></td></tr>';
	$html_text .= '<tr><td>domain event_expiration</td><td>'.$item->details->event_expiration.'</td><td id="domain_event_expiration"></td></tr>';
	$html_text .= '<tr id="307" style="display:none"><td>domain event_recovery_until</td><td>'.$item->details->event_recovery_until.'</td><td id="domain_event_recovery_until"></td></tr>';
	$html_text .= '<tr id="308" style="display:none"><td>domain event_deletion</td><td>'.$item->details->event_deletion.'</td><td id="domain_event_deletion"></td></tr>';
	$html_text .= '<tr id="309" style="display:none"><td>domain event_last_uploaded</td><td>'.$item->details->event_last_uploaded.'</td><td id="domain_event_last_uploaded"></td></tr>';
	$html_text .= '<tr id="3010" style="display:none;vertical-align:top"><td>domain extensions_values</td><td><b>'.$item->details->extensions_values.'</b></td><td id="domain_extensions_values"></td></tr>';
	$html_text .= '<tr id="3011" style="display:none;vertical-align:top"><td>domain remark_values</td><td>'.$item->details->remark_values.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
