...
if (true or $pd == mb_strtolower($data[$pd]['registry']['properties']['ascii_name']) or empty($data[$pd]['registry']['properties']['ascii_name']))	{
	...
	$html_text .= '<tr id="6310" style="display:none"><td>dnssec_signed</td><td>'.$data[$pd]['registry']['nameservers']['dnssec_signed'].'</td><td id="nameservers_dnssec_signed"></td><td>'.str_replace(',',',<br />',$data[$pd]['registrar']['nameservers']['dnssec_signed']).'</td></tr>';
	$html_text .= '<tr id="6311" style="display:none"><td>dnssec_key_tag</td><td>'.str_replace(',',',<br />',$data[$pd]['registry']['nameservers']['dnssec_key_tag']).'</td><td></td><td>'.str_replace(',',',<br />',$data[$pd]['registrar']['nameservers']['dnssec_key_tag']).'</td></tr>';
	$html_text .= '<tr><td>dnssec_algorithm</td><td>'.str_replace(',',',<br />',$data[$pd]['registry']['nameservers']['dnssec_algorithm']).'</td><td id="nameservers_dnssec_algorithm"></td><td>'.str_replace(',',',<br />',$data[$pd]['registrar']['nameservers']['dnssec_algorithm']).'</td></tr>';	
	$html_text .= '<tr id="6312" style="display:none"><td>dnssec_digest_type</td><td>'.str_replace(',',',<br />',$data[$pd]['registry']['nameservers']['dnssec_digest_type']).'</td><td></td><td>'.str_replace(',',',<br />',$data[$pd]['registrar']['nameservers']['dnssec_digest_type']).'</td></tr>';
	$html_text .= '<tr id="6313" style="display:none"><td>dnssec_digest</td><td colspan="2">'.str_replace(',',',<br />',$data[$pd]['registry']['nameservers']['dnssec_digest']).'</td><td>'.str_replace(',',',<br />',$data[$pd]['registrar']['nameservers']['dnssec_digest']).'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
