...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="202" style="display:none"><td>view_links_value_0</td><td>'.$item->view->view_links_value_0.'</td><td></td></tr>';
	$html_text .= '<tr id="203" style="display:none"><td>view_links_related_0</td><td>'.$item->view->view_links_related_0.'</td><td></td></tr>';
	$html_text .= '<tr id="204" style="display:none"><td>view_links_href_0</td><td>'.$item->view->view_links_href_0.'</td><td></td></tr>';
	$html_text .= '<tr id="205" style="display:none"><td>view_links_href_lang_0</td><td>'.$item->view->view_links_href_lang_0.'</td><td></td></tr>';
	$html_text .= '<tr id="206" style="display:none"><td>view_links_title_0</td><td>'.$item->view->view_links_title_0.'</td><td></td></tr>';
	$html_text .= '<tr id="207" style="display:none"><td>view_links_media_0</td><td>'.$item->view->view_links_media_0.'</td><td></td></tr>';
	$html_text .= '<tr id="208" style="display:none"><td>view_links_type_0</td><td>'.$item->view->view_links_type_0.'</td><td></td></tr>';
	$html_text .= '<tr id="209" style="display:none"><td>view_links_value_1</td><td>'.$item->view->view_links_value_1.'</td><td></td></tr>';
	$html_text .= '<tr id="2010" style="display:none"><td>view_links_related_1</td><td>'.$item->view->view_links_related_1.'</td><td></td></tr>';
	$html_text .= '<tr id="2011" style="display:none"><td>view_links_href_1</td><td>'.$item->view->view_links_href_1.'</td><td></td></tr>';
	$html_text .= '<tr id="2012" style="display:none"><td>view_links_href_lang_1</td><td>'.$item->view->view_links_href_lang_1.'</td><td></td></tr>';
	$html_text .= '<tr id="2013" style="display:none"><td>view_links_title_1</td><td>'.$item->view->view_links_title_1.'</td><td></td></tr>';
	$html_text .= '<tr id="2014" style="display:none"><td>view_links_media_1</td><td>'.$item->view->view_links_media_1.'</td><td></td></tr>';
	$html_text .= '<tr id="2015" style="display:none"><td>view_links_type_1</td><td>'.$item->view->view_links_type_1.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="305" style="display:none"><td>domain_will_expire</td><td>'.$item->domain_will_expire.'</td><td></td></tr>';
