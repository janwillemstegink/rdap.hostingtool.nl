...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("registrant_protected").textContent = proposed + "Het zone-specifiek verbergen van adresvelden varieert afhankelijk van de rol.";
	...
	et }
		...
		document.getElementById("registrant_protected").textContent = proposed + "Zone Specific hiding of address fields vary depending on the role.";
		...
		document.getElementById("registrant_protected").textContent = proposed + "Zonenspezifisches Ausblenden von Adressfeldern variiert je nach Rolle.";
		...
		document.getElementById("registrant_protected").textContent = proposed + "Le masquage spécifique des champs d'adresse varie en fonction du rôle.";
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td>registrant_country_code <a href="https://icann-hamster.nl/ham/soac/ccnso/techday/icann80/2.%20RDAP%20Conformance%20Tool%20-%20Tech%20Day.pdf" target="_blank">Conformance</a></td><td>'.$item->registrant->registrant_country_code.'</td><td id="registrant_country_code"></td></tr>';
	$html_text .= '<tr id="406" style="display:none"><td>registrant_street</td><td>'.$item->registrant->registrant_street.'</td><td></td></tr>';
	$html_text .= '<tr id="407" style="display:none"><td>registrant_city</td><td>'.$item->registrant->registrant_city.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4010" style="display:none"><td>registrant_country_name</td><td>'.$item->registrant->registrant_country_name.'</td><td></td></tr>';
	...
	$html_text .= '<tr id="6217" style="display:none"><td>sponsor_protected</td><td>'.$item->sponsor->sponsor_protected.'</td><td></td></tr>';
