...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("zone_menu_url").textContent = proposed + 'Een informatief dropdownmenu, eventueel via een subdomein zoals "regmenu".';
		...
		document.getElementById("zone_menu_url").textContent = proposed + 'An informative dropdown menu, possibly via a subdomain such as "regmenu".';
		document.getElementById("notices_role").textContent = accessible;
		document.getElementById("links_role").textContent = accessible;			
		...
		document.getElementById("zone_menu_url").textContent = proposed + 'Ein informatives Dropdown-Menü, möglicherweise über eine Subdomain wie "regmenu".';
		document.getElementById("notices_role").textContent = accessible;
		document.getElementById("links_role").textContent = accessible;
		...
		document.getElementById("zone_menu_url").textContent = proposed + 'Un menu déroulant informatif, éventuellement via un sous-domaine tel que "regmenu".';
		document.getElementById("notices_role").textContent = accessible;
		document.getElementById("links_role").textContent = accessible;
