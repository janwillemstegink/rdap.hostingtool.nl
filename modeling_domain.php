...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="104" style="display:none"><td>zone_registry_trade_name</td><td>'.$item->zone->zone_registry_trade_name.'</td><td id="zone_registry_trade_name"></td></tr>';
	$html_text .= '<tr id="105" style="display:none"><td>zone_time_zone</td><td>'.$item->zone->zone_time_zone.'</td><td id="zone_time_zone"></td></tr>';
	$html_text .= '<tr id="106" style="display:none"><td>zone_language</td><td>'.$item->zone->zone_language.'</td><td id="zone_language"></td></tr>';
	$html_text .= '<tr id="107" style="display:none;vertical-align:top"><td>zone_description_legal</td><td>'.$item->zone->zone_description_legal.'</td><td></td></tr>';
	$html_text .= '<tr id="108" style="display:none;vertical-align:top"><td>zone_description_translated</td><td>'.$item->zone->zone_description_translated.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';	
	...
	$html_text .= '<tr><td>domain_type</td><td>'.$item->domain_type.'</td><td id="domain_type"></td></tr>';
	$html_text .= '<tr><td>domain_status</td><td>'.$item->domain_status.'</td><td id="domain_status"></td></tr>';
	$html_text .= '<tr id="303" style="display:none"><td>domain_status_codes</td><td>'.$item->domain_status_codes.'</td><td id="domain_status_codes"></td></tr>';
	...
	$html_text .= '<tr id="304" style="display:none"><td>domain_updated</td><td>'.$item->domain_updated.'</td><td></td></tr>';
	$html_text .= '<tr id="305" style="display:none"><td>domain_refreshed</td><td>'.$item->domain_refreshed.'</td><td id="domain_refreshed"></td></tr>';
	$html_text .= '<tr id="306" style="display:none"><td>domain_expiration</td><td>'.$item->domain_expiration.'</td><td></td></tr>';
	$html_text .= '<tr id="307" style="display:none"><td>domain_out_of_quarantine</td><td>'.$item->domain_out_of_quarantine.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	...
	$html_text .= '<tr><td>registrar_trade_name</td><td>'.$item->registrar->registrar_trade_name.'</td><td></td></tr>';
	$html_text .= '<tr id="402" style="display:none"><td>registrar_url</td><td>'.$item->registrar->registrar_url.'</td><td></td></tr>';
	$html_text .= '<tr id="403" style="display:none"><td>registrar_iana_id</td><td>'.$item->registrar->registrar_iana_id.'</td><td id="registrar_iana_id"></td></tr>';
	$html_text .= '<tr id="404" style="display:none"><td>registrar_personal_name</td><td>'.$item->registrar->registrar_personal_name.'</td><td></td></tr>';
	$html_text .= '<tr id="405" style="display:none"><td>registrar_phone</td><td>'.$item->registrar->registrar_phone.'</td><td></td></tr>';
	$html_text .= '<tr id="406" style="display:none"><td>registrar_fax</td><td>'.$item->registrar->registrar_fax.'</td><td></td></tr>';
	$html_text .= '<tr id="407" style="display:none"><td>registrar_email</td><td>'.$item->registrar->registrar_email.'</td><td></td></tr>';
	$html_text .= '<tr id="408" style="display:none"><td>registrar_street</td><td>'.$item->registrar->registrar_street.'</td><td></td></tr>';
	$html_text .= '<tr id="409" style="display:none"><td>registrar_postal_code</td><td>'.$item->registrar->registrar_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="4010" style="display:none"><td>registrar_city</td><td>'.$item->registrar->registrar_city.'</td><td></td></tr>';
	$html_text .= '<tr id="4011" style="display:none"><td>registrar_state_province</td><td>'.$item->registrar->registrar_state_province.'</td><td></td></tr>';	
	$html_text .= '<tr id="4012" style="display:none"><td>registrar_country_code</td><td>'.$item->registrar->registrar_country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="4013" style="display:none"><td>registrar_country_name</td><td>'.$item->registrar->registrar_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="4014" style="display:none"><td>registrar_country_language</td><td>'.$item->registrar->registrar_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="4015" style="display:none"><td>registrar_protected</td><td>'.$item->registrar->registrar_protected.'</td><td id="registrar_protected"></td></tr>';
	...
	if (!empty($item->reseller->reseller_trade_name))	{
		if (strlen(trim($item->reseller->reseller_trade_name)))	{
			$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(50)">reseller +/-</button></b></td><td></b></td><td id="reseller_role"></td></tr>';								$html_text .= '<tr id="501" style="display:none"><td>reseller_contact_id</td><td>'.$item->reseller->reseller_contact_id.'</td><td></td></tr>';
			$html_text .= '<tr><td>reseller_web_id</td><td>'.$item->reseller->reseller_web_id.'</td><td id="reseller_web_id"></td></tr>';
			$html_text .= '<tr><td>reseller_trade_name</td><td>'.$item->reseller->reseller_trade_name.'</td><td></td></tr>';
			$html_text .= '<tr id="502" style="display:none"><td>reseller_personal_name</td><td>'.$item->reseller->reseller_personal_name.'</td><td></td></tr>';
			$html_text .= '<tr id="503" style="display:none"><td>reseller_phone</td><td>'.$item->reseller->reseller_phone.'</td><td></td></tr>';
			$html_text .= '<tr id="504" style="display:none"><td>reseller_fax</td><td>'.$item->reseller->reseller_fax.'</td><td></td></tr>';
			$html_text .= '<tr id="505" style="display:none"><td>reseller_email</td><td>'.$item->reseller->reseller_email.'</td><td></td></tr>';			
			$html_text .= '<tr id="506" style="display:none"><td>reseller_street</td><td>'.$item->reseller->reseller_street.'</td><td></td></tr>';
			$html_text .= '<tr id="507" style="display:none"><td>reseller_postal_code</td><td>'.$item->reseller->reseller_postal_code.'</td><td></td></tr>';
			$html_text .= '<tr id="508" style="display:none"><td>reseller_city</td><td>'.$item->reseller->reseller_city.'</td><td></td></tr>';
			$html_text .= '<tr id="509" style="display:none"><td>reseller_state_province</td><td>'.$item->reseller->reseller_state_province.'</td><td></td></tr>';			
			$html_text .= '<tr id="5010" style="display:none"><td>reseller_country_code</td><td>'.$item->reseller->reseller_country_code.'</td><td></td></tr>';
			$html_text .= '<tr id="5011" style="display:none"><td>reseller_country_name</td><td>'.$item->reseller->reseller_country_name.'</td><td></td></tr>';
			$html_text .= '<tr id="5012" style="display:none"><td>reseller_country_language</td><td>'.$item->reseller->reseller_country_language.'</td><td></td></tr>';
			$html_text .= '<tr id="5013" style="display:none"><td>reseller_protected</td><td>'.$item->reseller->reseller_protected.'</td><td id="reseller_protected"></td></tr>';
			$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
		}	
	}
	...
	$html_text .= '<tr id="602" style="display:none"><td>registrant_phone</td><td>'.$item->registrant->registrant_phone.'</td><td></td></tr>';
	$html_text .= '<tr id="603" style="display:none"><td>registrant_fax</td><td>'.$item->registrant->registrant_fax.'</td><td></td></tr>';
	$html_text .= '<tr id="604" style="display:none"><td>registrant_email</td><td>'.$item->registrant->registrant_email.'</td><td></td></tr>';
	$html_text .= '<tr id="605" style="display:none"><td>registrant_street</td><td>'.$item->registrant->registrant_street.'</td><td></td></tr>';
	$html_text .= '<tr id="606" style="display:none"><td>registrant_postal_code</td><td>'.$item->registrant->registrant_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="607" style="display:none"><td>registrant_city</td><td>'.$item->registrant->registrant_city.'</td><td></td></tr>';
	$html_text .= '<tr id="608" style="display:none"><td>registrant_state_province</td><td>'.$item->registrant->registrant_state_province.'</td><td></td></tr>';	
	$html_text .= '<tr id="609" style="display:none"><td>registrant_country_code</td><td>'.$item->registrant->registrant_country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="6010" style="display:none"><td>registrant_country_name</td><td>'.$item->registrant->registrant_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="6011" style="display:none"><td>registrant_country_language</td><td>'.$item->registrant->registrant_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="6012" style="display:none"><td>registrant_protected</td><td>'.$item->registrant->registrant_protected.'</td><td id="registrant_protected"></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="703" style="display:none"><td>admin_web_id</td><td>'.$item->admin->admin_web_id.'</td><td id="admin_web_id"></td></tr>';
	$html_text .= '<tr id="702" style="display:none"><td>admin_trade_name</td><td>'.$item->admin->admin_trade_name.'</td><td id="admin_trade_name"></td></tr>';
	$html_text .= '<tr id="704" style="display:none"><td>admin_personal_name</td><td>'.$item->admin->admin_personal_name.'</td><td></td></tr>';
	$html_text .= '<tr id="705" style="display:none"><td>admin_phone</td><td>'.$item->admin->admin_phone.'</td><td></td></tr>';
	$html_text .= '<tr id="706" style="display:none"><td>admin_fax</td><td>'.$item->admin->admin_fax.'</td><td></td></tr>';
	$html_text .= '<tr><td>admin_email</td><td>'.$item->admin->admin_email.'</td><td></td></tr>';
	$html_text .= '<tr id="707" style="display:none"><td>admin_street</td><td>'.$item->admin->admin_street.'</td><td></td></tr>';
	$html_text .= '<tr id="708" style="display:none"><td>admin_postal_code</td><td>'.$item->admin->admin_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="709" style="display:none"><td>admin_city</td><td>'.$item->admin->admin_city.'</td><td></td></tr>';
	$html_text .= '<tr id="7010" style="display:none"><td>admin_state_province</td><td>'.$item->admin->admin_state_province.'</td><td></td></tr>';	
	$html_text .= '<tr id="7011" style="display:none"><td>admin_country_code</td><td>'.$item->admin->admin_country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="7012" style="display:none"><td>admin_country_name</td><td>'.$item->admin->admin_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="7013" style="display:none"><td>admin_country_language</td><td>'.$item->admin->admin_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="7014" style="display:none"><td>admin_protected</td><td>'.$item->admin->admin_protected.'</td><td id="admin_protected"></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="803" style="display:none"><td>tech_trade_name</td><td>'.$item->tech->tech_trade_name.'</td><td id="tech_trade_name"></td></tr>';
	$html_text .= '<tr id="804" style="display:none"><td>tech_personal_name</td><td>'.$item->tech->tech_personal_name.'</td><td></td></tr>';
	$html_text .= '<tr id="805" style="display:none"><td>tech_phone</td><td>'.$item->tech->tech_phone.'</td><td></td></tr>';
	$html_text .= '<tr id="806" style="display:none"><td>tech_fax</td><td>'.$item->tech->tech_fax.'</td><td></td></tr>';
	$html_text .= '<tr><td>tech_email</td><td>'.$item->tech->tech_email.'</td><td></td></tr>';
	$html_text .= '<tr id="807" style="display:none"><td>tech_street</td><td>'.$item->tech->tech_street.'</td><td></td></tr>';
	$html_text .= '<tr id="808" style="display:none"><td>tech_postal_code</td><td>'.$item->tech->tech_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="809" style="display:none"><td>tech_city</td><td>'.$item->tech->tech_city.'</td><td></td></tr>';
	$html_text .= '<tr id="8010" style="display:none"><td>tech_state_province</td><td>'.$item->tech->tech_state_province.'</td><td></td></tr>';	
	$html_text .= '<tr id="8011" style="display:none"><td>tech_country_code</td><td>'.$item->tech->tech_country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="8012" style="display:none"><td>tech_country_name</td><td>'.$item->tech->tech_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="8013" style="display:none"><td>tech_country_language</td><td>'.$item->tech->tech_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="8014" style="display:none"><td>tech_protected</td><td>'.$item->tech->tech_protected.'</td><td id="tech_protected"></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="903" style="display:none"><td>billing_trade_name</td><td>'.$item->billing->billing_trade_name.'</td><td></td></tr>';
	$html_text .= '<tr id="904" style="display:none"><td>billing_personal_name</td><td>'.$item->billing->billing_personal_name.'</td><td></td></tr>';
	$html_text .= '<tr id="905" style="display:none"><td>billing_phone</td><td>'.$item->billing->billing_phone.'</td><td></td></tr>';
	$html_text .= '<tr id="906" style="display:none"><td>billing_fax</td><td>'.$item->billing->billing_fax.'</td><td></td></tr>';
	$html_text .= '<tr id="907" style="display:none"><td>billing_email</td><td>'.$item->billing->billing_email.'</td><td></td></tr>';
	$html_text .= '<tr id="908" style="display:none"><td>billing_street</td><td>'.$item->billing->billing_street.'</td><td></td></tr>';
	$html_text .= '<tr id="909" style="display:none"><td>billing_postal_code</td><td>'.$item->billing->billing_postal_code.'</td><td></td></tr>';
	$html_text .= '<tr id="9010" style="display:none"><td>billing_city</td><td>'.$item->billing->billing_city.'</td><td></td></tr>';
	$html_text .= '<tr id="9011" style="display:none"><td>billing_state_province</td><td>'.$item->billing->billing_state_province.'</td><td></td></tr>';	
	$html_text .= '<tr id="9012" style="display:none"><td>billing_country_code</td><td>'.$item->billing->billing_country_code.'</td><td></td></tr>';
	$html_text .= '<tr id="9013" style="display:none"><td>billing_country_name</td><td>'.$item->billing->billing_country_name.'</td><td></td></tr>';
	$html_text .= '<tr id="9014" style="display:none"><td>billing_country_language</td><td>'.$item->billing->billing_country_language.'</td><td></td></tr>';
	$html_text .= '<tr id="9015" style="display:none"><td>billing_protected</td><td>'.$item->billing->billing_protected.'</td><td id="billing_protected"></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	...
	if (!empty($item->name_servers->server_1->server_name_1))	{
		if (strlen(trim($item->name_servers->server_1->server_name_1)))	{
			...
			$html_text .= '<tr id="953" style="display:none"><td>server_ipv4_1</td><td>'.$item->name_servers->server_1->server_ipv4_1.'</td><td></td></tr>';
