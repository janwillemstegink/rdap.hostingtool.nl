...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("domain_status").textContent = "De status 'redemption period' betekent heractiveerbaar en 'pending delete' betekent niet-heractiveerbaar.";
