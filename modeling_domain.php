...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("domain_name_unicode").textContent = "Hoewel de informatie verduidelijkt, is de unicode-domeinnaam optioneel binnen het RDAP-protocol.";
		...
		document.getElementById("domain_name_unicode").textContent = "Although information clarifies, the unicode domain name is optional within the RDAP protocol.";
		...
		document.getElementById("domain_name_unicode").textContent = "Obwohl die Informationen klarstellen, ist der Unicode-Domänenname innerhalb des RDAP-Protokolls optional.";
		...
		document.getElementById("domain_name_unicode").textContent = "Bien que les informations soient clarifiées, le nom de domaine Unicode est facultatif dans le protocole RDAP.";
...
if (true or $pd == mb_strtolower($data[$pd]['domain']['name_ascii']) or empty($data[$pd]['domain']['name_ascii']))	{
	...
	$html_text .= '<tr id="3921" style="display:none"><td>sponsor last_updated_at</td><td>'.$data[$pd]['sponsor']['last_updated_at'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="3925" style="display:none;vertical-align:top"><td>sponsor remark_values</td><td>'.$data[$pd]['sponsor']['remark_values'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4018" style="display:none"><td>registrant last_updated_at</td><td>'.$data[$pd]['registrant']['last_updated_at'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4020" style="display:none;vertical-align:top"><td>registrant remark_values</td><td>'.$data[$pd]['registrant']['remark_values'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="5018" style="display:none"><td>reseller last_updated_at</td><td>'.$data[$pd]['reseller']['last_updated_at'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="5022" style="display:none;vertical-align:top"><td>reseller remark_values</td><td>'.$data[$pd]['reseller']['remark_values'].'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="6018" style="display:none"><td>registrar last_updated_at</td><td>'.$data[$pd]['registrar']['last_updated_at'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="6022" style="display:none;vertical-align:top"><td>registrar remark_values</td><td>'.$data[$pd]['registrar']['remark_values'].'</td><td></td></tr>';
