...
foreach ($xml1->xpath('//zone') as $item)	{
	...
	$html_text .= '<tr id="111" style="display:none"><td><b>zone_privacy_title</b></td><td>'.$item->zone_privacy_title.'</td><td></td></tr>';
	$html_text .= '<tr id="112" style="display:none"><td><b>zone_privacy_legal</b></td><td>'.$item->zone_privacy_legal.'</td><td></td></tr>';
	$html_text .= '<tr id="113" style="display:none"><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr id="114" style="display:none"><td><b>zone_privacy_translated</b></td><td>'.$item->zone_privacy_translated.'</td><td></td></tr>';
	$html_text .= '<tr id="115" style="display:none"><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr id="116" style="display:none"><td><b>zone_copyright_title</b></td><td>'.$item->zone_copyright_title.'</td><td></td></tr>';
	$html_text .= '<tr id="117" style="display:none"><td><b>zone_copyright_legal</b></td><td>'.$item->zone_copyright_legal.'</td><td></td></tr>';
	$html_text .= '<tr id="118" style="display:none"><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr id="119" style="display:none"><td><b>zone_copyright_translated</b></td><td>'.$item->zone_copyright_translated.'</td><td></td></tr>';
	break;
}
foreach ($xml2->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="207" style="display:none"><td><b>domain_links_value</b></td><td>'.$item->domain_links_value.'</td><td id="zone_server" style="font-style:italic"></td></tr>';
	$html_text .= '<tr id="208" style="display:none"><td><b>domain_links_rel</b></td><td>'.$item->domain_links_rel.'</td><td></td></tr>';
	$html_text .= '<tr id="209" style="display:none"><td><b>domain_links_href</b></td><td>'.$item->domain_links_href.'</td><td></td></tr>';
	$html_text .= '<tr id="2010" style="display:none"><td><b>domain_links_type</b></td><td>'.$item->domain_links_type.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(60)">administrative +/-</button></td><td></td><td id="admin_role" style="font-weight:bold"></td></tr>';
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer" onclick="SwitchDisplay(70)">technical +/-</button></td><td></td><td id="tech_role" style="font-weight:bold"></td></tr>';
