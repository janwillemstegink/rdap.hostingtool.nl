...
function SwitchTranslation(translation)	{
	...
	if (translation == 99)	{
		...
		document.getElementById("registrant_part").textContent = "Jurisdictieverwijzing op basis van het land van vestiging van de rechtmatige registrant of organisatorische gebruiker.";
		...
		document.getElementById("actor_part").textContent = proposed + "De actor handelt namens de registrant en volgt de vereisten van de registrant.";
		...
		document.getElementById("escalation_part").textContent = proposed + "Wordt gebruikt wanneer het primaire contact niet beschikbaar, niet responsief of onvoldoende is.";
		...
		document.getElementById("actor_part").textContent = proposed + "The actor acts on behalf of the registrant and follows the registrant’s requirements.";
		...
		document.getElementById("sponsor_part").textContent = "Die Domainregistrierung kann, sofern zutreffend, über eine Sponsorenbeziehung verwaltet werden (siehe z. B. france.fr).";
		document.getElementById("registrant_part").textContent = "Gerichtsstandsreferenz basierend auf dem Niederlassungsland des rechtmäßigen Registranten oder organisatorischen Nutzers.";
		...
		document.getElementById("actor_part").textContent = proposed + "Der Akteur handelt im Auftrag des Registranten und folgt dessen Anforderungen.";
		...
		document.getElementById("escalation_part").textContent = proposed + "Wird verwendet, wenn der primäre Kontakt nicht verfügbar, nicht reaktionsfähig oder unzureichend ist.";
		...
		document.getElementById("registrant_part").textContent = "Référence de juridiction basée sur le pays d’établissement du titulaire légitime ou de l’utilisateur organisationnel.";
		...
		document.getElementById("actor_part").textContent = proposed + "L’acteur agit pour le compte du titulaire et suit ses exigences.";
