...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("domain_event_expiration").textContent = "Einddatum/-tijd van het object voor periodieke verificatie en/of stopzetting van de publicatie.";
		document.getElementById("domain_event_deletion").textContent = "Geplande datum/tijd voor het verwijderen van het object, gevolgd door de beschikbaarheid.";
		...
		document.getElementById("domain_event_expiration").textContent = "End date/time of the object for periodic verification and/or publication discontinuation.";
		document.getElementById("domain_event_deletion").textContent = "Scheduled date/time for object removal, followed by availability.";
		...
		document.getElementById("domain_event_expiration").textContent = "Enddatum/-zeit des Objekts für die periodische Überprüfung und/oder Einstellung der Veröffentlichung.";
		document.getElementById("domain_event_deletion").textContent = "Geplantes Datum/Uhrzeit für die Objektentfernung, gefolgt von der Verfügbarkeit.";
		...
		document.getElementById("domain_event_expiration").textContent = "Date/heure de fin de l'objet pour la vérification périodique et/ou l'arrêt de la publication.";
		document.getElementById("domain_event_deletion").textContent = "Date/heure prévue pour le retrait de l'objet, suivie de la disponibilité.";
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td>domain_status_properties</td><td>'.$item->domain_status_properties.'</td><td id="domain_status_properties"></td></tr>';
