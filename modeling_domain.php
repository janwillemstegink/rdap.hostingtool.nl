...
function SwitchTranslation(translation)	{
	...
	if (translation == 99)	{
		...
		document.getElementById("registrant_subject_id").textContent = proposed;
		...
		document.getElementById("request_handling_subject_id").textContent = proposed;
		document.getElementById("issue_reporting_part").textContent = modified;
		document.getElementById("issue_reporting_subject_id").textContent = proposed;
		...
		document.getElementById("reseller_subject_id").textContent = proposed;
		...
		document.getElementById("registrar_subject_id").textContent = proposed;
		...
		document.getElementById("registrant_subject_id").textContent = proposed + "Een jurisdictiegebonden identificatie van een rechtspersoon of natuurlijke persoon, geverifieerd via PKI.";
		...
		document.getElementById("registrant_subject_id").textContent = proposed + "A jurisdiction-specific identifier for a business entity or natural person, verified through PKI.";
		...
		document.getElementById("registrant_subject_id").textContent = proposed + "Eine rechtsraumbezogene Identifikation einer juristischen oder natürlichen Person, verifiziert durch PKI.";
		...
		document.getElementById("registrant_subject_id").textContent = proposed + "Une identification juridictionnelle d’une personne morale ou physique, vérifiée par PKI.";
...
if (true or $pd == mb_strtolower($data[$pd]['registry']['domain']['ascii_name']) or empty($data[$pd]['registry']['domain']['ascii_name']))	{
	...
	$html_text .= '<tr id="393" style="display:none"><td>sponsor_subject_id</td><td>'.$data[$pd]['registry']['sponsor']['subject_id'].'</td><td id="sponsor_subject_id"></td><td>'.$data[$pd]['registrar']['sponsor']['subject_id'].'</td></tr>';
	...
	$html_text .= '<tr id="403" style="display:none"><td>registrant_subject_id</td><td>'.$data[$pd]['registry']['registrant']['subject_id'].'</td><td id="registrant_subject_id"></td><td>'.$data[$pd]['registrar']['registrant']['subject_id'].'</td></tr>';
	...
	$html_text .= '<tr id="413" style="display:none"><td>actor_subject_id</td><td>'.$data[$pd]['registry']['actor']['subject_id'].'</td><td></td><td>'.$data[$pd]['registrar']['actor']['subject_id'].'</td></tr>';
	...
	$html_text .= '<tr id="423" style="display:none"><td>request_handling_subject_id</td><td>'.$data[$pd]['registry']['request_handling']['subject_id'].'</td><td id="request_handling_subject_id"></td><td>'.$data[$pd]['registrar']['request_handling']['subject_id'].'</td></tr>';
	...
	$html_text .= '<tr id="433" style="display:none"><td>issue_reporting_subject_id</td><td>'.$data[$pd]['registry']['issue_reporting']['subject_id'].'</td><td id="issue_reporting_subject_id"></td><td>'.$data[$pd]['registrar']['issue_reporting']['subject_id'].'</td></tr>';
...
$html_text .= '<tr><td><button style="cursor:pointer;font-size:0.8rem" onclick="SwitchDisplay(44)">Billing +/-</button></td><td></td><td id="billing_part"></td><td></td></tr>';
	...
	$html_text .= '<tr id="443" style="display:none"><td>billing_subject_id</td><td>'.$data[$pd]['registry']['billing']['subject_id'].'</td><td></td><td>'.$data[$pd]['registrar']['billing']['subject_id'].'</td></tr>';
	...
	$html_text .= '<tr id="503" style="display:none"><td>reseller_subject_id</td><td>'.$data[$pd]['registry']['reseller']['subject_id'].'</td><td id="reseller_subject_id"></td><td>'.$data[$pd]['registrar']['reseller']['subject_id'].'</td></tr>';
	...
	$html_text .= '<tr id="603" style="display:none"><td>registrar_subject_id</td><td>'.$data[$pd]['registry']['registrar']['subject_id'].'</td><td id="registrar_subject_id"></td><td>'.$data[$pd]['registrar']['registrar']['subject_id'].'</td></tr>';
