...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{
		...
		document.getElementById("rootzone_country_code_designated_manager").textContent = proposed;
		document.getElementById("rootzone_registry_operator_organization_name").textContent = proposed;
		document.getElementById("rootzone_registry_operator_presented_name").textContent = proposed;
		...
		document.getElementById("metadata_registrar_public_ids").textContent = proposed;
		...
		document.getElementById("metadata_root_zones_url").textContent = proposed;
		...
		document.getElementById("rootzone_country_code_designated_manager").textContent = proposed + "ccTLD-beheerders zijn niet noodzakelijkerwijs gebonden aan internationale normen.";
		document.getElementById("rootzone_registry_operator_organization_name").textContent = proposed + 'De juridische naam van de organisatie die verantwoordelijk is voor de registratieactiviteiten.';
		document.getElementById("rootzone_registry_operator_presented_name").textContent = proposed;
		...
		document.getElementById("metadata_registrar_public_ids").textContent = proposed + "Een IANA-registraraccreditatie-ID voor gTLD's moet correct zijn.";
		...
		document.getElementById("metadata_accredited_registrars_url").textContent = proposed;
		document.getElementById("metadata_root_zones_url").textContent = proposed + 'Een verwijzing naar de officiële lijst met Root Zones.';
		...
		document.getElementById("rootzone_country_code_designated_manager").textContent = proposed + 'ccTLD managers are not necessarily bound by international standards.';
		document.getElementById("rootzone_registry_operator_organization_name").textContent = proposed + 'The legal name of the organization responsible for registration activities.';
		document.getElementById("rootzone_registry_operator_presented_name").textContent = proposed;
		...
		document.getElementById("metadata_registrar_public_ids").textContent = proposed + "The IANA registrar accreditation ID for gTLDs must be accurate.";
		...
		document.getElementById("metadata_accredited_registrars_url").textContent = proposed;
		document.getElementById("metadata_root_zones_url").textContent = proposed + 'A reference to the official list of Root Zones.';
		...
		document.getElementById("rootzone_country_code_designated_manager").textContent = proposed + 'ccTLD-Manager sind nicht unbedingt an internationale Standards gebunden.';
		document.getElementById("rootzone_registry_operator_organization_name").textContent = proposed + 'Der offizielle Name der Organisation, die für die Registrierungsaktivitäten verantwortlich ist.';
		document.getElementById("rootzone_registry_operator_presented_name").textContent = proposed;
		...
		document.getElementById("metadata_registrar_public_ids").textContent = proposed + "Eine IANA-Registrar-Akkreditierungs-ID für gTLDs muss korrekt sein.";
		...
		document.getElementById("metadata_accredited_registrars_url").textContent = proposed;
		document.getElementById("metadata_root_zones_url").textContent = proposed + 'Ein Verweis auf die offizielle Liste der Root-Zones.';	
		...
		document.getElementById("rootzone_country_code_designated_manager").textContent = proposed + "Les gestionnaires de ccTLD ne sont pas nécessairement liés par les normes internationales.";
		document.getElementById("rootzone_registry_operator_organization_name").textContent = proposed + "Le nom légal de l’organisation responsable des activités d’enregistrement.";
		document.getElementById("rootzone_registry_operator_presented_name").textContent = proposed;
		...
		document.getElementById("metadata_registrar_public_ids").textContent = proposed + "Un identifiant d'accréditation de bureau d'enregistrement IANA pour les gTLD doit être exact.";
		...
		document.getElementById("metadata_accredited_registrars_url").textContent = proposed;
		document.getElementById("metadata_root_zones_url").textContent = proposed + "Une référence à la liste officielle des 'Root Zones'.";	
...
if (true or $pd == mb_strtolower($data[$pd]['domain']['ascii_name']) or empty($data[$pd]['domain']['ascii_name']))	{
	...
	$html_text .= '<tr id="101" style="display:none"><td>rootzone tld_category</td><td>'.$data[$pd]['rootzone']['tld_category'].'</td><td id="rootzone_tld_category"></td></tr>';
	$html_text .= '<tr id="102" style="display:none"><td>rootzone tld_type</td><td>'.$data[$pd]['rootzone']['tld_type'].'</td><td id="rootzone_tld_type"></td></tr>';
	$html_text .= '<tr id="103" style="display:none"><td>rootzone sponsoring_organization_name</td><td>'.$data[$pd]['rootzone']['sponsoring_organization_name'].'</td><td id="rootzone_sponsoring_organization_name"></td></tr>';
	$html_text .= '<tr id="104" style="display:none"><td>rootzone country_code_designated_manager</td><td>'.$data[$pd]['rootzone']['country_code_designated_manager'].'</td><td id="rootzone_country_code_designated_manager"></td></tr>';
	$html_text .= '<tr id="105" style="display:none"><td>rootzone registry_operator_organization_name</td><td>'.$data[$pd]['rootzone']['registry_operator_organization_name'].'</td><td id="rootzone_registry_operator_organization_name"></td></tr>';
	$html_text .= '<tr id="106" style="display:none"><td>rootzone registry_operator_presented_name</td><td>'.$data[$pd]['rootzone']['registry_operator_presented_name'].'</td><td id="rootzone_registry_operator_presented_name"></td></tr>';
	$html_text .= '<tr id="107" style="display:none"><td>rootzone backend_operator_organization_name</td><td>'.$data[$pd]['rootzone']['backend_operator_organization_name'].'</td><td id="rootzone_backend_operator_organization_name"></td></tr>';
	$html_text .= '<tr id="108" style="display:none"><td>rootzone backend_operator_presented_name</td><td>'.$data[$pd]['rootzone']['backend_operator_presented_name'].'</td><td id="rootzone_backend_operator_presented_name"></td></tr>';
	$html_text .= '<tr id="109" style="display:none"><td>rootzone language_codes</td><td>'.$data[$pd]['rootzone']['language_codes'].'</td><td id="rootzone_language_codes"></td></tr>';
	$html_text .= '<tr id="1010" style="display:none"><td>rootzone delegation_url</td><td><a href='.$data[$pd]['rootzone']['delegation_url'].' target="_blank">TLD Delegation</a></td><td id="rootzone_delegation_url"></td></tr>';
	$html_text .= '<tr id="1011" style="display:none"><td>rootzone restrictions_url</td><td>'.((strlen($data[$pd]['rootzone']['restrictions_url'])) ? '<a href='.$data[$pd]['rootzone']['restrictions_url'].' target="_blank">TLD Restrictions</a>' : '').'</td><td id="rootzone_restrictions_url"></td></tr>';
	$html_text .= '<tr id="1012" style="display:none"><td>rootzone menu_url</td><td>'.((strlen($data[$pd]['rootzone']['menu_url'])) ? '<a href='.$data[$pd]['rootzone']['menu_url'].' target="_blank">TLD Menu</a>' : '').'</td><td id="rootzone_menu_url"></td></tr>';
	...
	$html_text .= '<tr id="291" style="display:none"><td>metadata object_class_name</td><td>'.$data[$pd]['metadata']['object_class_name'].'</td><td id="metadata_object_class_name"></td></tr>';
	$html_text .= '<tr id="292" style="display:none; vertical-align:top"><td>metadata object_conformance</td><td>'.$data[$pd]['metadata']['object_conformance'].'</td><td id="metadata_object_conformance"></td></tr>';
	$html_text .= '<tr id="293" style="display:none"><td>metadata resource_upload_at</td><td>'.$data[$pd]['metadata']['resource_upload_at'].'</td><td id="metadata_resource_upload_at"></td></tr>';
	...
	$html_text .= '<tr id="294" style="display:none"><td>metadata registry_source</td><td>'.((strlen($data[$pd]['metadata']['registry_source'])) ? '<a href='.$data[$pd]['metadata']['registry_source'].' target="_blank">Registry Response</a> - <a href="' . htmlspecialchars($validation_registry, ENT_QUOTES, "UTF-8") . '" target="_blank">validator.rdap.org</a>' : '').'</td><td id="metadata_registry_source"></td></tr>';
	$html_text .= '<tr id="295" style="display:none"><td>metadata lookup_endpoints_url</td><td><a href='.$data[$pd]['metadata']['lookup_endpoints_url'].' target="_blank">Lookup Endpoints</a></td><td id="metadata_lookup_endpoints_url"></td></tr>';
	...
	$html_text .= '<tr id="296" style="display:none"><td>metadata registrar_source eg. <a style="font-size: 0.9rem" href="https://rdap.cscglobal.com/dbs/rdap-api/v1/domain/icann.com" target="_blank">icann.com</a> <a style="font-size: 0.9rem" href="https://rdap.metaregistrar.com/domain/fryslan.frl" target="_blank">fryslan.frl</a></td><td>'.((strlen($data[$pd]['metadata']['registrar_source'])) ? '<a href='.$data[$pd]['metadata']['registrar_source'].' target="_blank">Registrar Response</a> - <a href="' . htmlspecialchars($validation_registrar, ENT_QUOTES, "UTF-8") . '" target="_blank">validator.rdap.org</a>' : '').'</td><td id="metadata_registrar_source"></td></tr>';
	$html_text .= '<tr id="297" style="display:none"><td>metadata registrar_public_ids</td><td>'.((strlen($data[$pd]['metadata']['registrar_public_ids'])) ? $data[$pd]['metadata']['registrar_public_ids'] : 'no IANA ID').'</td><td id="metadata_registrar_public_ids"></td></tr>';
	$html_text .= '<tr id="298" style="display:none"><td>metadata registrar_complaint_url</td><td>'.((strlen($data[$pd]['metadata']['registrar_complaint_url'])) ? '<a href='.$data[$pd]['metadata']['registrar_complaint_url'].' target="_blank">icann.org/wicf</a>' : '').'</td><td id="metadata_registrar_complaint_url"></td></tr>';
	$html_text .= '<tr id="299" style="display:none"><td>metadata status_explanation_url</td><td>'.((strlen($data[$pd]['metadata']['status_explanation_url'])) ? '<a href='.$data[$pd]['metadata']['status_explanation_url'].' target="_blank">icann.org/epp</a>' : '').'</td><td id="metadata_status_explanation_url"></td></tr>';
	$html_text .= '<tr id="2910" style="display:none"><td>metadata accredited_registrars_url</td><td><a href='.$data[$pd]['metadata']['accredited_registrars_url'].' target="_blank">IANA Registrars</a></td><td id="metadata_accredited_registrars_url"></td></tr>';
	$html_text .= '<tr id="2911" style="display:none"><td>metadata root_zones_url</td><td><a href='.$data[$pd]['metadata']['root_zones_url'].' target="_blank">Root Zones</a></td><td id="metadata_root_zones_url"></td></tr>';
