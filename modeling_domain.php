...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="4013" style="display:none"><td>registrant_shielding</td><td>'.$item->registrant->shielding.'</td><td id="registrant_shielding"></td></tr>';
	...
	$html_text .= '<tr id="4116" style="display:none"><td>administrative_shielding</td><td>'.$item->administrative->shielding.'</td><td id="administrative_shielding"></td></tr>';
	...
	$html_text .= '<tr id="4216" style="display:none"><td>technical_shielding</td><td>'.$item->technical->shielding.'</td><td id="technical_shielding"></td></tr>';
	...
	$html_text .= '<tr id="4317" style="display:none"><td>billing_shielding</td><td>'.$item->billing->shielding.'</td><td id="billing_shielding"></td></tr>';
	...
	$html_text .= '<tr id="4417" style="display:none"><td>emergency_shielding</td><td>'.$item->emergency->shielding.'</td><td id="emergency_shielding"></td></tr>';
	...
	$html_text .= '<tr id="5015" style="display:none"><td>reseller_shielding</td><td>'.$item->reseller->shielding.'</td><td id="reseller_shielding"></td></tr>';
	...
	$html_text .= '<tr id="6017" style="display:none"><td>registrar_shielding</td><td>'.$item->registrar->shielding.'</td><td id="registrar_shielding"></td></tr>';
	...
	$html_text .= '<tr id="6219" style="display:none"><td>sponsor_shielding</td><td>'.$item->sponsor->shielding.'</td><td></td></tr>';
