...
if (true or $pd == mb_strtolower($data[$pd]['domain']['ascii_name']) or empty($data[$pd]['domain']['ascii_name']))	{
	...
	$html_text .= '<tr id="395" style="display:none"><td>sponsor organization_name</td><td>'.$data[$pd]['sponsor']['organization_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="396" style="display:none"><td>sponsor presented_name</td><td>'.$data[$pd]['sponsor']['presented_name'].'</td><td id="sponsor_recover"></td></tr>';
	$html_text .= '<tr id="397" style="display:none"><td>sponsor kind</td><td>'.$data[$pd]['sponsor']['kind'].'</td><td></td></tr>';
	$html_text .= '<tr id="398" style="display:none"><td>sponsor name</td><td>'.$data[$pd]['sponsor']['name'].'</td><td></td></tr>';
	$html_text .= '<tr id="399" style="display:none"><td>sponsor email</td><td>'.$data[$pd]['sponsor']['email'].'</td><td></td></tr>';
	$html_text .= '<tr id="3910" style="display:none"><td>sponsor telephone</td><td>'.$data[$pd]['sponsor']['telephone'].'</td><td></td></tr>';
	$html_text .= '<tr id="3911" style="display:none"><td>sponsor country_code</td><td>'.$data[$pd]['sponsor']['country_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="3912" style="display:none"><td>sponsor street_address</td><td>'.$data[$pd]['sponsor']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="3913" style="display:none"><td>sponsor city</td><td>'.$data[$pd]['sponsor']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="3914" style="display:none"><td>sponsor state_or_province</td><td>'.$data[$pd]['sponsor']['state_or_province'].'</td><td></td></tr>';
	$html_text .= '<tr id="3915" style="display:none"><td>sponsor postal_code</td><td>'.$data[$pd]['sponsor']['postal_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="3916" style="display:none"><td>sponsor country_name</td><td>'.$data[$pd]['sponsor']['country_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="3917" style="display:none"><td>sponsor language_pref_1</td><td>'.$data[$pd]['sponsor']['language_pref_1'].'</td><td></td></tr>';
	$html_text .= '<tr id="3918" style="display:none"><td>sponsor language_pref_2</td><td>'.$data[$pd]['sponsor']['language_pref_2'].'</td><td></td></tr>';
	$html_text .= '<tr id="3919" style="display:none;vertical-align:top"><td>sponsor statuses</td><td>'.$data[$pd]['sponsor']['statuses'].'</td><td></td></tr>';
	$html_text .= '<tr id="3920" style="display:none"><td>sponsor created_at</td><td>'.$data[$pd]['sponsor']['created_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="3921" style="display:none"><td>sponsor latest_update_at</td><td>'.$data[$pd]['sponsor']['latest_update_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="3922" style="display:none"><td>sponsor verification_received_at</td><td>'.$data[$pd]['sponsor']['verification_received_at'].'</td><td id="sponsor_verification_received_at"></td></tr>';
	$html_text .= '<tr id="3923" style="display:none"><td>sponsor verification_set_at</td><td>'.$data[$pd]['sponsor']['verification_set_at'].'</td><td id="sponsor_verification_set_at"></td></tr>';
	...
	$html_text .= '<tr id="405" style="display:none"><td>registrant kind</td><td>'.$data[$pd]['registrant']['kind'].'</td><td id="registrant_kind"></td></tr>';
	$html_text .= '<tr id="406" style="display:none"><td>registrant name</td><td>'.$data[$pd]['registrant']['name'].'</td><td id="registrant_name"></td></tr>';
	$html_text .= '<tr id="407" style="display:none"><td>registrant email</td><td>'.$data[$pd]['registrant']['email'].'</td><td></td></tr>';
	$html_text .= '<tr id="408" style="display:none"><td>registrant telephone</td><td>'.$data[$pd]['registrant']['telephone'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="409" style="display:none"><td>registrant street_address</td><td>'.$data[$pd]['registrant']['street_address'].'</td><td id="registrant_street_address"></td></tr>';
	$html_text .= '<tr id="4010" style="display:none"><td>registrant city</td><td>'.$data[$pd]['registrant']['city'].'</td><td id="registrant_city"></td></tr>';
	$html_text .= '<tr id="4011" style="display:none"><td>registrant state_or_province</td><td>'.$data[$pd]['registrant']['state_or_province'].'</td><td></td></tr>';
	$html_text .= '<tr id="4012" style="display:none"><td>registrant postal_code</td><td>'.$data[$pd]['registrant']['postal_code'].'</td><td id="registrant_postal_code"></td></tr>';
	$html_text .= '<tr id="4013" style="display:none"><td>registrant country_name</td><td>'.$data[$pd]['registrant']['country_name'].'</td><td id="registrant_country_name"></td></tr>';
	$html_text .= '<tr id="4014" style="display:none"><td>registrant language_pref_1</td><td>'.$data[$pd]['registrant']['language_pref_1'].'</td><td></td></tr>';
	$html_text .= '<tr id="4015" style="display:none"><td>registrant language_pref_2</td><td>'.$data[$pd]['registrant']['language_pref_2'].'</td><td></td></tr>';
	$html_text .= '<tr id="4016" style="display:none;vertical-align:top"><td>registrant statuses</td><td>'.$data[$pd]['registrant']['statuses'].'</td><td></td></tr>';
	$html_text .= '<tr id="4017" style="display:none"><td>registrant created_at</td><td>'.$data[$pd]['registrant']['created_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="4018" style="display:none"><td>registrant latest_update_at</td><td>'.$data[$pd]['registrant']['latest_update_at'].'</td><td></td></tr>';
	$html_text .= '<tr><td>registrant verification_received_at</td><td>'.$data[$pd]['registrant']['verification_received_at'].'</td><td id="registrant_verification_received_at"></td></tr>';
	$html_text .= '<tr><td>registrant verification_set_at</td><td>'.$data[$pd]['registrant']['verification_set_at'].'</td><td id="registrant_verification_set_at"></td></tr>';
	...
	$html_text .= '<tr id="415" style="display:none"><td>administrative organization_name</td><td>'.$data[$pd]['administrative']['organization_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="416" style="display:none"><td>administrative presented_name</td><td>'.$data[$pd]['administrative']['presented_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="417" style="display:none"><td>administrative kind</td><td>'.$data[$pd]['administrative']['kind'].'</td><td></td></tr>';
	$html_text .= '<tr id="418" style="display:none"><td>administrative name</td><td>'.$data[$pd]['administrative']['name'].'</td><td></td></tr>';
	$html_text .= '<tr><td>administrative email</td><td>'.$data[$pd]['administrative']['email'].'</td><td></td></tr>';
	$html_text .= '<tr id="419" style="display:none"><td>administrative telephone</td><td>'.$data[$pd]['administrative']['telephone'].'</td><td></td></tr>';
	$html_text .= '<tr id="4110" style="display:none"><td>administrative country_code</td><td>'.$data[$pd]['administrative']['country_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="4111" style="display:none"><td>administrative street_address</td><td>'.$data[$pd]['administrative']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="4112" style="display:none"><td>administrative city</td><td>'.$data[$pd]['administrative']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="4113" style="display:none"><td>administrative state_or_province</td><td>'.$data[$pd]['administrative']['state_or_province'].'</td><td></td></tr>';
	$html_text .= '<tr id="4114" style="display:none"><td>administrative postal_code</td><td>'.$data[$pd]['administrative']['postal_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="4115" style="display:none"><td>administrative country_name</td><td>'.$data[$pd]['administrative']['country_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="4116" style="display:none"><td>administrative language_pref_1</td><td>'.$data[$pd]['administrative']['language_pref_1'].'</td><td></td></tr>';
	$html_text .= '<tr id="4117" style="display:none"><td>administrative language_pref_2</td><td>'.$data[$pd]['administrative']['language_pref_2'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="425" style="display:none"><td>technical organization_name</td><td>'.$data[$pd]['technical']['organization_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="426" style="display:none"><td>technical presented_name</td><td>'.$data[$pd]['technical']['presented_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="427" style="display:none"><td>technical kind</td><td>'.$data[$pd]['technical']['kind'].'</td><td></td></tr>';
	$html_text .= '<tr id="428" style="display:none"><td>technical name</td><td>'.$data[$pd]['technical']['name'].'</td><td></td></tr>';
	$html_text .= '<tr><td>technical email</td><td>'.$data[$pd]['technical']['email'].'</td><td></td></tr>';
	$html_text .= '<tr id="429" style="display:none"><td>technical telephone</td><td>'.$data[$pd]['technical']['telephone'].'</td><td></td></tr>';
	$html_text .= '<tr id="4210" style="display:none"><td>technical country_code</td><td>'.$data[$pd]['technical']['country_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="4211" style="display:none"><td>technical street_address</td><td>'.$data[$pd]['technical']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="4212" style="display:none"><td>technical city</td><td>'.$data[$pd]['technical']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="4213" style="display:none"><td>technical state_or_province</td><td>'.$data[$pd]['technical']['state_or_province'].'</td><td></td></tr>';
	$html_text .= '<tr id="4214" style="display:none"><td>technical postal_code</td><td>'.$data[$pd]['technical']['postal_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="4215" style="display:none"><td>technical country_name</td><td>'.$data[$pd]['technical']['country_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="4216" style="display:none"><td>technical language_pref_1</td><td>'.$data[$pd]['technical']['language_pref_1'].'</td><td></td></tr>';
	$html_text .= '<tr id="4217" style="display:none"><td>technical language_pref_2</td><td>'.$data[$pd]['technical']['language_pref_2'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="435" style="display:none"><td>billing organization_name</td><td>'.$data[$pd]['billing']['organization_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="436" style="display:none"><td>billing presented_name</td><td>'.$data[$pd]['billing']['presented_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="437" style="display:none"><td>billing kind</td><td>'.$data[$pd]['billing']['kind'].'</td><td></td></tr>';
	$html_text .= '<tr id="438" style="display:none"><td>billing name</td><td>'.$data[$pd]['billing']['name'].'</td><td></td></tr>';
	$html_text .= '<tr id="439" style="display:none"><td>billing email</td><td>'.$data[$pd]['billing']['email'].'</td><td></td></tr>';
	$html_text .= '<tr id="4310" style="display:none"><td>billing telephone</td><td>'.$data[$pd]['billing']['telephone'].'</td><td></td></tr>';
	$html_text .= '<tr id="4311" style="display:none"><td>billing country_code</td><td>'.$data[$pd]['billing']['country_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="4312" style="display:none"><td>billing street_address</td><td>'.$data[$pd]['billing']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="4313" style="display:none"><td>billing city</td><td>'.$data[$pd]['billing']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="4314" style="display:none"><td>billing state_or_province</td><td>'.$data[$pd]['billing']['state_or_province'].'</td><td></td></tr>';
	$html_text .= '<tr id="4315" style="display:none"><td>billing postal_code</td><td>'.$data[$pd]['billing']['postal_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="4316" style="display:none"><td>billing country_name</td><td>'.$data[$pd]['billing']['country_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="4317" style="display:none"><td>billing language_pref_1</td><td>'.$data[$pd]['billing']['language_pref_1'].'</td><td></td></tr>';
	$html_text .= '<tr id="4318" style="display:none"><td>billing language_pref_2</td><td>'.$data[$pd]['billing']['language_pref_2'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="445" style="display:none"><td>emergency organization_name</td><td>'.$data[$pd]['emergency']['organization_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="446" style="display:none"><td>emergency presented_name</td><td>'.$data[$pd]['emergency']['presented_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="447" style="display:none"><td>emergency kind</td><td>'.$data[$pd]['emergency']['kind'].'</td><td></td></tr>';
	$html_text .= '<tr id="448" style="display:none"><td>emergency name</td><td>'.$data[$pd]['emergency']['name'].'</td><td></td></tr>';
	$html_text .= '<tr id="449" style="display:none"><td>emergency email</td><td>'.$data[$pd]['emergency']['email'].'</td><td></td></tr>';
	$html_text .= '<tr id="4410" style="display:none"><td>emergency telephone</td><td>'.$data[$pd]['emergency']['telephone'].'</td><td></td></tr>';
	$html_text .= '<tr id="4411" style="display:none"><td>emergency country_code</td><td>'.$data[$pd]['emergency']['country_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="4412" style="display:none"><td>emergency street_address</td><td>'.$data[$pd]['emergency']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="4413" style="display:none"><td>emergency city</td><td>'.$data[$pd]['emergency']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="4414" style="display:none"><td>emergency state_or_province</td><td>'.$data[$pd]['emergency']['state_or_province'].'</td><td></td></tr>';
	$html_text .= '<tr id="4415" style="display:none"><td>emergency postal_code</td><td>'.$data[$pd]['emergency']['postal_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="4416" style="display:none"><td>emergency country_name</td><td>'.$data[$pd]['emergency']['country_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="4417" style="display:none"><td>emergency language_pref_1</td><td>'.$data[$pd]['emergency']['language_pref_1'].'</td><td></td></tr>';
	$html_text .= '<tr id="4418" style="display:none"><td>emergency language_pref_2</td><td>'.$data[$pd]['emergency']['language_pref_2'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="505" style="display:none"><td>reseller kind</td><td>'.$data[$pd]['reseller']['kind'].'</td><td></td></tr>';
	$html_text .= '<tr id="506" style="display:none"><td>reseller name</td><td>'.$data[$pd]['reseller']['name'].'</td><td></td></tr>';
	$html_text .= '<tr id="507" style="display:none"><td>reseller email</td><td>'.$data[$pd]['reseller']['email'].'</td><td></td></tr>';
	$html_text .= '<tr id="508" style="display:none"><td>reseller telephone</td><td>'.$data[$pd]['reseller']['telephone'].'</td><td></td></tr>';
	$html_text .= '<tr><td>reseller country_code</td><td>'.$data[$pd]['reseller']['country_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="509" style="display:none"><td>reseller street_address</td><td>'.$data[$pd]['reseller']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="5010" style="display:none"><td>reseller city</td><td>'.$data[$pd]['reseller']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="5011" style="display:none"><td>reseller state_or_province</td><td>'.$data[$pd]['reseller']['state_or_province'].'</td><td></td></tr>';
	$html_text .= '<tr id="5012" style="display:none"><td>reseller postal_code</td><td>'.$data[$pd]['reseller']['postal_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="5013" style="display:none"><td>reseller country_name</td><td>'.$data[$pd]['reseller']['country_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="5014" style="display:none"><td>reseller language_pref_1</td><td>'.$data[$pd]['reseller']['language_pref_1'].'</td><td></td></tr>';
	$html_text .= '<tr id="5015" style="display:none"><td>reseller language_pref_2</td><td>'.$data[$pd]['reseller']['language_pref_2'].'</td><td></td></tr>';
	$html_text .= '<tr id="5016" style="display:none;vertical-align:top"><td>reseller statuses</td><td>'.$data[$pd]['reseller']['statuses'].'</td><td></td></tr>';
	$html_text .= '<tr id="5017" style="display:none"><td>reseller created_at</td><td>'.$data[$pd]['reseller']['created_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="5018" style="display:none"><td>reseller latest_update_at</td><td>'.$data[$pd]['reseller']['latest_update_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="5019" style="display:none"><td>reseller verification_received_at</td><td>'.$data[$pd]['reseller']['verification_received_at'].'</td><td id="reseller_verification_received_at"></td></tr>';
	$html_text .= '<tr id="5020" style="display:none"><td>reseller verification_set_at</td><td>'.$data[$pd]['reseller']['verification_set_at'].'</td><td id="reseller_verification_set_at"></td></tr>';
	$html_text .= '<tr id="5021" style="display:none;vertical-align:top"><td>reseller properties</td><td>'.$data[$pd]['reseller']['properties'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="605" style="display:none"><td>registrar kind</td><td>'.$data[$pd]['registrar']['kind'].'</td><td></td></tr>';
	$html_text .= '<tr id="606" style="display:none"><td>registrar name</td><td>'.$data[$pd]['registrar']['name'].'</td><td></td></tr>';
	$html_text .= '<tr id="607" style="display:none"><td>registrar email</td><td>'.$data[$pd]['registrar']['email'].'</td><td></td></tr>';
	$html_text .= '<tr id="608" style="display:none"><td>registrar telephone</td><td>'.$data[$pd]['registrar']['telephone'].'</td><td></td></tr>';
	$html_text .= '<tr><td>registrar country_code</td><td>'.$data[$pd]['registrar']['country_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="609" style="display:none"><td>registrar street_address</td><td>'.$data[$pd]['registrar']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="6010" style="display:none"><td>registrar city</td><td>'.$data[$pd]['registrar']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="6011" style="display:none"><td>registrar state_or_province</td><td>'.$data[$pd]['registrar']['state_or_province'].'</td><td></td></tr>';
	$html_text .= '<tr id="6012" style="display:none"><td>registrar postal_code</td><td>'.$data[$pd]['registrar']['postal_code'].'</td><td></td></tr>';
	$html_text .= '<tr id="6013" style="display:none"><td>registrar country_name</td><td>'.$data[$pd]['registrar']['country_name'].'</td><td></td></tr>';
	$html_text .= '<tr id="6014" style="display:none"><td>registrar language_pref_1</td><td>'.$data[$pd]['registrar']['language_pref_1'].'</td><td></td></tr>';
	$html_text .= '<tr id="6015" style="display:none"><td>registrar language_pref_2</td><td>'.$data[$pd]['registrar']['language_pref_2'].'</td><td></td></tr>';
	$html_text .= '<tr id="6016" style="display:none;vertical-align:top"><td>registrar statuses</td><td>'.$data[$pd]['registrar']['statuses'].'</td><td></td></tr>';
	$html_text .= '<tr id="6017" style="display:none"><td>registrar created_at</td><td>'.$data[$pd]['registrar']['created_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="6018" style="display:none"><td>registrar latest_update_at</td><td>'.$data[$pd]['registrar']['latest_update_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="6019" style="display:none"><td>registrar verification_received_at</td><td>'.$data[$pd]['registrar']['verification_received_at'].'</td><td id="registrar_verification_received_at"></td></tr>';
	$html_text .= '<tr id="6020" style="display:none"><td>registrar verification_set_at</td><td>'.$data[$pd]['registrar']['verification_set_at'].'</td><td id="registrar_verification_set_at"></td></tr>';
	...
	$html_text .= '<tr id="615" style="display:none"><td>abuse kind</td><td>'.$data[$pd]['abuse']['kind'].'</td><td></td></tr>';
	$html_text .= '<tr id="616" style="display:none"><td>abuse email</td><td>'.$data[$pd]['abuse']['email'].'</td><td></td></tr>';
	$html_text .= '<tr id="617" style="display:none"><td>abuse telephone</td><td>'.$data[$pd]['abuse']['telephone'].'</td><td id="abuse_telephone"></td></tr>';
	$html_text .= '<tr id="618" style="display:none"><td>abuse country_code</td><td>'.$data[$pd]['abuse']['country_code'].'</td><td id="abuse_country_code"></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	//if (!empty($data[$pd]['name_servers']['server_1']['server_ascii_name']))	{
	//	if (strlen(trim($data[$pd]['name_servers']['server_1']['server_ascii_name'])))	{
			$html_text .= '<tr id="631" style="display:none"><td>server_ascii_name_1</td><td>'.$data[$pd]['name_servers']['server_1']['server_ascii_name'].'</td><td></td></tr>';
			$html_text .= '<tr id="632" style="display:none"><td>server_unicode_name_1</td><td>'.$data[$pd]['name_servers']['server_1']['server_unicode_name'].'</td><td></td></tr>';
			...
			$html_text .= '<tr id="637" style="display:none"><td>server_delegation_latest_correct_check_1</td><td>'.$data[$pd]['name_servers']['server_1']['server_delegation_latest_correct_check'].'</td><td></td></tr>';	
	//	}	
	//}
	if (!empty($data[$pd]['name_servers']['server_2']['server_ascii_name']))	{		
		if (strlen(trim($data[$pd]['name_servers']['server_2']['server_ascii_name'])))	{
			$html_text .= '<tr id="638" style="display:none"><td>server_ascii_name_2</td><td>'.$data[$pd]['name_servers']['server_2']['server_ascii_name'].'</td><td></td></tr>';
			$html_text .= '<tr id="639" style="display:none"><td>server_unicode_name_2</td><td>'.$data[$pd]['name_servers']['server_2']['server_unicode_name'].'</td><td></td></tr>';		
			...
			$html_text .= '<tr id="6314" style="display:none"><td>server_delegation_latest_correct_check_2</td><td>'.$data[$pd]['name_servers']['server_2']['server_delegation_latest_correct_check'].'</td><td></td></tr>';
		}	
	}
	if (!empty($data[$pd]['name_servers']['server_3']['server_ascii_name']))	{
		if (strlen(trim($data[$pd]['name_servers']['server_3']['server_ascii_name'])))	{
			$html_text .= '<tr id="6315" style="display:none"><td>server_ascii_name_3</td><td>'.$data[$pd]['name_servers']['server_3']['server_ascii_name'].'</td><td></td></tr>';
			$html_text .= '<tr id="6316" style="display:none"><td>server_unicode_name_3</td><td>'.$data[$pd]['name_servers']['server_3']['server_unicode_name'].'</td><td></td></tr>';
			...
			$html_text .= '<tr id="6321" style="display:none"><td>server_delegation_latest_correct_check_3</td><td>'.$data[$pd]['name_servers']['server_3']['server_delegation_latest_correct_check'].'</td><td></td></tr>';				
		}	
	}
	if (!empty($data[$pd]['name_servers']['server_4']['server_ascii_name']))	{	
		if (strlen(trim($data[$pd]['name_servers']['server_4']['server_ascii_name'])))	{
			$html_text .= '<tr id="6322" style="display:none"><td>server_ascii_name_4</td><td>'.$data[$pd]['name_servers']['server_4']['server_ascii_name'].'</td><td></td></tr>';
			$html_text .= '<tr id="6323" style="display:none"><td>server_unicode_name_4</td><td>'.$data[$pd]['name_servers']['server_4']['server_unicode_name'].'</td><td></td></tr>';	
			...
			$html_text .= '<tr id="6328" style="display:none"><td>server_delegation_latest_correct_check_4</td><td>'.$data[$pd]['name_servers']['server_4']['server_delegation_latest_correct_check'].'</td><td></td></tr>';
		}	
	}
	if (!empty($data[$pd]['name_servers']['server_5']['server_ascii_name']))	{		
		if (strlen(trim($data[$pd]['name_servers']['server_5']['server_ascii_name'])))	{
			$html_text .= '<tr id="6329" style="display:none"><td>server_ascii_name_5</td><td>'.$data[$pd]['name_servers']['server_5']['server_ascii_name'].'</td><td></td></tr>';
			$html_text .= '<tr id="6330" style="display:none"><td>server_unicode_name_5</td><td>'.$data[$pd]['name_servers']['server_5']['server_unicode_name'].'</td><td></td></tr>';
			...
			$html_text .= '<tr id="6335" style="display:none"><td>server_delegation_latest_correct_check_5</td><td>'.$data[$pd]['name_servers']['server_5']['server_delegation_latest_correct_check'].'</td><td></td></tr>';	
		}	
	}
	if (!empty($data[$pd]['name_servers']['server_6']['server_ascii_name']))	{
		if (strlen(trim($data[$pd]['name_servers']['server_6']['server_ascii_name'])))	{
			$html_text .= '<tr id="6336" style="display:none"><td>server_ascii_name_6</td><td>'.$data[$pd]['name_servers']['server_6']['server_ascii_name'].'</td><td></td></tr>';
			$html_text .= '<tr id="6337" style="display:none"><td>server_unicode_name_6</td><td>'.$data[$pd]['name_servers']['server_6']['server_unicode_name'].'</td><td></td></tr>';	
			...
			$html_text .= '<tr id="6342" style="display:none"><td>server_delegation_latest_correct_check_6</td><td>'.$data[$pd]['name_servers']['server_6']['server_delegation_latest_correct_check'].'</td><td></td></tr>';	
		}	
	}
