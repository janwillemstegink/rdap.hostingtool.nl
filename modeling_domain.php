...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("registrant_last_validated").textContent = proposed;
		...
		document.getElementById("registrant_last_validated").textContent = proposed + "Entiteitsvalidatie vanuit een nationaal domeincontroleregister; en t.b.v. zoekmachines.";
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td>domain_last_uploaded</td><td>'.$item->domain_last_uploaded.'</td><td id="domain_last_uploaded"></td></tr>';
	$html_text .= '<tr id="304" style="display:none"><td>domain_expiration_grace_until</td><td>'.$item->domain_expiration_grace_until.'</td><td></td></tr>';
	$html_text .= '<tr id="305" style="display:none"><td>domain_last_changed</td><td>'.$item->domain_last_changed.'</td><td></td></tr>';
	$html_text .= '<tr id="306" style="display:none"><td>domain_last_transferred</td><td>'.$item->domain_last_transferred.'</td><td></td></tr>';
	...
	$html_text .= '<tr><td>registrant_last_validated</td><td>'.$item->registrant_last_validated.'</td><td id="registrant_last_validated"></td></tr>';
