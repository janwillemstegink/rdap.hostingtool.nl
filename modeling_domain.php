...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("registrant_kind").textContent = "Leeg / 'org' / 'individual' (Continuïteit: levenstestament + testament + digitale executeur)";
	...
	et }
		...
		document.getElementById("registrant_kind").textContent = "Empty / 'org' / 'individual' (Continuity: Living Will + Will + Digital Executor)";
		...
		document.getElementById("registrant_kind").textContent = "Leer / 'org' / 'individual' (Kontinuität: Patientenverfügung + Testament + digitaler Testamentsvollstrecker)";
		...
		document.getElementById("registrant_kind").textContent = "Vide / 'org' / 'individual' (Continuité : testament biologique + testament + exécuteur testamentaire numérique)";
