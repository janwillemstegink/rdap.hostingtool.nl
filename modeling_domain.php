...
function SwitchTranslation(translation)	{
	...
	if (translation == 99)	{
		...
		document.getElementById("metadata_global_data_uri").textContent = proposed + "JSON-antwoord via een globale RDAP-URI die kan verwijzen naar een andere RDAP-bron.";
		document.getElementById("metadata_registry_data_uri").textContent = proposed + "URI van het RDAP-JSON-antwoord van de registry; relatie 'self'.";
		...
		document.getElementById("metadata_registrar_data_uri").textContent = proposed + "URI van het RDAP-JSON-antwoord van de registrar; relatie 'related'.";
		...
		document.getElementById("metadata_global_data_uri").textContent = proposed + "JSON response via a global RDAP URI that may reference another RDAP source.";
		document.getElementById("metadata_registry_data_uri").textContent = proposed + "RDAP JSON response URI from the registry; relationship 'self'.";
		...
		document.getElementById("metadata_registrar_data_uri").textContent = proposed + "RDAP JSON response URI from the registrar; relationship 'related'.";
		...
		document.getElementById("metadata_global_data_uri").textContent = proposed + "JSON-Antwort über eine globale RDAP-URI, die auf eine andere RDAP-Quelle verweisen kann.";
		document.getElementById("metadata_registry_data_uri").textContent = proposed + "URI der RDAP-JSON-Antwort der Registry; Beziehung 'self'.";
		...
		document.getElementById("metadata_registrar_data_uri").textContent = proposed + "URI der RDAP-JSON-Antwort des Registrars; Beziehung 'related'."
		...
		document.getElementById("metadata_global_data_uri").textContent = proposed + "Réponse JSON via une URI RDAP globale pouvant référencer une autre source RDAP.";
