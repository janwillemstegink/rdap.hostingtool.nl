...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td>registrant_country_code <a style="font-size: 0.9rem" href="https://icann-hamster.nl/ham/soac/ccnso/techday/icann80/2.%20RDAP%20Conformance%20Tool%20-%20Tech%20Day.pdf" target="_blank">(cc parameter)</a></td><td>'.$item->registrant->registrant_country_code.'</td><td id="registrant_country_code"></td></tr>';
