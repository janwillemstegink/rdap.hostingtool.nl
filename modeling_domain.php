...
function SwitchTranslation(translation)	{
	...
	if (translation == 99)	{
		...
		document.getElementById("metadata_language_codes").textContent = modified;
		...
		document.getElementById("nameservers_secure_ds_digest_types").textContent = "";
		...
		document.getElementById("metadata_terms_and_conditions_uri").textContent = proposed + "Machineleesbare IANA TLD- en RDAP-bootstrapdata (PostgreSQL JSON-gestructureerd)";
		...
		document.getElementById("metadata_registrar_json_response_uri").textContent = proposed + "RDAP JSON-antwoord van de registrar; relationship 'related'.";
		...
		document.getElementById("metadata_language_codes").textContent = modified + "Beperkte functionele waarde; mogelijk nuttig voor sommige ccTLD’s en geoTLD's.";	
		...
		document.getElementById("nameservers_secure_ds_digest_types").textContent = "Hexadecimale digestwaarden zijn niet hoofdlettergevoelig.";
		...
		document.getElementById("metadata_terms_and_conditions_uri").textContent = proposed + "Machine-Readable IANA TLD & RDAP Bootstrap Data (PostgreSQL JSON-Structured)";
		...
		document.getElementById("metadata_registrar_json_response_uri").textContent = proposed + "RDAP JSON response from the registrar; relationship 'related'.";
		...
		document.getElementById("metadata_language_codes").textContent = modified + "Limited functional value; may be useful for some ccTLDs and geoTLDs.";
		...
		document.getElementById("nameservers_secure_ds_digest_types").textContent = "The hexadecimal digest values are case-insensitive.";
		...
		document.getElementById("metadata_terms_and_conditions_uri").textContent = proposed + "Maschinenlesbare IANA-TLD- und RDAP-Bootstrap-Daten (PostgreSQL-JSON-strukturiert)";
		...
		document.getElementById("metadata_registrar_json_response_uri").textContent = proposed + "RDAP-JSON-Antwort vom Registrar; relationship 'related'."
		...
		document.getElementById("metadata_language_codes").textContent = modified + "Begrenzter funktionaler Nutzen; für einige ccTLDs und geoTLDs eventuell relevant.";
		...
		document.getElementById("nameservers_secure_ds_digest_types").textContent = "Hexadezimale Digestwerte sind nicht von Groß-/Kleinschreibung abhängig.";
		...
		document.getElementById("metadata_terms_and_conditions_uri").textContent = proposed + "Données IANA TLD et RDAP bootstrap lisibles par machine (structurées en JSON pour PostgreSQL)";
		...
		document.getElementById("metadata_registrar_json_response_uri").textContent = proposed + "Réponse JSON RDAP du registraire ; relationship 'related'.";
		...
		document.getElementById("metadata_language_codes").textContent = modified + "Valeur fonctionnelle limitée ; éventuellement utile pour certains ccTLD et geoTLD.";
		...
		document.getElementById("nameservers_secure_ds_digest_types").textContent = "Les valeurs de hachage hexadécimales sont insensibles à la casse.";
...
if (true or $pd == mb_strtolower($data[$pd]['registry']['properties']['ascii_name']) or empty($data[$pd]['registry']['properties']['ascii_name']))	{
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer;font-size:0.8rem" onclick="SwitchDisplay(50)">Reseller +/-</button></td><td><b>'.$vd.'</b></td><td id="reseller_role"></td><td></td></tr>';
	...
	$html_text .= '<tr id="6311" style="display:none"><td>secure_ds_key_tags</td><td>'.str_replace(',',',<br />',$data[$pd]['registry']['nameservers']['secure_ds_key_tags']).'</td><td></td><td>'.str_replace(',',',<br />',$data[$pd]['registrar']['nameservers']['secure_ds_key_tags']).'</td></tr>';
	$html_text .= '<tr id="6312" style="display:none"><td>secure_ds_algorithms</td><td>'.str_replace(',',',<br />',$data[$pd]['registry']['nameservers']['secure_ds_algorithms']).'</td><td id="nameservers_secure_ds_algorithms"></td><td>'.str_replace(',',',<br />',$data[$pd]['registrar']['nameservers']['secure_ds_algorithms']).'</td></tr>';
	$html_text .= '<tr id="6313" style="display:none"><td>secure_ds_digest_types</td><td>'.str_replace(',',',<br />',$data[$pd]['registry']['nameservers']['secure_ds_digest_types']).'</td><td id="nameservers_secure_ds_digest_types"></td><td>'.str_replace(',',',<br />',$data[$pd]['registrar']['nameservers']['secure_ds_digest_types']).'</td></tr>';
	$html_text .= '<tr id="6314" style="display:none"><td>secure_ds_digests</td><td colspan="2">'.str_replace(',',',<br />',$data[$pd]['registry']['nameservers']['secure_ds_digests']).'</td><td>'.str_replace(',',',<br />',$data[$pd]['registrar']['nameservers']['secure_ds_digests']).'</td></tr>';
