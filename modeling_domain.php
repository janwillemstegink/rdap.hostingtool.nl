...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td>domain_will_expire</td><td>'.$item->domain_will_expire.'</td><td></td></tr>';
	$html_text .= '<tr id="303" style="display:none"><td>domain_out_of_quarantine</td><td>'.$item->domain_out_of_quarantine.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
