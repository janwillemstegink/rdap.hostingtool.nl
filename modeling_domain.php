...
$url1a = "http://whois.hostingtool.nl/compose_data/index.php?domain=$inputdomain&format=xml&type=1";
$url1b = "http://whois.hostingtool.nl/".$zonefile;
$url2a = "http://whois.hostingtool.nl/compose_data/index.php?domain=$inputdomain&format=xml&type=2";
$url2b = "http://whois.hostingtool.nl/".$domainfile;
...
elseif (@get_headers($url1a) and false)	{ // for using the application to compose
	$xml1 = simplexml_load_file($url1a, "SimpleXMLElement", LIBXML_NOCDATA) or die("Cannot load url2a from non-public folder.");
}
else	{
	$xml1 = simplexml_load_file($url1b, "SimpleXMLElement", LIBXML_NOCDATA) or die("Cannot load url2b from public_html folder.");
}
...
elseif (@get_headers($url2a) and false)	{ // the application to compose is modeled only for zone data.
	$xml2 = simplexml_load_file($url2a, "SimpleXMLElement", LIBXML_NOCDATA) or die("Cannot load url1a from non-public folder.");
}
else	{
	$xml2 = simplexml_load_file($url2b, "SimpleXMLElement", LIBXML_NOCDATA) or die("Cannot load url1b from public_html folder.");
}
...
foreach ($xml1->xpath('//zone') as $item)	{
	...
	$html_text .= '<tr id="104" style="display:none"><td><b>zone_registry_name</b></td><td>'.$item->zone_registry_name.'</td><td></td></tr>';
	$html_text .= '<tr id="105" style="display:none"><td><b>zone_registry_abbreviation</b></td><td>'.$item->zone_registry_abbreviation.'</td><td></td></tr>';
	$html_text .= '<tr id="106" style="display:none"><td><b>zone_registry_web_id</b></td><td>'.$item->zone_registry_web_id.'</td><td></td></tr>';
	$html_text .= '<tr id="107" style="display:none"><td><b>zone_time_zone</b></td><td>'.$item->zone_time_zone.'</td><td></td></tr>';
	$html_text .= '<tr id="108" style="display:none"><td><b>zone_language</b></td><td>'.$item->zone_language.'</td><td></td></tr>';
	$html_text .= '<tr id="109" style="display:none"><td><b>zone_format</b></td><td>'.$item->zone_format.'</td><td></td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
