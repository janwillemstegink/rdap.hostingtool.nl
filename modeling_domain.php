...
if (true or $pd == mb_strtolower($data[$pd]['registry']['properties']['ascii_name']) or empty($data[$pd]['registry']['properties']['ascii_name']))	{
	...
	$html_text .= '<tr id="208" style="display:none"><td>registrar_identifiers</td><td>'.((strlen($data[$pd]['registry']['metadata']['registrar_identifiers'])) ? $data[$pd]['registry']['metadata']['registrar_identifiers'] : '').'</td><td id="metadata_registrar_identifiers"></td><td>'.$data[$pd]['registrar']['metadata']['registrar_identifiers'].'</td></tr>';
	...
	$html_text .= '<tr id="2012" style="display:none"><td>language_codes</td><td>'.$data[$pd]['registry']['metadata']['language_codes'].'</td><td id="metadata_language_codes"></td><td>'.$data[$pd]['registrar']['metadata']['language_codes'].'</td></tr>';
