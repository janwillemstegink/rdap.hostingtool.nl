...
function SwitchTranslation(inputlanguage)	{
	...
	if (inputlanguage == 0)	{
		...
		document.getElementById("zone_menu").textContent = newfield;
		document.getElementById("zone_support").textContent = newfield;
		document.getElementById("zone_registry_web_id").textContent = newfield;
		document.getElementById("zone_registry_trade_name").textContent = newfield;
		document.getElementById("zone_time_zone").textContent = newfield;
		document.getElementById("zone_language").textContent = newfield;
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr id="107" style="display:none"><td>zone_description_legal</td><td><b>'.$item->zone->zone_description_legal.'</b></td><td></td></tr>';
	$html_text .= '<tr id="108" style="display:none"><td>zone_description_translated</td><td><b>'.$item->zone->zone_description_translated.'</b></td><td></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	...
	$html_text .= '<tr id="151" style="display:none"><td>zone_privacy_title</td><td><b>'.$item->zone->zone_privacy_title.'</b></td><td></td></tr>';
	$html_text .= '<tr id="152" style="display:none"><td>zone_privacy_legal</td><td><b>'.$item->zone->zone_privacy_legal.'</b></td><td></td></tr>';
	$html_text .= '<tr id="153" style="display:none"><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	$html_text .= '<tr id="154" style="display:none"><td>zone_privacy_translated</td><td><b>'.$item->zone->zone_privacy_translated.'</b></td><td></td></tr>';
	$html_text .= '<tr id="155" style="display:none"><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	$html_text .= '<tr id="156" style="display:none"><td>zone_copyright_title</td><td><b>'.$item->zone->zone_copyright_title.'</b></td><td></td></tr>';
	$html_text .= '<tr id="157" style="display:none"><td>zone_copyright_legal</td><td><b>'.$item->zone->zone_copyright_legal.'</b></td><td></td></tr>';
	$html_text .= '<tr id="158" style="display:none"><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
	$html_text .= '<tr id="159" style="display:none"><td>zone_copyright_translated</td><td><b>'.$item->zone->zone_copyright_translated.'</b></td><td></td></tr>';
	$html_text .= '<tr><td><hr></b></td><td><hr></b></td><td><hr></td></tr>';
