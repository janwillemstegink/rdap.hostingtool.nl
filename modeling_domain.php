...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("resource_role").textContent = "";
		document.getElementById("resource_registrar_source").textContent = proposed;
		document.getElementById("resource_registrar_public_ids").textContent = proposed;
		document.getElementById("resource_registrar_complaint_url").textContent = proposed;
		document.getElementById("resource_status_explanation_url").textContent = proposed;
		...
		document.getElementById("domain_recovery_until").textContent = proposed;
		document.getElementById("domain_deletion_at").textContent = "";
		document.getElementById("domain_last_uploaded_at").textContent = "";
		...
		document.getElementById("registrant_verification_received").textContent = proposed;
		document.getElementById("registrant_verification_set").textContent = proposed;
		...
		document.getElementById("reseller_verification_received").textContent = proposed;
		document.getElementById("reseller_verification_set").textContent = proposed;
		...
		document.getElementById("registrar_verification_received").textContent = proposed;
		document.getElementById("registrar_verification_set").textContent = proposed;
		...
		document.getElementById("zone_menu_url").textContent = proposed + 'Een zonespecifiek informatiemenu, beschikbaar onder een subdomein zoals "regmenu".';
		...
		document.getElementById("resource_role").textContent = "Geplande functie: Web-ID-zoekopdrachten zijn beschikbaar op wereldwijde RDAP-servers.";
		document.getElementById("resource_registrar_source").textContent = proposed + 'Er is geen registrarbron-URL opgenomen in het huidige RDAP v1-antwoord.';
		document.getElementById("resource_registrar_public_ids").textContent = proposed + "Een IANA-registraraccreditatie-ID voor gTLD's moet correct zijn.";
		document.getElementById("resource_registrar_complaint_url").textContent = proposed + 'Vereist als de registrar IANA-geaccrediteerd is; wordt gebruikt om klachten van gebruikers door te sturen.';		
		document.getElementById("resource_status_explanation_url").textContent = proposed + 'Vereist als de registrar IANA-geaccrediteerd is; bevat uitleg over de statuscode.';
		...
		document.getElementById("domain_name_ascii").textContent = "Voor speciale tekens bevatten de ASCII-tekenreeksen Punycode-transcriptie.";
		document.getElementById("domain_name_unicode").textContent = "Hoewel de informatie duidelijk is, is de unicode-domeinnaam optioneel binnen het RDAP-protocol.";
		...
		document.getElementById("domain_recovery_until").textContent = proposed + "Tijdstip tot wanneer herstel nog mogelijk is.";		
		...
		document.getElementById("domain_last_uploaded_at").textContent = "Datum en tijdstip van de RDAP-database-update in Zoeloe-tijd (Coordinated Universal Time - UTC).";
		...
		document.getElementById("registrant_verification_received").textContent = proposed + "Na identificatie kan een overeenkomende web-ID worden bevestigd, leeg is intrekking.";
		document.getElementById("registrant_verification_set").textContent = proposed + "Vervolgens verifieert de registry de gegevens bij de landspecifieke webdomeindienst.";
		...
		document.getElementById("zone_menu_url").textContent = proposed + 'A zone-specific information menu, available under a subdomain such as "regmenu".';
		document.getElementById("notices_role").textContent = accessible;
		document.getElementById("links_role").textContent = accessible;			
		...
		document.getElementById("background_accredited_registrars_url").textContent = proposed;		
		document.getElementById("background_lookup_endpoints_url").textContent = proposed;
		document.getElementById("background_registry_source").textContent = proposed + "Planned Feature: Support for Web ID searches on global RDAP servers.";
		document.getElementById("resource_role").textContent = "The /v1/ folder may also support /v2/ responses — see icann.com for details.";
		document.getElementById("resource_registrar_source").textContent = proposed + 'No registrar source URL is included in the current RDAP v1 response.';
		document.getElementById("resource_registrar_public_ids").textContent = proposed + "The IANA registrar accreditation ID for gTLDs must be accurate.";
		document.getElementById("resource_registrar_complaint_url").textContent = proposed + 'Required for IANA-accredited registrars; used to direct user complaints.';		
		document.getElementById("resource_status_explanation_url").textContent = proposed + 'Required if the registrar is IANA-accredited; provides status code explanations.';		
		...
		document.getElementById("domain_name_ascii").textContent = "For special characters, the ASCII character strings contain Punycode transcription.";
		document.getElementById("domain_name_unicode").textContent = "Although the information is clear, the unicode domain name is optional within the RDAP protocol.";
		...
		document.getElementById("domain_recovery_until").textContent = proposed + "Time until which recovery is still possible.";
		...
		document.getElementById("domain_last_uploaded_at").textContent = "Date and time of RDAP database update in Zulu time (Coordinated Universal Time - UTC).";
		...
		document.getElementById("registrant_verification_received").textContent = proposed + "After identification, a matching web ID can be confirmed, empty is revocation.";
		document.getElementById("registrant_verification_set").textContent = proposed + "The registry then verifies the data with the country-specific web domain service.";	
		...
		document.getElementById("zone_menu_url").textContent = proposed + 'Ein zonenspezifisches Informationsmenü, verfügbar unter einer Subdomäne wie "regmenu".';
		document.getElementById("notices_role").textContent = accessible;
		document.getElementById("links_role").textContent = accessible;
		...
		document.getElementById("resource_role").textContent = "Geplante Funktion: Web-ID-Suchen werden auf globalen RDAP-Servern verfügbar sein.";
		document.getElementById("resource_registrar_source").textContent = proposed + 'Eine Registrar-Quell-URL ist in der aktuellen RDAP v1-Antwort nicht enthalten.';
		document.getElementById("resource_registrar_public_ids").textContent = proposed + "Eine IANA-Registrar-Akkreditierungs-ID für gTLDs muss korrekt sein.";
		document.getElementById("resource_registrar_complaint_url").textContent = proposed + 'Erforderlich, wenn der Registrar IANA-akkreditiert ist; wird verwendet, um Benutzerbeschwerden weiterzuleiten.';
		document.getElementById("resource_status_explanation_url").textContent = proposed + 'Erforderlich, wenn der Registrar IANA-akkreditiert ist; bietet Erklärungen zum Statuscode.';
		...
		document.getElementById("domain_name_ascii").textContent = "Für Sonderzeichen enthalten die ASCII-Zeichenfolgen eine Punycode-Transkription.";
		document.getElementById("domain_name_unicode").textContent = "Obwohl die Informationen eindeutig sind, ist der Unicode-Domänenname innerhalb des RDAP-Protokolls optional.";
		...
		document.getElementById("domain_recovery_until").textContent = proposed + "Zeitpunkt, bis zu dem eine Wiederherstellung noch möglich ist.";
		...
		document.getElementById("domain_last_uploaded_at").textContent = "Datum und Uhrzeit der RDAP-Datenbankaktualisierung in Zulu-Zeit (Koordinierte Weltzeit – UTC).";
		...
		document.getElementById("registrant_verification_received").textContent = proposed + "Nach der Identifizierung kann eine passende Web-ID bestätigt werden, leer ist der Widerruf.";
		document.getElementById("registrant_verification_set").textContent = proposed + "Anschließend verifiziert die Registry die Daten beim länderspezifischen Webdomänendienst.";
		...
		document.getElementById("zone_menu_url").textContent = proposed + "Un menu d'informations spécifique à une zone, disponible sous un sous-domaine tel que 'regmenu'.";
		document.getElementById("notices_role").textContent = accessible;
		document.getElementById("links_role").textContent = accessible;
		...
		document.getElementById("resource_role").textContent = "Fonctionnalité prévue : les recherches d’identifiants Web seront disponibles sur les serveurs RDAP mondiaux.";
		document.getElementById("resource_registrar_source").textContent = proposed + "L'URL source du bureau d'enregistrement n'est pas incluse dans la réponse RDAP v1 actuelle.";
		document.getElementById("resource_registrar_public_ids").textContent = proposed + "Un identifiant d'accréditation de bureau d'enregistrement IANA pour les gTLD doit être exact.";
		document.getElementById("resource_registrar_complaint_url").textContent = proposed + "Obligatoire si le registraire est accrédité par l'IANA ; utilisé pour diriger les plaintes des utilisateurs.";		
		document.getElementById("resource_status_explanation_url").textContent = proposed + "Obligatoire si le registraire est accrédité par l'IANA ; fournit des explications sur le code de statut.";
		...
		document.getElementById("domain_name_ascii").textContent = "Pour les caractères spéciaux, les chaînes de caractères ASCII contiennent une transcription Punycode.";
		document.getElementById("domain_name_unicode").textContent = "Bien que l'information soit claire, le nom de domaine Unicode est facultatif dans le protocole RDAP.";
		...
		document.getElementById("domain_recovery_until").textContent = proposed + "Délai jusqu'à lequel la récupération est encore possible.";
		...
		document.getElementById("domain_last_uploaded_at").textContent = "Date et heure de mise à jour de la base de données RDAP en heure Zulu (Temps Universel Coordonné - UTC).";
		...
		document.getElementById("registrant_verification_received").textContent = proposed + "Après identification, un identifiant Web correspondant peut être confirmé, vide signifie révocation.";
		document.getElementById("registrant_verification_set").textContent = proposed + "Le registre vérifie ensuite les données avec le service de domaine Web spécifique au pays.";
...
//echo $pd.'#'.$data[$pd]['domain']['name_ascii'];
if (true or $pd == mb_strtolower($data[$pd]['domain']['name_ascii']) or empty($data[$pd]['domain']['name_ascii']))	{
	...
	$html_text .= '<tr><td><button style="cursor:pointer;font-size:0.8rem" onclick="SwitchDisplay(29)">Resource Information +/-</button></td><td></td><td id="resource_role"></td></tr>';
	$registry_source = str_replace('https://', '', $data[$pd]['resource']['registry_source']);
	...
	$html_text .= '<tr id="291" style="display:none"><td>resource registry_source</td><td>'.((strlen($data[$pd]['resource']['registry_source'])) ? '<a href='.$data[$pd]['resource']['registry_source'].' target="_blank">Registry Response</a> - <a href="' . htmlspecialchars($validation_registry, ENT_QUOTES, "UTF-8") . '" target="_blank">validator.rdap.org</a>' : 'none').'</td><td id="background_registry_source"></td></tr>';
	$registrar_source = str_replace('https://', '', $data[$pd]['resource']['registrar_source']);
	...
	$html_text .= '<tr id="292" style="display:none"><td>resource registrar_source eg. <a style="font-size: 0.9rem" href="https://rdap.cscglobal.com/dbs/rdap-api/v1/domain/icann.com" target="_blank">icann.com</a> <a style="font-size: 0.9rem" href="https://rdap.metaregistrar.com/domain/fryslan.frl" target="_blank">fryslan.frl</a></td><td>'.((strlen($data[$pd]['resource']['registrar_source'])) ? '<a href='.$data[$pd]['resource']['registrar_source'].' target="_blank">Registrar Response</a> - <a href="' . htmlspecialchars($validation_registrar, ENT_QUOTES, "UTF-8") . '" target="_blank">validator.rdap.org</a>' : 'none').'</td><td id="resource_registrar_source"></td></tr>';
	$html_text .= '<tr id="293" style="display:none"><td>resource registrar_public_ids</td><td>'.((strlen($data[$pd]['resource']['registrar_public_ids'])) ? $data[$pd]['resource']['registrar_public_ids'] : 'none').'</td><td id="resource_registrar_public_ids"></td></tr>';
	$html_text .= '<tr id="294" style="display:none"><td>resource registrar_complaint_url</td><td>'.((strlen($data[$pd]['resource']['registrar_complaint_url'])) ? '<a href='.$data[$pd]['resource']['registrar_complaint_url'].' target="_blank">icann.org/wicf</a>' : 'none').'</td><td id="resource_registrar_complaint_url"></td></tr>';
	$html_text .= '<tr id="295" style="display:none"><td>resource status_explanation_url</td><td>'.((strlen($data[$pd]['resource']['status_explanation_url'])) ? '<a href='.$data[$pd]['resource']['status_explanation_url'].' target="_blank">icann.org/epp</a>' : 'none').'</td><td id="resource_status_explanation_url"></td></tr>';
	//$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer;font-size:0.8rem" onclick="SwitchDisplay(30)">Domain Information +/-</button></td><td>'.$vd.'</td><td id="domain_role"></td></tr>';
	$html_text .= '<tr id="301" style="display:none"><td>domain handle</td><td>'.$data[$pd]['domain']['handle'].'</td><td></td></tr>';
	$html_text .= '<tr id="302" style="display:none"><td>domain name_ascii (lower case is not a "MUST")</td><td>'.$data[$pd]['domain']['name_ascii'].'</td><td id="domain_name_ascii"></td></tr>';
	$html_text .= '<tr id="303" style="display:none"><td>domain name_unicode</td><td>'.$data[$pd]['domain']['name_unicode'].'</td><td id="domain_name_unicode"></td></tr>';
	$html_text .= '<tr style="vertical-align:top"><td>domain status_values</td><td>'.$data[$pd]['domain']['status_values'].'</td><td id="domain_status_values"></td></tr>';
	...
	$html_text .= '<tr id="305" style="display:none"><td>domain last_transferred_at</td><td>'.$data[$pd]['domain']['last_transferred_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="306" style="display:none"><td>domain last_updated_at</td><td>'.$data[$pd]['domain']['last_updated_at'].'</td><td></td></tr>';
	$html_text .= '<tr><td>domain expiration_at</td><td>'.$data[$pd]['domain']['expiration_at'].'</td><td id="domain_expiration_at"></td></tr>';
	$html_text .= '<tr id="307" style="display:none"><td>domain recovery_until</td><td>'.$data[$pd]['domain']['recovery_until'].'</td><td id="domain_recovery_until"></td></tr>';
	...
	$html_text .= '<tr id="309" style="display:none"><td>domain last_uploaded_at</td><td>'.$data[$pd]['domain']['last_uploaded_at'].'</td><td id="domain_last_uploaded_at"></td></tr>';
	$html_text .= '<tr id="3010" style="display:none;vertical-align:top"><td>domain extensions_values</td><td>'.$data[$pd]['domain']['extensions_values'].'</td><td id="domain_extensions_values"></td></tr>';
	$html_text .= '<tr id="3011" style="display:none;vertical-align:top"><td>domain remark_values</td><td>'.$data[$pd]['domain']['remark_values'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="3911" style="display:none"><td>sponsor street_address</td><td>'.$data[$pd]['sponsor']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="3912" style="display:none"><td>sponsor city</td><td>'.$data[$pd]['sponsor']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="3913" style="display:none"><td>sponsor state_or_province</td><td>'.$data[$pd]['sponsor']['state_or_province'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="3921" style="display:none"><td>sponsor last_transferred_at</td><td>'.$data[$pd]['sponsor']['last_transferred_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="3922" style="display:none"><td>sponsor last_updated_at</td><td>'.$data[$pd]['sponsor']['last_updated_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="3923" style="display:none"><td>sponsor expiration_at</td><td>'.$data[$pd]['sponsor']['expiration_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="3924" style="display:none"><td>sponsor deletion_at</td><td>'.$data[$pd]['sponsor']['deletion_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="3925" style="display:none"><td>sponsor last_uploaded_at</td><td>'.$data[$pd]['sponsor']['last_uploaded_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="3926" style="display:none"><td>sponsor verification_received</td><td>'.$data[$pd]['sponsor']['verification_received'].'</td><td id="sponsor_verification_received"></td></tr>';
	$html_text .= '<tr id="3927" style="display:none"><td>sponsor verification_set</td><td>'.$data[$pd]['sponsor']['verification_set'].'</td><td id="sponsor_verification_set"></td></tr>';
	...
	$html_text .= '<tr id="408" style="display:none"><td>registrant street_address</td><td>'.$data[$pd]['registrant']['street_address'].'</td><td id="registrant_street_address"></td></tr>';
	$html_text .= '<tr id="409" style="display:none"><td>registrant city</td><td>'.$data[$pd]['registrant']['city'].'</td><td id="registrant_city"></td></tr>';
	$html_text .= '<tr id="4010" style="display:none"><td>registrant state_or_province</td><td>'.$data[$pd]['registrant']['state_or_province'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4018" style="display:none"><td>registrant last_transferred_at</td><td>'.$data[$pd]['registrant']['last_transferred_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="4019" style="display:none"><td>registrant last_updated_at</td><td>'.$data[$pd]['registrant']['last_updated_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="4020" style="display:none"><td>registrant expiration_at</td><td>'.$data[$pd]['registrant']['expiration_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="4021" style="display:none"><td>registrant deletion_at</td><td>'.$data[$pd]['registrant']['deletion_at'].'</td><td id="registrant_deletion_at"></td></tr>';
	$html_text .= '<tr id="4022" style="display:none"><td>registrant last_uploaded_at</td><td>'.$data[$pd]['registrant']['last_uploaded_at'].'</td><td id="registrant_last_uploaded_at"></td></tr>';
	$html_text .= '<tr><td>registrant verification_received</td><td>'.$data[$pd]['registrant']['verification_received'].'</td><td id="registrant_verification_received"></td></tr>';
	$html_text .= '<tr><td>registrant verification_set</td><td>'.$data[$pd]['registrant']['verification_set'].'</td><td id="registrant_verification_set"></td></tr>';
	...
	$html_text .= '<tr id="4110" style="display:none"><td>administrative street_address</td><td>'.$data[$pd]['administrative']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="4111" style="display:none"><td>administrative city</td><td>'.$data[$pd]['administrative']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="4112" style="display:none"><td>administrative state_or_province</td><td>'.$data[$pd]['administrative']['state_or_province'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4210" style="display:none"><td>technical street_address</td><td>'.$data[$pd]['technical']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="4211" style="display:none"><td>technical city</td><td>'.$data[$pd]['technical']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="4212" style="display:none"><td>technical state_or_province</td><td>'.$data[$pd]['technical']['state_or_province'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4311" style="display:none"><td>billing street_address</td><td>'.$data[$pd]['billing']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="4312" style="display:none"><td>billing city</td><td>'.$data[$pd]['billing']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="4313" style="display:none"><td>billing state_or_province</td><td>'.$data[$pd]['billing']['state_or_province'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="4411" style="display:none"><td>emergency street_address</td><td>'.$data[$pd]['emergency']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="4412" style="display:none"><td>emergency city</td><td>'.$data[$pd]['emergency']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="4413" style="display:none"><td>emergency state_or_province</td><td>'.$data[$pd]['emergency']['state_or_province'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="508" style="display:none"><td>reseller street_address</td><td>'.$data[$pd]['reseller']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="509" style="display:none"><td>reseller city</td><td>'.$data[$pd]['reseller']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="5010" style="display:none"><td>reseller state_or_province</td><td>'.$data[$pd]['reseller']['state_or_province'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="5018" style="display:none"><td>reseller last_transferred_at</td><td>'.$data[$pd]['reseller']['last_transferred_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="5019" style="display:none"><td>reseller last_updated_at</td><td>'.$data[$pd]['reseller']['last_updated_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="5020" style="display:none"><td>reseller expiration_at</td><td>'.$data[$pd]['reseller']['expiration_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="5021" style="display:none"><td>reseller deletion_at</td><td>'.$data[$pd]['reseller']['deletion_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="5022" style="display:none"><td>reseller last_uploaded_at</td><td>'.$data[$pd]['reseller']['last_uploaded_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="5023" style="display:none"><td>reseller verification_received</td><td>'.$data[$pd]['reseller']['verification_received'].'</td><td id="reseller_verification_received"></td></tr>';
	$html_text .= '<tr id="5024" style="display:none"><td>reseller verification_set</td><td>'.$data[$pd]['reseller']['verification_set'].'</td><td id="reseller_verification_set"></td></tr>';
	...
	$html_text .= '<tr id="608" style="display:none"><td>registrar street_address</td><td>'.$data[$pd]['registrar']['street_address'].'</td><td></td></tr>';
	$html_text .= '<tr id="609" style="display:none"><td>registrar city</td><td>'.$data[$pd]['registrar']['city'].'</td><td></td></tr>';
	$html_text .= '<tr id="6010" style="display:none"><td>registrar state_or_province</td><td>'.$data[$pd]['registrar']['state_or_province'].'</td><td></td></tr>';
	...
	$html_text .= '<tr id="6018" style="display:none"><td>registrar last_transferred_at</td><td>'.$data[$pd]['registrar']['last_transferred_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="6019" style="display:none"><td>registrar last_updated_at</td><td>'.$data[$pd]['registrar']['last_updated_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="6020" style="display:none"><td>registrar expiration_at</td><td>'.$data[$pd]['registrar']['expiration_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="6021" style="display:none"><td>registrar deletion_at</td><td>'.$data[$pd]['registrar']['deletion_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="6022" style="display:none"><td>registrar last_uploaded_at</td><td>'.$data[$pd]['registrar']['last_uploaded_at'].'</td><td></td></tr>';
	$html_text .= '<tr id="6023" style="display:none"><td>registrar verification_received</td><td>'.$data[$pd]['registrar']['verification_received'].'</td><td id="registrar_verification_received"></td></tr>';
	$html_text .= '<tr id="6024" style="display:none"><td>registrar verification_set</td><td>'.$data[$pd]['registrar']['verification_set'].'</td><td id="registrar_verification_set"></td></tr>';
