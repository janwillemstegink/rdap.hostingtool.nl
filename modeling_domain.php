...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("domain_status").textContent = "Respijtperiode: 'redemption period'; geplande beëindiging: 'pending delete'; misschien voor blanco: 'registrable'.";
		...
		document.getElementById("domain_status").textContent = "Grace period: 'redemption period'; planned termination: 'pending delete'; maybe for blank: 'registrable'.";
		...
		document.getElementById("domain_status").textContent = "Schonfrist: 'redemption period'; geplante Kündigung: 'pending delete'; vielleicht für leer: 'registrable'.";
		...
		document.getElementById("domain_status").textContent = "Période de grâce : 'redemption period' ; résiliation planifiée : 'pending delete' ; peut-être pour le blanc : 'registrable'.";
