...
if (true or $pd == mb_strtolower($data[$pd]['domain']['name_ascii']) or empty($data[$pd]['domain']['name_ascii']))	{
	...
	$html_text .= '<tr id="3926" style="display:none"><td>sponsor verification_received_at</td><td>'.$data[$pd]['sponsor']['verification_received_at'].'</td><td id="sponsor_verification_received_at"></td></tr>';
	$html_text .= '<tr id="3927" style="display:none"><td>sponsor verification_set_at</td><td>'.$data[$pd]['sponsor']['verification_set_at'].'</td><td id="sponsor_verification_set_at"></td></tr>';
	...
	$html_text .= '<tr id="5023" style="display:none"><td>reseller verification_received_at</td><td>'.$data[$pd]['reseller']['verification_received_at'].'</td><td id="reseller_verification_received_at"></td></tr>';
	$html_text .= '<tr id="5024" style="display:none"><td>reseller verification_set_at</td><td>'.$data[$pd]['reseller']['verification_set_at'].'</td><td id="reseller_verification_set_at"></td></tr>';
	...
	$html_text .= '<tr id="6023" style="display:none"><td>registrar verification_received_at</td><td>'.$data[$pd]['registrar']['verification_received_at'].'</td><td id="registrar_verification_received_at"></td></tr>';
	$html_text .= '<tr id="6024" style="display:none"><td>registrar verification_set_at</td><td>'.$data[$pd]['registrar']['verification_set_at'].'</td><td id="registrar_verification_set_at"></td></tr>';
