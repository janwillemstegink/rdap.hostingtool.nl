...
function SwitchTranslation(translation)	{
	...
	if (translation == 0)	{		
		...
		document.getElementById("domain_event_deletion").textContent = "Geplande datum/tijd voor objectverwijdering, en indien effectief, gevolgd door beschikbaarheid.";
		...
		document.getElementById("domain_event_expiration").textContent = "End date/time of the object for periodic verification or publication discontinuation.";
		document.getElementById("domain_event_deletion").textContent = "Scheduled date/time for object removal, and if effective, followed by availability.";
		...
		document.getElementById("domain_event_expiration").textContent = "Date/heure de fin de l'objet pour la vérification périodique ou l'arrêt de la publication.";
		document.getElementById("domain_event_deletion").textContent = "Date/heure planifiées pour la suppression de l'objet et, si effective, suivies de la disponibilité.";
