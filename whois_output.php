...
elseif (file_exists($inputFile))	{
	...
	//$url = "http://whois.hostingtool.nl/whois_fetch/index.php?domain=".$inputdomain."&format=xml&type=1";
...
elseif (file_exists($restrictionsFile))	{
	...
	//$url2 = "http://whois.hostingtool.nl/whois_fetch/index.php?domain=".$inputdomain."&format=xml&type=2";
...
foreach ($xml->xpath('//domain') as $item)	{
	...
	<td>Zakelijk gebruik heeft een zichtbare en bestaande naam nodig. Dit vereist dat directe verantwoordelijkheid bij de houder ligt, en anders bij de reseller.</td>
	<td>Business use needs a visible and existing name. This requires that direct responsibility lies with the holder, and otherwise with the reseller.</td></tr>';
	...
	<td>De "business_use" is voor transparantie, en privacy van een natuurlijk persoon.</td><td>The "business_use" is for transparency, and privacy of a natural person.</td></tr>';
