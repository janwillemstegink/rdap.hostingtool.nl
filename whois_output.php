...
foreach ($xml->xpath('//domain') as $item)	{
	...
	<td>Voor zakelijk gebruik is de houdernaam zichtbaar. Directe verantwoordelijkheid kan beperkt zijn tot klant-, anders reseller-, niveau van fysieke toegang.</td>
	<td>For business use, the holder name is visible. Direct responsibility may be limited to customer, otherwise reseller, level of physical access.</td></tr>';
	...
	<td>De business_use is voor transparantie en de privacy bij natuurlijke personen.</td><td>The business_use is for transparency and the privacy for natural persons..</td></tr>';
