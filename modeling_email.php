...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td>full_name</td><td>'.$item->registrant->full_name.'</td></tr>';
	...
	$html_text .= '<tr><td>full_name</td><td>'.$item->administrative->full_name.'</td></tr>';
	...
	$html_text .= '<tr><td>full_name</td><td>'.$item->billing->full_name.'</td></tr>';
