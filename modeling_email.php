...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td>administrative_web_id</td><td>'.$item->administrative->administrative_web_id.'</td></tr>';
	$html_text .= '<tr><td>administrative_full_name</td><td>'.$item->administrative->administrative_full_name.'</td></tr>';
	$html_text .= '<tr><td>administrative_kind</td><td>'.$item->administrative->administrative_kind.'</td></tr>';
	$html_text .= '<tr><td>administrative_name</td><td>'.$item->administrative->administrative_name.'</td></tr>';
	$html_text .= '<tr><td>administrative_email</td><td>'.$item->administrative->administrative_email.'</td></tr>';
	$html_text .= '<tr><td>administrative_tel</td><td>'.$item->administrative->administrative_tel.'</td></tr>';
	$html_text .= '<tr><td>administrative_country_code</td><td>'.$item->administrative->administrative_country_code.'</td></tr>';
	$html_text .= '<tr><td>administrative_street</td><td>'.$item->administrative->administrative_street.'</td></tr>';
	$html_text .= '<tr><td>administrative_postal_code</td><td>'.$item->administrative->administrative_postal_code.'</td></tr>';
