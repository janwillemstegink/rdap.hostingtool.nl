...
function SwitchTranslation(inputlanguage)	{
	if (inputlanguage == 1)	{
		...
		document.getElementById("rates").textContent = "Tarieven";
	}
		...
		document.getElementById("rates").textContent = "Preise";
	}
		...
		document.getElementById("rates").textContent = "Les taux";
	}
}	
</script><?php
echo '</head>';
...
$html_text .= '<tr><td id="rates" style="font-weight:bold"></td><td>hyperlink</td></tr>';
