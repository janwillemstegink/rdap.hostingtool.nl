...
function SwitchTranslation(inputlanguage)	{
	if (inputlanguage == 1)	{
		...
		document.getElementById("hyperlinks").textContent = "Relevante hyperlinks";
	}
		...
		document.getElementById("hyperlinks").textContent = "Relevant hyperlinks";
	}
		...
		document.getElementById("hyperlinks").textContent = "Entsprechende Hyperlinks";
	}
		...
		document.getElementById("hyperlinks").textContent = "Hyperliens pertinents";
	}
}	
</script><?php
echo '</head>';
...
$html_text .= '<tr><td id="hyperlinks" style="font-weight:bold"></td><td>...hyperlink...</td></tr>';
