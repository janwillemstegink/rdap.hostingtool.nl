...
$domain_last_uploaded = $doc->createElement("domain_last_uploaded");
$domain_last_uploaded->appendChild($doc->createCDATASection($last_uploaded));	
$domain->appendChild($domain_last_uploaded);
