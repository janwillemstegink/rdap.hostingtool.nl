							...
							foreach($value7 as $key8 => $value8) {
								if ($key1 == 'entities' and $key2 == $entity_registrar and $key3 == 'entities' 
									...
									if ($value7[0] == 'fn' and $value8 == 'fn')	{
										$registrar_abuse_full_name = $value7[3];
									}
...
$domain_registrant_organization = $doc->createElement("registrant_organization");
...
$domain_registrant_properties = $doc->createElement("registrant_properties");
...
$domain_administrative_organization = $doc->createElement("administrative_organization");
...
$domain_administrative_properties = $doc->createElement("administrative_properties");
...
$domain_technical_organization = $doc->createElement("technical_organization");
...
$domain_technical_properties = $doc->createElement("technical_properties");
...
$domain_billing_organization = $doc->createElement("billing_organization");
...
$domain_billing_properties = $doc->createElement("billing_properties");
...
$domain_reseller_organization = $doc->createElement("reseller_organization");
...
$domain_reseller_properties = $doc->createElement("reseller_properties");
...
$domain_registrar_organization = $doc->createElement("registrar_organization");
...
$domain_registrar_properties = $doc->createElement("registrar_properties");
...
$domain_registrar_abuse_full_name = $doc->createElement("registrar_abuse_full_name");
$domain_registrar_abuse_full_name->appendChild($doc->createCDATASection($registrar_abuse_full_name));	
$registrar->appendChild($domain_registrar_abuse_full_name);	
...
$domain_sponsor_organization = $doc->createElement("sponsor_organization");
...
$domain_sponsor_properties = $doc->createElement("sponsor_properties");
