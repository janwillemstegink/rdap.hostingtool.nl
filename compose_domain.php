...
$event_expiration_grace_until = $doc->createElement("event_expiration_grace_until");
$event_expiration_grace_until->appendChild($doc->createCDATASection($expiration_grace_until));	
$domain->appendChild($event_expiration_grace_until);
