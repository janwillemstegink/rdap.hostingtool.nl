...
if (!empty($_GET['domain']))	{
	if (strlen($_GET['domain']))	{
        ...
        echo json_encode(write_file($domain, $batch));
		die();
	}
	else	{	
...
$arr = array();
$arr[$inputdomain]['zone']['top_level_domain'] = $zone_top_level_domain;
$arr[$inputdomain]['zone']['registry_operator_trade_name'] = $zone_registry_operator_trade_name;
$arr[$inputdomain]['zone']['registry_trade_name'] = $zone_registry_trade_name;
$arr[$inputdomain]['zone']['delegation_url'] = $zone_delegation_url;
