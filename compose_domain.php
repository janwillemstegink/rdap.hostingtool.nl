...
$technical_country = '';
$technical_protected = 'web_id,full_name,name,tel,address';
				...
				foreach($value4 as $key5 => $value5) {
					...
					foreach($value5 as $key6 => $value6) {
						...
						if ($key1 == 'entities' and $key3 == 'vcardArray' and $value5[0] == 'adr' and $key6 == 1)	{
							if ($key2 == $entity_registrant)	{
								if (strlen($value6['CC']))	{
									$registrant_country_code = $value6['CC'] .' (cc in RDAP is not CC)';
								}
								if (strlen($value6['cc']))	{
						...
						if ($key1 == 'entities' and $key3 == 'vcardArray' and $value5[0] == 'adr' and $key6 == 3)	{
							if ($key2 == $entity_registrant)	{
								...
								$registrant_country = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}
							if ($key2 == $entity_admin)	{
								...
								$admin_country = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}	
							if ($key2 == $entity_technical)	{
								...
								$technical_country = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}
							if ($key2 == $entity_billing)	{
								...
								$billing_country = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}
							if ($key2 == $entity_reseller)	{
								...
								$reseller_country = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}
							if ($key2 == $entity_registrar)	{
								...
								$registrar_country = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];	
							}
							if ($key2 == $entity_sponsor)	{
								...
								$sponsor_country = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}
						}	
						if ($key2 == $entity_registrant and $key3 == 'remarks')	{
...
$domain_registrant_country = $doc->createElement("registrant_country");
$domain_registrant_country->appendChild($doc->createCDATASection($registrant_country));
$registrant->appendChild($domain_registrant_country);		
...
$domain_admin_country = $doc->createElement("admin_country");
$domain_admin_country->appendChild($doc->createCDATASection($admin_country));
$admin->appendChild($domain_admin_country);	
...
$domain_technical_country = $doc->createElement("technical_country");
$domain_technical_country->appendChild($doc->createCDATASection($technical_country));
$technical->appendChild($domain_technical_country);	
...
$domain_technical_protected = $doc->createElement("technical_protected");	
$domain_technical_protected->appendChild($doc->createCDATASection($technical_protected));	
$technical->appendChild($domain_technical_protected);
...
$domain_billing_country = $doc->createElement("billing_country");
$domain_billing_country->appendChild($doc->createCDATASection($billing_country));
$billing->appendChild($domain_billing_country);	
...
$domain_reseller_country = $doc->createElement("reseller_country");
$domain_reseller_country->appendChild($doc->createCDATASection($reseller_country));	
$reseller->appendChild($domain_reseller_country);
...
$domain_registrar_country = $doc->createElement("registrar_country");
$domain_registrar_country->appendChild($doc->createCDATASection($registrar_country));	
$registrar->appendChild($domain_registrar_country);
...
$domain_sponsor_country = $doc->createElement("sponsor_country");
$domain_sponsor_country->appendChild($doc->createCDATASection($sponsor_country));	
$sponsor->appendChild($domain_sponsor_country);
