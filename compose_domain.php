...
$technical_shielded = 'web_id,full_name,name,tel,address';
...
$billing_shielded = 'web_id,full_name,name,tel,address';
$reseller_handle = '';
$reseller_kind = '';	
$reseller_full_name = '';
$reseller_name = '';
...
$reseller_shielded = 'name,email,tel';
...
$registrar_shielded = 'name,email,tel';
...
$sponsor_shielded = 'name,email,tel';
				...
				foreach($value4 as $key5 => $value5) {
					...
					if ($key1 == 'entities')	{
						...
						if ($key2 == $entity_technical and $key3 == 'remarks')	{
							...
							if (!is_array($value5))	{
								$technical_remark_values .= $key5 . ': ' . $value5;
							}
							else	{
								$technical_remark_values .= $key5;
							}	
						}
						if ($key2 == $entity_billing and $key3 == 'remarks')	{
							...
							if (!is_array($value5))	{
								$billing_remark_values .= $key5 . ': ' . $value5;
							}
							else	{
								$billing_remark_values .= $key5;
							}	
						}
					...
					foreach($value5 as $key6 => $value6) {
						...
						if ($key1 == 'entities' and $key3 == 'vcardArray' and $value6 == 'tel')	{
							...
							if ($key2 == $entity_technical)	{
								$technical_tel .= implode(",",$value5[1]) . ' ' . $value5[3] . '<br />';
							}
							if ($key2 == $entity_billing)	{
								$biiling_tel .= implode(",",$value5[1]) . ' ' . $value5[3] . '<br />';
							}							
							if ($key2 == $entity_reseller)	{
						...
						if ($key1 == 'entities' and $key3 == 'vcardArray' and $value5[0] == 'adr' and $key6 == 3)	{
							if ($key2 == $entity_registrant)	{
								$registrant_street = (is_array($value6[2])) ? implode(",",$value6[2]) : $value6[2];
								$registrant_city = (is_array($value6[3])) ? implode(",",$value6[3]) : $value6[3];
								...
								$registrant_country_name = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}
							if ($key2 == $entity_admin)	{
								$admin_street = (is_array($value6[2])) ? implode(",",$value6[2]) : $value6[2];
								$admin_city = (is_array($value6[3])) ? implode(",",$value6[3]) : $value6[3];
								...
								$admin_country_name = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}	
							if ($key2 == $entity_technical)	{
								$technical_street = (is_array($value6[2])) ? implode(",",$value6[2]) : $value6[2];
								$technical_city = (is_array($value6[3])) ? implode(",",$value6[3]) : $value6[3];
								$technical_state_province = (is_array($value6[4])) ? implode(",",$value6[4]) : $value6[4];
								$technical_postal_code = (is_array($value6[5])) ? implode(",",$value6[5]) : $value6[5];
								$technical_country_name = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}
							if ($key2 == $entity_billing)	{
								$billing_street = (is_array($value6[2])) ? implode(",",$value6[2]) : $value6[2];
								$billing_city = (is_array($value6[3])) ? implode(",",$value6[3]) : $value6[3];
								$billing_state_province = (is_array($value6[4])) ? implode(",",$value6[4]) : $value6[4];
								$billing_postal_code = (is_array($value6[5])) ? implode(",",$value6[5]) : $value6[5];
								$billing_country_name = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}
							if ($key2 == $entity_reseller)	{
								...
								$reseller_country_name = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}
							if ($key2 == $entity_registrar)	{
								...
								$registrar_country_name = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];	
							}
							if ($key2 == $entity_sponsor)	{
								...
								$sponsor_country_name = (is_array($value6[6])) ? implode(",",$value6[6]) : $value6[6];
							}
						}	
						if ($key2 == $entity_registrant and $key3 == 'remarks')	{
						...
						foreach($value6 as $key7 => $value7)	{
							foreach($value7 as $key8 => $value8) {
								...
								if ($key1 == 'entities' and $key5 == 'vcardArray' and $value8 == 'tel')	{
									...
									if ($key4 == $entity_key4_tech)	{
										$technical_tel .= implode(",",$value7[1]) . ': ' . $value7[3] . '<br />';
									}	
									if ($key4 == $entity_key4_reseller)	{
...
$domain_registrant_street = $doc->createElement("registrant_street");
...
$domain_registrant_city = $doc->createElement("registrant_city");
...
$domain_registrant_country_name = $doc->createElement("registrant_country_name");
...
$domain_registrant_shielded = $doc->createElement("registrant_shielded");	
$domain_registrant_shielded->appendChild($doc->createCDATASection($registrant_shielded));	
$registrant->appendChild($domain_registrant_shielded);
...
$domain_technical_handle = $doc->createElement("technical_handle");
$domain_technical_handle->appendChild($doc->createCDATASection($technical_handle));	
$technical->appendChild($domain_technical_handle);	
$domain_technical_full_name = $doc->createElement("technical_full_name");
$domain_technical_full_name->appendChild($doc->createCDATASection($technical_full_name));	
$technical->appendChild($domain_technical_full_name);
$domain_technical_kind = $doc->createElement("technical_kind");
$domain_technical_kind->appendChild($doc->createCDATASection($technical_kind));	
$technical->appendChild($domain_technical_kind);	
$domain_technical_name = $doc->createElement("technical_name");
$domain_technical_name->appendChild($doc->createCDATASection($technical_name));	
$technical->appendChild($domain_technical_name);	
$domain_technical_email = $doc->createElement("technical_email");
$domain_technical_email->appendChild($doc->createCDATASection($technical_email));	
$technical->appendChild($domain_technical_email);	
$domain_technical_tel = $doc->createElement("technical_tel");
$domain_technical_tel->appendChild($doc->createCDATASection($technical_tel));	
$technical->appendChild($domain_technical_tel);
$domain_technical_country_code = $doc->createElement("technical_country_code");
...
$domain_technical_postal_code = $doc->createElement("technical_postal_code");
...
$domain_technical_country_name = $doc->createElement("technical_country_name");
...
$domain_technical_language_pref_1 = $doc->createElement("technical_language_pref_1");
...
$domain_technical_language_pref_2 = $doc->createElement("technical_language_pref_2");
...
$domain_technical_shielded = $doc->createElement("technical_shielded");	
$domain_technical_shielded->appendChild($doc->createCDATASection($technical_shielded));	
$technical->appendChild($domain_technical_shielded);
$domain_technical_remark_values = $doc->createElement("technical_remark_values");
...
$domain_billing_postal_code = $doc->createElement("billing_postal_code");
...
$domain_billing_country_name = $doc->createElement("billing_country_name");
...
$domain_billing_shielded = $doc->createElement("billing_shielded");	
$domain_billing_shielded->appendChild($doc->createCDATASection($billing_shielded));	
$billing->appendChild($domain_billing_shielded);
$domain_billing_remark_values = $doc->createElement("billing_remark_values");
...
$domain_reseller_country_name = $doc->createElement("reseller_country_name");
...
$domain_reseller_shielded = $doc->createElement("reseller_shielded");	
$domain_reseller_shielded->appendChild($doc->createCDATASection($reseller_shielded));	
$reseller->appendChild($domain_reseller_shielded);
...
$domain_registrar_country_name = $doc->createElement("registrar_country_name");
...
$domain_registrar_shielded = $doc->createElement("registrar_shielded");	
$domain_registrar_shielded->appendChild($doc->createCDATASection($registrar_shielded));	
$registrar->appendChild($domain_registrar_shielded);	
...
$domain_sponsor_country_name = $doc->createElement("sponsor_country_name");
...
$domain_sponsor_shielded = $doc->createElement("sponsor_shielded");	
$domain_sponsor_shielded->appendChild($doc->createCDATASection($sponsor_shielded));	
$sponsor->appendChild($domain_sponsor_shielded);
