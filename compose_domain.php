		...
		foreach($value2 as $key3 => $value3) {
			...
			if ($key1 == 'events')	{
				...
				elseif ($key3 == 'eventAction' and $value3 == 'transfer')	{
					$last_transferred_at = $value2['eventDate'];
				}
				elseif ($key3 == 'eventAction' and $value3 == 'last changed')	{
					$last_updated_at = $value2['eventDate'];
				}				
				...
				elseif ($key3 == 'eventAction' and $value3 == 'last update of RDAP database')	{
					$last_uploaded_at = $value2['eventDate'];				
				}
					...
					if ($key1 == 'entities')	{
						if ($key2 == $entity_registrant and $key3 == 'events')	{
							...
							elseif ($key5 == 'eventAction' and $value5 == 'last changed')	{
								$registrant_last_updated_at = $value4['eventDate'];
							}				
							...
							elseif ($key5 == 'eventAction' and $value5 == 'last update of RDAP database')	{
								$registrant_last_uploaded_at = $value4['eventDate'];				
							}
						}
						if ($key2 == $entity_reseller and $key3 == 'events')	{
							...
							elseif ($key5 == 'eventAction' and $value5 == 'last changed')	{
								$reseller_last_updated_at = $value4['eventDate'];
							}				
							elseif ($key5 == 'eventAction' and $value5 == 'expiration')	{
							...
							elseif ($key5 == 'eventAction' and $value5 == 'last update of RDAP database')	{
								$reseller_last_uploaded_at = $value4['eventDate'];				
							}
						}				
						if ($key2 == $entity_registrar and $key3 == 'events')	{
							...
							elseif ($key5 == 'eventAction' and $value5 == 'last changed')	{
								$registrar_last_updated_at = $value4['eventDate'];
							}				
							elseif ($key5 == 'eventAction' and $value5 == 'expiration')	{
							...
							elseif ($key5 == 'eventAction' and $value5 == 'last update of RDAP database')	{
								$registrar_last_uploaded_at = $value4['eventDate'];				
							}
						}
						if ($key2 == $entity_sponsor and $key3 == 'events')	{
							...
							elseif ($key5 == 'eventAction' and $value5 == 'last changed')	{
								$sponsor_last_updated_at = $value4['eventDate'];
							}				
							elseif ($key5 == 'eventAction' and $value5 == 'expiration')	{
							...
							elseif ($key5 == 'eventAction' and $value5 == 'last update of RDAP database')	{
								$sponsor_last_uploaded_at = $value4['eventDate'];				
							}
						}
...
$arr[$inputdomain]['resource']['registry_source'] = $url;		
$arr[$inputdomain]['resource']['registrar_source'] = $url_registrar;
$arr[$inputdomain]['resource']['registrar_public_ids'] = $registrar_public_ids;	
$arr[$inputdomain]['resource']['registrar_complaint_url'] = $registrar_complaint_url;		
$arr[$inputdomain]['resource']['status_explanation_url'] = $status_explanation_url;	
	
$arr[$inputdomain]['domain']['handle'] = $handle;
$arr[$inputdomain]['domain']['name_ascii'] = $name_ascii;	
$arr[$inputdomain]['domain']['name_unicode'] = $name_unicode;
$arr[$inputdomain]['domain']['status_values'] = $status_values;	
$arr[$inputdomain]['domain']['created_at'] = $created_at;	
$arr[$inputdomain]['domain']['last_transferred_at'] = $last_transferred_at;
$arr[$inputdomain]['domain']['last_updated_at'] = $last_updated_at;
$arr[$inputdomain]['domain']['expiration_at'] = $expiration_at;
$arr[$inputdomain]['domain']['deletion_at'] = $deletion_at;
$arr[$inputdomain]['domain']['last_uploaded_at'] = $last_uploaded_at;
$arr[$inputdomain]['domain']['extensions_values'] = $extensions_values;
$arr[$inputdomain]['domain']['remark_values'] = $remark_values;	
...
$arr[$inputdomain]['sponsor']['deletion_at'] = $sponsor_deletion_at;	
$arr[$inputdomain]['sponsor']['last_uploaded_at'] = $sponsor_last_uploaded_at;
...
$arr[$inputdomain]['registrant']['deletion_at'] = $registrant_deletion_at;	
$arr[$inputdomain]['registrant']['last_uploaded_at'] = $registrant_last_uploaded_at;
...
$arr[$inputdomain]['administrative']['deletion_at'] = $administrative_deletion_at;	
$arr[$inputdomain]['administrative']['last_uploaded_at'] = $administrative_last_uploaded_at;
...
$arr[$inputdomain]['technical']['deletion_at'] = $technical_deletion_at;	
$arr[$inputdomain]['technical']['last_uploaded_at'] = $technical_last_uploaded_at;
...
$arr[$inputdomain]['billing']['deletion_at'] = $billing_deletion_at;	
$arr[$inputdomain]['billing']['last_uploaded_at'] = $billing_last_uploaded_at;
...
$arr[$inputdomain]['reseller']['deletion_at'] = $reseller_deletion_at;	
$arr[$inputdomain]['reseller']['last_uploaded_at'] = $reseller_last_uploaded_at;
...
$arr[$inputdomain]['registrar']['deletion_at'] = $registrar_deletion_at;	
$arr[$inputdomain]['registrar']['last_uploaded_at'] = $registrar_last_uploaded_at;
