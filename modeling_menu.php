...
function SwitchTranslation(inputlanguage)	{
	if (inputlanguage == 1)	{
		document.getElementById("title").textContent = "Model voor een zonemenu";
...
<td style="font-size: .9rem"><a href="https://github.com/janwillemstegink/rdap_view_model" target="_blank">github.com/janwillemstegink/rdap_view_model</a></td></tr>';
