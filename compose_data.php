				...
				foreach($value4 as $key5 => $value5) {
					foreach($value5 as $key6 => $value6) {
						...
						foreach($value6 as $key7 => $value7) {
							if ($key1 == 'entities' and $key2 == $entity_registrar and $key3 == 'vcardArray'and $value5[0] == 'adr')	{
								$registrar_street = $value6[2];
								$registrar_city = $value6[3];
								$registrar_postal_code = $value6[5];
								$registrar_country_code = $value6[6];
							}
							elseif ($key1 == 'entities' and $key2 == $entity_reseller and $key3 == 'vcardArray' and $value5[0] == 'adr')	{
							...
							foreach($value7 as $key8 => $value8) {
								if ($key1 == 'entities' and $key2 == $entity_registrar and $key3 == 'entities' and $key4 == $entity_abuse and $key5 == 'vcardArray' and $key6 == 1)	{
									...
									elseif ($value8 == 'email')	{
										$registrar_abuse_email = $value7[3]; // $obj['entities'][3]['entities'][0]['vcardArray'][1][2][3];
									}	
								}
							}	
						}	
