...
$privacy_title = $obj['notices'][0]['title'];
$privacy_legal = $obj['notices'][0]['description'][0];	
$privacy_translated = $obj['notices'][0]['description'][1];
$copyright_title = $obj['notices'][1]['title'];
$copyright_legal = $obj['notices'][1]['description'][0];
$copyright_translated = $obj['notices'][1]['description'][1];
$description_legal = $obj['notices'][2]['description'][0];
$description_translated = $obj['notices'][2]['description'][1];	
$language = $obj['lang'];
...
$zone_privacy_title = $doc->createElement("zone_privacy_title");
$zone_privacy_title->appendChild($doc->createCDATASection($privacy_title));	
$zone->appendChild($zone_privacy_title);	
	
$zone_privacy_legal = $doc->createElement("zone_privacy_legal");
$zone_privacy_legal->appendChild($doc->createCDATASection($privacy_legal));	
$zone->appendChild($zone_privacy_legal);
	
$zone_privacy_translated = $doc->createElement("zone_privacy_translated");
$zone_privacy_translated->appendChild($doc->createCDATASection($privacy_translated));		
$zone->appendChild($zone_privacy_translated);
	
$zone_copyright_title = $doc->createElement("zone_copyright_title");
$zone_copyright_title->appendChild($doc->createCDATASection($copyright_title));	
$zone->appendChild($zone_copyright_title);	

$zone_copyright_legal = $doc->createElement("zone_copyright_legal");
$zone_copyright_legal->appendChild($doc->createCDATASection($copyright_legal));	
$zone->appendChild($zone_copyright_legal);
	
$zone_copyright_translated = $doc->createElement("zone_copyright_translated");
$zone_copyright_translated->appendChild($doc->createCDATASection($copyright_translated));		
$zone->appendChild($zone_copyright_translated);	
	
$zone_description_legal = $doc->createElement("zone_description_legal");
$zone_description_legal->appendChild($doc->createCDATASection($description_legal));	
$zone->appendChild($zone_description_legal);
	
$zone_description_translated = $doc->createElement("zone_description_translated");
$zone_description_translated->appendChild($doc->createCDATASection($description_translated));	
$zone->appendChild($zone_description_translated);	
...
$ipv4_1 = $obj['nameservers'][0]['ipAddresses']['v4'][0];
$ipv6_1 = $obj['nameservers'][0]['ipAddresses']['v6'][0];	
$ipv4_2 = $obj['nameservers'][1]['ipAddresses']['v4'][0];
$ipv6_2 = $obj['nameservers'][1]['ipAddresses']['v6'][0];
$ipv4_3 = $obj['nameservers'][2]['ipAddresses']['v4'][0];
$ipv6_3 = $obj['nameservers'][2]['ipAddresses']['v6'][0];
...
$domain_ipv4_1 = $doc->createElement("ipv4_1");
$domain_ipv4_1->appendChild($doc->createCDATASection($ipv4_1));		
$server_1->appendChild($domain_ipv4_1);
$domain_ipv6_1 = $doc->createElement("ipv6_1");
$domain_ipv6_1->appendChild($doc->createCDATASection($ipv6_1));		
$server_1->appendChild($domain_ipv6_1);	
$name_servers->appendChild($server_1);
...
$domain_ipv4_2 = $doc->createElement("ipv4_2");
$domain_ipv4_2->appendChild($doc->createCDATASection($ipv4_2));		
$server_2->appendChild($domain_ipv4_2);
$domain_ipv6_2 = $doc->createElement("ipv6_2");
$domain_ipv6_2->appendChild($doc->createCDATASection($ipv6_2));		
$server_2->appendChild($domain_ipv6_2);	
$name_servers->appendChild($server_2);	
...
$domain_ipv4_3 = $doc->createElement("ipv4_3");
$domain_ipv4_3->appendChild($doc->createCDATASection($ipv4_3));		
$server_3->appendChild($domain_ipv4_3);
$domain_ipv6_3 = $doc->createElement("ipv6_3");
$domain_ipv6_3->appendChild($doc->createCDATASection($ipv6_3));		
$server_3->appendChild($domain_ipv6_3);		
$name_servers->appendChild($server_3);
