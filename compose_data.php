...
$registrar_abuse_email = 'not available';
$entity_registrar = -1;	
$entity_abuse = -1;
$entity_reseller = -1;	
$entity_registrant = -1;
		...
		foreach($value2 as $key3 => $value3) {
			if ($key1 == 'events')	{
				...
				elseif ($value3 == 'transfer')	{
					$last_transfer = $value2['eventDate'];
				}				
			}
...
$domain_last_transfer = $doc->createElement("domain_last_transfer");
$domain_last_transfer->appendChild($doc->createCDATASection($last_transfer));	
$domain->appendChild($domain_last_transfer);			
