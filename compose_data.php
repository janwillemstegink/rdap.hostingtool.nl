...
$view_links_href_lang = $obj['links'][0]['hreflang'];
$view_links_title = $obj['links'][0]['title'];
...
//$registrar_full_name = $obj['entities'][3]['vcardArray'][1][1][3];
...
//$reseller_full_name = $obj['entities'][4]['vcardArray'][1][1][3];
	...
	foreach($value1 as $key2 => $value2) {
		foreach($value2 as $key3 => $value3) {
			...
			foreach($value3 as $key4 => $value4) {
				foreach($value4 as $key5 => $value5) {
					foreach($value5 as $key6 => $value6) {
						if ($key1 == 'entities' and $key2 == $entity_registrar and $key3 == 'vcardArray' and $value6 == 'fn')	{
							$registrar_full_name = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_reseller and $key3 == 'vcardArray' and $value6 == 'fn')	{
							$reseller_full_name = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_registrant and $key3 == 'vcardArray' and $value6 == 'fn')	{
							$registrant_full_name = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_registrar and $key3 == 'vcardArray' and $value6 == 'n')	{
							$registrar_name = $value5[3][0];
							if (strlen($value5[3][1]))	{
								$registrar_name .= ', '. $value5[3][1];
							}	
						}
						elseif ($key1 == 'entities' and $key2 == $entity_reseller and $key3 == 'vcardArray' and $value6 == 'n')	{
							$reseller_name = $value5[3][0];
							if (strlen($value5[3][1]))	{
								$reseller_name .= ', '. $value5[3][1];
							}
						}
						elseif ($key1 == 'entities' and $key2 == $entity_registrant and $key3 == 'vcardArray' and $value6 == 'n')	{
							$registrant_name = $value5[3][0];
							if (strlen($value5[3][1]))	{
								$registrant_name .= ', '. $value5[3][1];
							}
						}
						elseif ($key1 == 'entities' and $key2 == $entity_registrar and $key3 == 'vcardArray' and $value6 == 'kind')	{
							$registrar_kind = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_reseller and $key3 == 'vcardArray' and $value6 == 'kind')	{
							$reseller_kind = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_registrant and $key3 == 'vcardArray' and $value6 == 'kind')	{
							$registrant_kind = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_registrar and $key3 == 'vcardArray' and $value6 == 'lang')	{
							if ($value6['pref'] == 1)	$registrar_language_pref_1 = $value5[3];
							if ($value6['pref'] == 2)	$registrar_language_pref_2 = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_reseller and $key3 == 'vcardArray' and $value6 == 'lang')	{
							if ($value6['pref'] == 1)	$reseller_language_pref_1 = $value5[3];
							if ($value6['pref'] == 2)	$reseller_language_pref_2 = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_registrant and $key3 == 'vcardArray' and $value6 == 'lang')	{
							if ($value6['pref'] == 1)	$registrant_language_pref_1 = $value5[3];
							if ($value6['pref'] == 2)	$registrant_language_pref_2 = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_admin and $key3 == 'vcardArray' and $value6 == 'lang')	{
							if ($value6['pref'] == 1)	$admin_language_pref_1 = $value5[3];
							if ($value6['pref'] == 2)	$admin_language_pref_2 = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_tech and $key3 == 'vcardArray' and $value6 == 'lang')	{
							if ($value6['pref'] == 1)	$tech_language_pref_1 = $value5[3];
							if ($value6['pref'] == 2)	$tech_language_pref_2 = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_admin and $key3 == 'vcardArray' and $value6 == 'email')	{
							$admin_email = $value5[3];
						}
						elseif ($key1 == 'entities' and $key2 == $entity_tech and $key3 == 'vcardArray' and $value6 == 'email')	{
							$tech_email = $value5[3];
						}
...
$domain_view_links_href_lang = $doc->createElement("view_links_href_lang");
$domain_view_links_href_lang->appendChild($doc->createCDATASection($view_links_href_lang));	
$view->appendChild($domain_view_links_href_lang);
	
$domain_view_links_title = $doc->createElement("view_links_title");
$domain_view_links_title->appendChild($doc->createCDATASection($view_links_title));	
$view->appendChild($domain_view_links_title);	
	
$domain_view_links_media = $doc->createElement("view_links_media");
$domain_view_links_media->appendChild($doc->createCDATASection($view_links_media));	
$view->appendChild($domain_view_links_media);
