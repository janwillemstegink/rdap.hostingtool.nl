...
function SwitchDisplay(type) {
	...
	else if (type == 21)	{ // security headers
		var pre = '21';
		var max = 2
	}
...
foreach ($xml1->xpath('//domain') as $item)	{
	...
	$html_text .= '<tr><td><button style="cursor:pointer;font-size:1.05rem" onclick="SwitchDisplay(11)">transfer information, no www +/-</button></td><td></td><td><button style="cursor:pointer;font-size:1.05rem" onclick="SwitchDisplay(11)">transfer information, via www +/-</button></td></tr>';
	$html_text .= '<tr id="111" style="display:none"><td colspan="2">'.$item->transfer_information.'</td><td>'.$item->transfer_information_www.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer;font-size:1.05rem" onclick="SwitchDisplay(21)">security.txt, no www +/-</button></td><td></td><td><button style="cursor:pointer;font-size:1.05rem" onclick="SwitchDisplay(21)">security.txt, via www +/-</button></td></tr>';
	$html_text .= '<tr id="211" style="display:none"><td colspan="2"><em>'.$item->security_txt_url.'</em></td><td><em>'.$item->security_txt_url_www.'</em></td></tr>';
	$html_text .= '<tr id="212" style="display:none"><td colspan="2">'.$item->security_txt.'</td><td>'.$item->security_txt_www.'</td></tr>';
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	...
	$html_text .= '<tr><td><hr></td><td><hr></td><td><hr></td></tr>';
	$html_text .= '<tr><td><button style="cursor:pointer;font-size:1.05rem" onclick="SwitchDisplay(32)">MX, no www +/-</button></td><td></td><td><button style="cursor:pointer;font-size:1.05rem" onclick="SwitchDisplay(32)">MX, via www +/-</button></td></tr>';
